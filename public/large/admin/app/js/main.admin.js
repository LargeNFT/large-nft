...
`}}Ne=Be([(0,s.b)(),Me("design:paramtypes",[P,E,W,ee,U,$,pe,oe,be,Ie,je,De,y])],Ne),Le.id="b264ceb776",Le.style="\n\n\n";const Ue=Le;function He(e,{$on:t,$f7ready:i,$f7:a,$f7router:s,$update:o}){return i((async()=>{let e,t,i=window.location.pathname,s=window.location.hash?.length>2?window.location.hash.substring(2):void 0,r=n.getInstance(f),c=n.getWalletService(),l=n.getInstance(Ne);const d=async e=>{t=void 0,c.provider||await c.initProvider(),t=await c.getAddress(),t&&(c.address=t,c.wallet||await c.connect()),await o()};document.addEventListener("connect-wallet",(async e=>{await(async e=>{await c.initWallet(),await c.connect(),await d()})()})),await async function(){r.showSpinner("Loading..."),await l.load(),await d(),e=a.views.create(".view-main",{url:s||"/",browserHistory:!0,browserHistoryRoot:i,reloadCurrent:!0}),r.hideSpinner()}()})),function(e){e.$;var t=e.$h;e.$root,e.$f7,e.$f7route,e.$f7router,e.$theme,e.$update,e.$store;return t`
  <div id="app">
...
`}}ca.id="afb6075133",ca.style="\n\n\n";const la=ca;function fa(e,{$:t,$h:i,$on:a,$f7:s,$update:o}){let r=n.getInstance(zi),c=(n.getInstance(Ct),n.getInstance(f));e.footerText;let l,d,p,u,h,g=[],m=[{text:"Home"}];function v(){console.log("Unload infinite scroll"),s.infiniteScroll.destroy("#channel-index-infinite-scroll"),t(".infinite-scroll-preloader").hide()}async function b(){if(!u&&p){c.showSpinner("Loading..."),u=!0;try{g=await r.list(20,l),g&&20==g.length?l+=g.length:p=!1,0==d&&h.deleteAllItems(),h.appendItems(g)}catch(e){console.log(e)}p||v(),d++,u=!1,c.hideSpinner()}}a("pageAfterOut",((e,t)=>{v()})),a("pageInit",((e,i)=>{l=0,d=0,p=!0,u=!1,h=s.virtualList.create({el:"#channel-index-list",renderItem:e=>y(e),items:[],setListHeight:!1,emptyTemplate:'\n              <li class="item-content">\n                <div class="item-inner">\n                    There are no collections yet. <br /><br />Click the \'Create Collection\' button to create your first collection.\n                </div>\n              </li>\n            '}),t("#channel-index-infinite-scroll").trigger("infinite"),h.on("itemsAfterInsert",((e,i)=>{t(".empty").each((e=>{const i=t(e).data("id"),a=g.filter((e=>e.channel._id==i))[0];a.channel.descriptionHTML&&(e.innerHTML=a.channel.descriptionHTML);let n=e.getElementsByTagName("a");for(let e of n)e.classList.add("external");t(e).removeClass("empty")})),t("#channel-index-list ul").css("height","")}))}));const y=e=>`\n              <li>\n                <a href="/admin/channel/show/${e.channel._id}" class="item-link">\n                  <div class="item-content">\n                    <div class="item-media">\n                      ${e.coverImage?`\n                        <img src="${e.coverImage.url}" class="avatar" />\n                      `:'\n                        <i class="material-icons avatar">image</i>\n                      '}\n                    </div>\n                    <div class="item-inner">\n                      <div class="item-title-row">\n                        <div class="item-title">\n                          ${e.channel.title}                          \n                        </div>\n                        <div class="item-after"><span class="badge">${e.itemCount}</span></div>\n                      </div>\n\n                      ${e.authorDisplayName?`\n                        <div class="item-subtitle">\n                          By ${e?.authorDisplayName}\n                        </div>\n                      `:""}\n\n                      <div class="description item-text empty" data-id="${e.channel._id}"></div>\n                    \n                    </div>\n                  </div>\n                </a>\n              </li>\n          `;return function(e){e.$;var t=e.$h;e.$root,e.$f7,e.$f7route,e.$f7router,e.$theme,e.$update,e.$store;return t`
            ...
            <div class="view">
                <div class="page">
                    ...
                    <div class="page-content">
                        ...
                        <form @submit="${T}" id="save-marketplaces-form">
                                    ...
                                    <div class="item-content item-input">
                                        <div class="item-inner">
                                            ...
                                            <div class="item-input-wrap">
                                                ...
                                                ${F.coverImage?t`
                                                <img class="avatar-preview" src="${F?.coverImage.url}" />
                        ...
                        <div class="list">
                            <ul>
                                    ...
                                    <div class="item-content item-input">
                                        <div class="item-inner">
                                            ...
                                            <div class="item-input-wrap">
                                                ...
                                                <input type="hidden" name="mintPrice" value="${A}" />
                                            </div>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li tabindex="-1">
                                    <div class="item-content">
                                        <div class="item-inner">
                                            <div class="item-text"> You will receive <strong>${A}</strong> ETH
                                                (${O} wei) for
                                                each mint.</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item-content item-input">
                                        <div class="item-inner">
                                            ...
                                            <div class="block">
                                                ...
                                                <a class="button button-outline " @click="${j}" tabindex="10">Add Marketplace</a>
...
`}}ma.id="5dccd66fb6",ma.style="\n\n\n\n\n\n";const va=ma;var ba=i(20637);function ya(e,{$:t,$on:i,$f7:a,$update:s}){n.getInstance(mi);let o,r,c=n.getInstance(zi),l=n.getInstance(ti),d=n.getInstance(Lt),p=(n.getInstance(f),n.getWalletService()),u=[{text:"Home",path:"/"},{text:"Create & Import",path:"/admin/channel/create-menu"},{text:"Create Collection"}];ba.Z.configure({languages:["css"]});let h,g,m={channel:{mintPrice:"0.00",authorId:p.address},themes:[],staticPages:[],editable:!0,disableForks:!1};const v=async e=>{if(e.preventDefault(),!document.getElementById("create-channel-form").reportValidity())return void document.getElementById("collection-title").scrollIntoView();let t=Object.assign(new A,a.form.convertToData("#create-channel-form"));t.description=d.activeEditor.getContents(),t.license=o.getContents(),t.sellerFeeBasisPoints=parseInt(t.sellerFeeBasisPoints),t.attributeOptions?t.attributeOptions=JSON.parse(t.attributeOptions):t.attributeOptions=[],t.externalLinks?t.externalLinks=JSON.parse(t.externalLinks):t.externalLinks=[],t.marketplaces?t.marketplaces=JSON.parse(t.marketplaces):t.marketplaces=[],t.disableForks="true"==t.disableForks,t.showMintPage="true"==t.showMintPage,t.showActivityPage="true"==t.showActivityPage;try{await c.put(t,h,g),t.authorId&&await l.insertIfNew(t.authorId);a.toast.show({text:"Collection saved",closeTimeout:2e3,closeButton:!0,position:"bottom",horizontalPosition:"left"});a.views.main.router.navigate(`/admin/channel/show/${t._id}`)}catch(e){console.log(e),a.dialog.alert(e.errors,"There was an error")}};i("pageInit",(async(e,i)=>{t("#create-channel-form").attr("novalidate","novalidate"),await d.init(),d.buildQuillPostEditor("#create-channel-description-editor","#create-channel-description-toolbar"),o=new(ot())("#create-channel-license-editor",{bounds:".page-content",modules:{toolbar:"#create-channel-license-toolbar"},theme:"snow"}),r=a.swiper.create(".swiper",{speed:1e3,allowTouchMove:!1,createElements:!0,longSwipes:!1,preventInteractionOnTransition:!0,shortSwipes:!1,simulateTouch:!1,on:{slideChange:function(e){0==e.activeIndex&&(document.getElementById("create-new-swiper").style.height="700px"),1==e.activeIndex&&(document.getElementById("create-new-swiper").style.height="2500px")}}})}));const b=async e=>{m.channel.disableForks=!0,await s(),r.slideNext(1e3)},y=async e=>{m.channel.disableForks=!1,await s(),r.slideNext(1e3)};return t(document).on("cover-image-updated",(async e=>{h=e.detail.coverImage})),t(document).on("cover-banner-updated",(async e=>{g=e.detail.coverBanner})),function(e){e.$;var t=e.$h;e.$root,e.$f7,e.$f7route,e.$f7router,e.$theme,e.$update,e.$store;return t`
                ...
                <div class="fixed-width-content center">
                  ...
                  <div class="block split-row">
                    ...
                    <div class="block copyright-block no-margin-bottom">
                      ...
                      <button class="button color-red button-outline" @click="${b}">Copyright</button>
                    ...
                    <div class="block copyleft-block">
                      ...
                      <button class="button button-fill" @click="${y}">Copyleft</button>
  ...
  <div class="page" data-name="admin-show-collection">
    ...
    <div class="page-content infinite-scroll-content hide-toolbar-on-scroll" id="item-list-infinite-scroll">
      ...
      <div class="fixed-width-content center">
        ...
        <${$a} channel=${c.channel._id} token_id="1" />
...
`}}ka.id="a46af0f738",ka.style="\n  \n\n";const Ia=ka;function Ra(e,{$:t,$on:i,$f7:a,$update:n}){let s=e.theme,o=e.cover_image_css_editor_id,r=e.animation_css_editor_id;return function(e){e.$;var t=e.$h;e.$root,e.$f7,e.$f7route,e.$f7router,e.$theme,e.$update,e.$store;return t`
            ...
            <div class="page">
              ...
              <div class="page-content">
                <form id="add-theme-form" @submit="${v}">
                  <${xa} cover_image_css_editor_id="add-theme-cover-image-editor"
            ...
            <div class="page">
              ...
              <div class="page-content">
                <form id="edit-theme-form" @submit="${b}">
                  ...
                  <${xa} cover_image_css_editor_id="edit-theme-cover-image-editor"
            ...
            <div class="page">
              ...
              <div class="page-content">
                <form id="add-static-page-form" @submit="${b}">
                  <${ja} static_page_content_editor_id="add-static-page-content-editor"
            ...
            <div class="page">
              ...
              <div class="page-content">
                <form id="edit-static-page-form" @submit="${y}">
                  ...
                  <${ja} static_page_content_editor_id="edit-static-page-content-editor"
...
`}}Oa.id="082a1b93ec",Oa.style="\n";const Fa=Oa;function Ea(e,{$:t,$on:i,$f7:a,$update:s}){let o,r=[{text:"Home",path:"/"},{text:"Create & Import"}];return i("pageInit",(async()=>{o=n.getWalletService(),await s()})),function(e){e.$;var t=e.$h;e.$root,e.$f7,e.$f7route,e.$f7router,e.$theme,e.$update,e.$store;return t`
...
`}}_n=Rn([(0,s.b)(),xn("design:paramtypes",[Ft,mi,Xi,kn,Ne])],_n),Pn.id="c30185605e",Pn.style="\n    .cover-image-thumbnail {\n        width: 250px;\n        height: 250px;\n    }\n\n    .cover-image-thumbnail.selected {\n        border: 3px solid #ff0000;\n    }\n\n    #title-header-input {\n        line-height: 30px;\n        font-size: 30px;\n        font-weight: 700;\n        height: 50px;\n    }\n\n    .clear-button {\n        width: 100px;\n    }\n";const Cn=Pn;i(69942);function jn(e,{$:t,$on:i,$f7:a,$update:s}){let o,r,c=n.getInstance(Lt),l=n.getInstance(at),d=n.getInstance(f),p=n.getInstance(fi),u=(n.getInstance(Ct),n.getInstance(Ni)),h=n.getInstance(wi),g=(n.getInstance(_n),n.getInstance(Ft)),m=n.getInstance(Bt),v=(n.getWalletService(),e.itemViewModel),b=e.themes,y=!1,w=`/admin/channel/show/${v.channel._id}`,S=!1,$=[{text:"Home",path:"/"},{text:v.channel.title,path:`/admin/channel/show/${v.channel._id}`},{text:"Create Item"}];ba.Z.configure({languages:["css"]});const k=async e=>{e.preventDefault(),await h.init();let t=a.form.convertToData("#create-item-form"),i=Object.assign(new K,t);i.coverImageAsAnimation="on"!=t.coverImageAsAnimation[0],i.content=c.activeEditor.getContents(),i.coverImageCSS="\n"!=o.getText()?o.getText():void 0,i.animationCSS="\n"!=r.getText()?r.getText():void 0,i.attributeSelections=JSON.parse(i.attributeSelections).map((e=>({id:e.id,traitType:e.traitType,value:e.value}))),i.contentHTML=await l.translateContent(i.content,!0);let n=await u.saveGeneratedCoverImage(i);i.coverImageGenerated=n.generated,i.tokenId=await p.getNextTokenId(i.channelId),i.coverImageAsAnimation||await u.saveAnimation(i);try{d.showSpinner(),await u.put({channel:v.channel,item:i,updateQueryCache:!0,publish:!1});a.toast.show({text:"Item created",closeTimeout:2e3,closeButton:!0,position:"bottom",horizontalPosition:"left"});a.views.main.router.navigate(`/admin/channel/show/${i.channelId}/${i.tokenId}`)}catch(e){console.log(e),a.dialog.alert(e.errors,"There was an error")}};return i("pageInit",(async(e,i)=>{c.buildQuillPostEditor("#create-item-editor","#create-item-toolbar"),c.activeEditor.root.addEventListener("blur",(function(){document.dispatchEvent(new CustomEvent("load-cover-images"))})),c.activeEditor.on("text-change",((e,t,i)=>{if(document.dispatchEvent(new CustomEvent("load-cover-images")),"user"!==i)return;const a=function(e){return e.ops.filter((e=>e.insert&&e.insert.ipfsimage)).map((e=>e.insert.ipfsimage))}(c.activeEditor.getContents().diff(t));a.forEach((e=>{v.images=v.images.filter((t=>t.cid!=e.cid)),e.cid==v.coverImage?.cid&&(v.coverImage=void 0)}))})),t(".image-button").off("click"),t(".image-button-input").off("click"),t(".ai-button").off("click"),t(".image-button").on("click",(function(e){e.preventDefault();t(".image-button-input").click()})),t(".image-button-input").on("change",(async function(e){e.preventDefault(),await c.imageSelected(this)})),t(".ai-button").on("click",(async function(e){e.preventDefault();const t=new CustomEvent("set-ai-prompt");document.dispatchEvent(t),a.popup.open(".ai-popup")})),o=new(ot())("#cover-image-css-editor",{bounds:".page-content",theme:"snow",modules:{syntax:{highlight:e=>ba.Z.highlightAuto(e).value},toolbar:!1}}),o.on("text-change",((e,t,i)=>{document.dispatchEvent(new CustomEvent("update-cover-image-css",{detail:{coverImageCSS:"\n"!=o.getText()?o.getText():void 0}}))})),r=new(ot())("#animation-css-editor",{bounds:".page-content",theme:"snow",modules:{syntax:{highlight:e=>ba.Z.highlightAuto(e).value},toolbar:!1}}),o.setText(".svg-h1 {}"),r.setText(".animation-container {}"),await s(),d.showSpinner(),await h.init(),y=null!=h.ipfs;const n=new CustomEvent("ipfs-ready");document.dispatchEvent(n);const l=await g.get();if(S=null!=l?.huggingFace,l?.huggingFace?.length>0){await m.init();const e=new CustomEvent("hugging-face-ready");document.dispatchEvent(e)}d.hideSpinner(),await s()})),i("pageBeforeRemove",(()=>{})),function(e){e.$;var t=e.$h;e.$root,e.$f7,e.$f7route,e.$f7router,e.$theme,e.$update,e.$store;return t`
    ...
    <div class="page-content hide-toolbar-on-scroll">
      ...
      <div class="item-show">
        ...
        <div class="right">
          ...
          <${$a} channel=${c.channel._id} item=${c} />
          ...
          ${c.item.coverImageAsAnimation?t`<span />`:t`
            <div class="card">
              ...
              <div class="card-content">
                <div class="square">
                  <img src="${c.coverImage?.url}" class="cover-image-preview" />
                </div>
              </div>
            </div>
...
`}}An.id="743b1506d1",An.style="\n\n\n\n\n  /* .item-card-show a {\n    color: var(--f7-text-color);\n  } */\n\n\n  .menu-dropdown-link.menu-close {\n    color: #ffffff;\n  }\n\n\n  .attribute-row {\n    font-size: 16px;\n    vertical-align: top;\n  }\n\n  .attribute-row strong {\n    width: 175px;\n    display: inline-block;\n    vertical-align: top;\n  }\n\n\n  .attribute-row .material-icons {\n    line-height: 16px;\n    display: inline-block;\n    vertical-align: middle;\n  }\n\n  .item-show-footer {\n    font-size: 14px;\n  }\n\n  .card-header {\n    line-height: 21px;\n  }\n\n  .card-header label {\n    padding-bottom: 3px;\n    margin-left: 5px;\n    float: left;\n  }\n\n  .card-header .material-icons {\n    float: left;\n  }\n\n  .item-show-token-id {\n    color: rgb(79, 79, 79);\n  }\n\n  .cover-image-preview {\n    max-width: 100%;\n  }\n\n  .animation-preview {\n    margin-left: 5px;\n    height: 500px; \n    width: 500px;\n    max-width: 100%;\n    border: 1px solid #cccccc;\n  }\n\n\n  .nft-header-row {\n    display: flex;  \n  }\n\n  .nft-header-row .left {\n    flex: 0 0 500px;\n  }\n\n  .nft-header-row .right {\n    flex: 1;\n  }\n\n  .nft-header-row .right h1 {\n    font-size: 25px;\n  }\n\n  .nft-header-row .right h4 {\n    margin-bottom: 0px;\n  }\n\n\n\n\n\n@media only screen and (max-width: 1024px) {\n\n  .nft-header-row {\n    display: block;  \n  }\n  \n  .nft-header-row .left {\n    width: 100%;\n  }\n  \n  .nft-header-row .right {\n    width: 100%;\n  }\n  \n}\n\n\n.theme-name {\n  display: block;\n}\n\n.main-header {\n\n}\n\n\n";const On=An;function Fn(e,{$:t,$on:i,$f7:a,$update:s}){let o,r,c=n.getInstance(Lt),l=n.getInstance(at),d=n.getInstance(f),p=(n.getInstance(fi),n.getInstance(Ni)),u=n.getInstance(wi),h=(n.getInstance(_n),n.getInstance(Ft)),g=n.getInstance(Bt),m=(n.getInstance(Ct),n.getWalletService(),e.itemViewModel),v=e.themes,b=!1,y=`/admin/channel/show/${m.item.channelId}/${m.item.tokenId}`,w=!1;ba.Z.configure({languages:["css"]});let S=[{text:"Home",path:"/"},{text:m.channel.title,path:`/admin/channel/show/${m.channel._id}`},{text:m.item.title?m.item.title:`#${m.item.tokenId}`,path:`/admin/channel/show/${m.channel._id}/${m.item.tokenId}`},{text:"Edit Item"}];const $=async e=>{e.preventDefault();let t=a.form.convertToData("#edit-item-form"),i=Object.assign(new K,t);i.coverImageAsAnimation="on"!=t.coverImageAsAnimation[0],i.tokenId=parseInt(t.tokenId),i.content=c.activeEditor.getContents(),i.coverImageCSS="\n"!=o.getText()?o.getText():void 0,i.animationCSS="\n"!=r.getText()?r.getText():void 0,i.attributeSelections?i.attributeSelections=JSON.parse(i.attributeSelections).map((e=>({id:e.id,traitType:e.traitType,value:e.value}))):i.attributeSelections=[],i.contentHTML=await l.translateContent(i.content,!0);let n=await p.saveGeneratedCoverImage(i);i.coverImageGenerated=n.generated,i.coverImageAsAnimation||await p.saveAnimation(i);try{d.showSpinner(),await p.put({channel:m.channel,item:i,updateQueryCache:!0,publish:!1});a.toast.show({text:"Item saved",closeTimeout:2e3,closeButton:!0,position:"bottom",horizontalPosition:"left"});a.views.main.router.navigate(`/admin/channel/show/${i.channelId}/${i.tokenId}`)}catch(e){console.log(e),a.dialog.alert(e.errors,"There was an error")}};return i("pageInit",(async(e,i)=>{c.buildQuillPostEditor("#edit-item-editor","#edit-item-toolbar"),c.activeEditor.setContents(m.item.content),c.activeEditor.on("selection-change",(e=>{document.dispatchEvent(new CustomEvent("load-cover-images"))})),c.activeEditor.on("text-change",((e,t,i)=>{if(document.dispatchEvent(new CustomEvent("load-cover-images")),"user"!==i)return;let a=c.activeEditor.getContents();const n=function(e){return e.ops.filter((e=>e.insert&&e.insert.ipfsimage)).map((e=>e.insert.ipfsimage))}(c.activeEditor.getContents().diff(t)),o=[];for(let e of n){let i=t.ops.filter((t=>t.insert&&t.insert.ipfsimage&&t.insert.ipfsimage.cid==e.cid)),n=a.ops.filter((t=>t.insert&&t.insert.ipfsimage&&t.insert.ipfsimage.cid==e.cid));i.length>0&&0==n.length&&o.push(e)}o.forEach((e=>{m.images=m.images.filter((t=>t.cid!=e.cid)),e.cid==m.coverImage?.cid&&(m.coverImage=void 0)})),s()})),t(".image-button").off("click"),t(".image-button-input").off("click"),t(".ai-button").off("click"),t(".image-button").on("click",(function(e){e.preventDefault();t(".image-button-input").click()})),t(".image-button-input").on("change",(async function(e){e.preventDefault(),await c.imageSelected(this)})),t(".ai-button").on("click",(async function(e){e.preventDefault();const t=new CustomEvent("set-ai-prompt");document.dispatchEvent(t),a.popup.open(".ai-popup")})),o=new(ot())("#cover-image-edit-css-editor",{bounds:".page-content",theme:"snow",modules:{syntax:{highlight:e=>ba.Z.highlightAuto(e).value},toolbar:!1}}),o.on("text-change",((e,t,i)=>{document.dispatchEvent(new CustomEvent("update-cover-image-css",{detail:{coverImageCSS:"\n"!=o.getText()?o.getText():void 0}}))})),r=new(ot())("#animation-edit-css-editor",{bounds:".page-content",theme:"snow",modules:{syntax:{highlight:e=>ba.Z.highlightAuto(e).value},toolbar:!1}}),m.item.coverImageCSS&&o.setText(m.item.coverImageCSS),m.item.animationCSS&&r.setText(m.item.animationCSS),await s(),d.showSpinner(),await u.init(),b=null!=u.ipfs;const n=new CustomEvent("ipfs-ready");document.dispatchEvent(n);const l=await h.get();if(w=null!=l?.huggingFace,l?.huggingFace?.length>0){await g.init();const e=new CustomEvent("hugging-face-ready");document.dispatchEvent(e)}d.hideSpinner(),await s()})),function(e){e.$;var t=e.$h;e.$root,e.$f7,e.$f7route,e.$f7router,e.$theme,e.$update,e.$store;return t`
...
`}}Fn.id="180c69b1bc",Fn.style="\n  #edit-item-editor {\n    min-height: 175px;\n    height: 100%;\n    /* added these styles */\n    flex: 1;\n    display: flex;\n    flex-direction: column;\n  }\n";const En=Fn;var Dn=function(e,t,i,a){var n,s=arguments.length,o=s<3?t:null===a?a=Object.getOwnPropertyDescriptor(t,i):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,i,a);else for(var r=e.length-1;r>=0;r--)(n=e[r])&&(o=(s<3?n(o):s>3?n(t,i,o):n(t,i))||o);return s>3&&o&&Object.defineProperty(t,i,o),o},Bn=function(e,t){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(e,t)};let Mn=class{itemWebService;themeService;schemaService;constructor(e,t,i){this.itemWebService=e,this.themeService=t,this.schemaService=i}async create(){return new na((async e=>{await this.schemaService.loadChannel(e.params.channelId);let t=await this.itemWebService.getNewViewModel(e.params.channelId);return{itemViewModel:t,themes:await this.themeService.listByChannel(t.channel._id,1e3,0)}}),Tn)}async show(){return new na((async e=>(await this.schemaService.loadChannel(e.params.channelId),{itemViewModel:await this.itemWebService.getNavigation(e.params.channelId,parseInt(e.params.tokenId))})),On)}async edit(){return new na((async e=>{await this.schemaService.loadChannel(e.params.channelId);let t=await this.itemWebService.get(e.params.id);return{itemViewModel:t,themes:await this.themeService.listByChannel(t.channel._id,1e3,0)}}),En)}};function Nn(e,{$:t,$on:i,$f7:a,$update:n}){let s=e.authorViewModel,o=[{text:"Home",path:"/"},{text:"Author Profile"}];return function(t){t.$;var i=t.$h;t.$root,t.$f7,t.$f7route,t.$f7router,t.$theme,t.$update,t.$store;return i`
    <div class="page" data-name="profile-show">

        <${la} breadcrumbs=${o} active="profile" />
...
`}}Un.id="6ca3c4ef5b",Un.style="\n    .author-photo-preview {\n        max-width: 100%;\n        max-height: 200px;\n        border: 1px solid #cccccc;\n        padding: 5px;\n        margin-bottom: 10px;\n    }\n";const Hn=Un;var zn=function(e,t,i,a){var n,s=arguments.length,o=s<3?t:null===a?a=Object.getOwnPropertyDescriptor(t,i):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,i,a);else for(var r=e.length-1;r>=0;r--)(n=e[r])&&(o=(s<3?n(o):s>3?n(t,i,o):n(t,i))||o);return s>3&&o&&Object.defineProperty(t,i,o),o},qn=function(e,t){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(e,t)};let Gn=class{authorWebService;schemaService;constructor(e,t){this.authorWebService=e,this.schemaService=t}async show(){return new na((async e=>{let t;await this.schemaService.loadChannel(e.params.channelId);try{t=await this.authorWebService.get(e.params.id)}catch(e){console.log(e)}return t||(t=Object.assign(new R,{author:{walletAddress:e.params.id}})),{authorViewModel:t}}),Ln)}async edit(){return new na((async e=>{let t;await this.schemaService.loadChannel(e.params.channelId);try{t=await this.authorWebService.get(e.params.id)}catch(e){}return t||(t=Object.assign(new R,{author:{walletAddress:e.params.id}})),{authorViewModel:t}}),Hn)}};function Jn(e,{$:t,$on:i,$f7:a,$update:s}){let o=n.getInstance(Ft),r=n.getInstance(wi),c=e.settings,l=[{text:"Home",path:"/"},{text:"Settings"}];const f=async e=>{e.preventDefault();let t=a.form.convertToData("#edit-settings-form"),i={_id:t._id,_rev:t._rev,ipfsHost:t.ipfsHost,defaultGitProvider:t.gitProvider,gitCorsProxy:t.gitCorsProxy,gitProviders:{gitlab:{name:"gitlab",username:t.gitLabUsername,personalAccessToken:t.gitLabPersonalAccessToken},github:{name:"github",username:t.gitHubUsername,personalAccessToken:t.gitHubPersonalAccessToken}},alchemyKey:t.alchemyKey,huggingFace:t.huggingFace};try{let e=Object.assign(new M,i);await o.put(e),c?.ipfsHost!=e?.ipfsHost&&await r.clearInit();a.toast.show({text:"Settings Saved",closeTimeout:2e3,closeButton:!0,position:"bottom",horizontalPosition:"left"});a.views.main.router.navigate("/")}catch(e){console.log(e.errors),a.dialog.alert(e,"Saving settings failed")}},d=async e=>{c.gitProvider=t(e.currentTarget).val(),await s()};return i("pageInit",(async e=>{})),function(e){e.$;var t=e.$h;e.$root,e.$f7,e.$f7route,e.$f7router,e.$theme,e.$update,e.$store;return t`
        ...
        <div class="page-content hide-toolbar-on-scroll">
            ...
            <div class="fixed-width-content center">
                ...
                <form id="edit-settings-form" @submit="${f}">
                    ...
                    <input type="hidden" name="_rev" value="${c?._rev}" />
                                ...
                                <ul>
                                    <li class="item-content item-input">
                                        ...
                                        <div class="item-inner">
                                            ...
                                            <div class="item-input-wrap">
                                                <input type="text" name="huggingFace" value="${c?.huggingFace}" placeholder="API token..." />
                                                <span class="input-clear-button"></span>
                                            </div>
                                        </div>
                                            ...
                                            <div class="item-inner">
                                                ...
                                                <div class="item-input-wrap">
                                                    <select @change="${d}" class="value-input" name="gitProvider">     
                                                        ...
                                                        ${c?.defaultGitProvider&&"github"!=c?.defaultGitProvider?t`
                                                            <option value="github">GitHub</option>
                                                        `:t`
                                                            <option value="github" selected>GitHub</option>
                                                        `}
                                                                ...
                                                                <div class="item-inner">
                                                                    ...
                                                                    <div class="item-input-wrap">
                                                                        <input type="text" name="gitHubUsername" placeholder="Username"
                                                                            value="${c.gitProviders?.github?.username}"  />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </li>
                                                                ...
                                                                <div class="item-inner">
                                                                    ...
                                                                    <div class="item-input-wrap">
                                                                        <input type="text" name="gitHubPersonalAccessToken" placeholder="Personal access token"
                                                                            value="${c.gitProviders?.github?.personalAccessToken}"  />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </li>
                                                                ...
                                                                <div class="item-inner">
                                                                    ...
                                                                    <div class="item-input-wrap">
                                                                        <input type="text" name="gitLabUsername" placeholder="Username"
                                                                            value="${c.gitProviders?.gitlab?.username}"  />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </li>
                                                                ...
                                                                <div class="item-inner">
                                                                    ...
                                                                    <div class="item-input-wrap">
                                                                        <input type="text" name="gitLabPersonalAccessToken" placeholder="Personal access token"
                                                                            value="${c.gitProviders?.gitlab?.personalAccessToken}"  />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </li>
                                ...
                                <ul>
                                    <li class="item-content item-input item-input-with-info">
                                        ...
                                        <div class="item-inner">
                                            ...
                                            <div class="item-input-wrap">
                                                <input type="text" name="ipfsHost" value="${c?.ipfsHost}" placeholder="Example: https://localhost:5001/api/v0" />
                                                <span class="input-clear-button"></span>
                                ...
                                <ul>
                                    <li class="item-content item-input">
                                        ...
                                        <div class="item-inner">
                                            ...
                                            <div class="item-input-wrap">
                                                <input type="text" name="alchemyKey" value="${c?.alchemyKey}" placeholder="API key..." />
                                                <span class="input-clear-button"></span>
                                            </div>
                                        </div>
...
`}}Zn([sa("/admin/settings"),Vn("design:type",Function),Vn("design:paramtypes",[]),Vn("design:returntype",Promise)],Kn.prototype,"show",null),Kn=Zn([(0,s.b)(),Vn("design:paramtypes",[Ft])],Kn),Yn.id="c0cfd79399";const Qn=Yn;var Xn=function(e,t,i,a){var n,s=arguments.length,o=s<3?t:null===a?a=Object.getOwnPropertyDescriptor(t,i):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,i,a);else for(var r=e.length-1;r>=0;r--)(n=e[r])&&(o=(s<3?n(o):s>3?n(t,i,o):n(t,i))||o);return s>3&&o&&Object.defineProperty(t,i,o),o},es=function(e,t){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(e,t)};let ts=class{ipfsService;constructor(e){this.ipfsService=e}async show(){return new na((async e=>{if(!this.ipfsService.ipfs)return{};let t=await this.ipfsService.ipfs.swarm.peers(),i=await this.ipfsService.ipfs.id();return{peers:t.map((e=>e.addr.toString())),peerCount:t.length,addresses:i?.addresses?.map((e=>e.toString()))}}),Qn)}};function is(e,{$:t,$h:i,$on:a,$f7:s,$update:o}){let r,c=e.channelViewModel,l=[{text:"Home",path:"/"},{text:c.channel.title,path:`/admin/channel/show/${c.channel._id}`},{text:"Publish"}];return a("pageInit",(async(e,t)=>{r=n.getWalletService(),await o()})),function(e){e.$;var t=e.$h;e.$root,e.$f7,e.$f7route,e.$f7router,e.$theme,e.$update,e.$store;return t`
                                ...
                                ${f.channel.publishReaderIPFSStatus?.status?t`
                                    ...
                                    <div class="pin-status"> 
                                        ...
                                        ${"complete"==f.channel.publishReaderIPFSStatus?.status&&f.channel.publishReaderIPFSStatus?.cid?t`
                                            ...
                                            <strong>Date:</strong> ${ra()(f.channel.publishReaderIPFSStatus?.date).format("MMMM Do YYYY, h:mm:ss a")}
                                        `:t` `}
...
`}}os.id="ebe9b031aa",os.style="\n  .publish-label,\n  .ipfs-label,\n  .forking-label {\n    margin-top: 10px;\n    margin-bottom: 10px;\n    font-weight: bold;\n    font-size: 18px;\n  }\n\n  .publish-output {\n    border: 1px solid #cccccc;\n    font-size: 13px;\n    width: 100%;\n    max-width: 100%;\n    padding: 5px;\n    height: 300px;\n    overflow-y: scroll;\n  }\n\n  #fork-next-button {\n    width: 200px;\n  }\n";const rs=os;var cs=i(76551),ls=i.n(cs),fs=i(26470),ds=i.n(fs),ps=i(26015),us=i(48764).Buffer,hs=function(e,t,i,a){var n,s=arguments.length,o=s<3?t:null===a?a=Object.getOwnPropertyDescriptor(t,i):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,i,a);else for(var r=e.length-1;r>=0;r--)(n=e[r])&&(o=(s<3?n(o):s>3?n(t,i,o):n(t,i))||o);return s>3&&o&&Object.defineProperty(t,i,o),o},gs=function(e,t){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(e,t)},ms=function(e,t){return function(i,a){t(i,a,e)}};let vs=class{channelService;itemService;ipfsService;imageService;animationService;exportService;settingsService;walletService;constructor(e,t,i,a,n,s,o,r){this.channelService=e,this.itemService=t,this.ipfsService=i,this.imageService=a,this.animationService=n,this.exportService=s,this.settingsService=o,this.walletService=r}async publish(e,t){this.logPublishProgress(void 0,"Preparing export...");let i=await this.exportService.prepareExport(e,this.walletService.address),a=await this.getFeeReceipient(i.channel,i.ownerAddress);a&&this.logPublishProgress(void 0,`Fee Recipient: ${a}`),this.logPublishProgress(void 0,"Preparing backup...");let n,s=await this.exportService.createBackup(i);return e.contractAddress?e.publishReaderIPFSStatus?.cid&&(n={cid:e.publishReaderIPFSStatus.cid}):(this.logPublishProgress(void 0,"Exporting to IPFS..."),n=await this.exportToIPFS(i,s,a)),this.logPublishProgress(void 0,"Exporting to file system..."),await this.exportToFS(t,e,i,s,a,n),{cids:n}}async exportToIPFS(e,t,i){let a=!0,n=this.getIPFSDirectory(e.channel);try{await this.ipfsService.ipfs.files.read(n),await this.ipfsService.ipfs.files.rm(n,{recursive:!0,flush:!0})}catch(e){}let s={contractMetadata:{saved:0,total:1},nftMetadata:{saved:0,total:e.items.length},images:{saved:0,total:e.imageCids.length},animations:{saved:0,total:e.animationCids.length},backups:{channels:{saved:0,total:1},authors:{saved:0,total:1},items:{saved:0,total:t.itemCount},images:{saved:0,total:e.imageCids.length},animations:{saved:0,total:e.animationCids.length},themes:{saved:0,total:t.themeCount},staticPages:{saved:0,total:t.staticPageCount}}};this.logPublishProgress(s),await this._publishImagesIPFS(s,n,e.imageCids,!0),await this._publishAnimationsIPFS(s,n,e.animationCids,!0),await this._publishNFTMetadataIPFS(s,n,e.channel,e.items,!0);let o=`${n}/contractMetadata.json`,r=await this.channelService.exportContractMetadata(e.channel,i);await this.ipfsService.ipfs.files.write(o,(new TextEncoder).encode(JSON.stringify(r)),{create:!0,parents:!0,flush:a});let c=await this.ipfsService.ipfs.files.stat(o);s.contractMetadata.saved=1,this.logPublishProgress(s,`Saving contract metadata to ${o} (${c.cid})`),await this.ipfsService.ipfs.files.write(`${n}/backup/channels.json`,(new TextEncoder).encode(JSON.stringify(t.channels)),{create:!0,parents:!0,flush:a}),s.backups.channels.saved=1,this.logPublishProgress(s),await this.ipfsService.ipfs.files.write(`${n}/backup/authors.json`,(new TextEncoder).encode(JSON.stringify(t.authors)),{create:!0,parents:!0,flush:a}),s.backups.authors.saved=1,this.logPublishProgress(s),await this.ipfsService.ipfs.files.write(`${n}/backup/items.json`,(new TextEncoder).encode(JSON.stringify(t.items)),{create:!0,parents:!0,flush:a}),s.backups.items.saved=t.itemCount,this.logPublishProgress(s),await this.ipfsService.ipfs.files.write(`${n}/backup/originalMetadata.json`,(new TextEncoder).encode(JSON.stringify(t.originalMetadata)),{create:!0,parents:!0,flush:a}),await this.ipfsService.ipfs.files.write(`${n}/backup/images.json`,(new TextEncoder).encode(JSON.stringify(t.images)),{create:!0,parents:!0,flush:a}),s.backups.images.saved=t.imageCount,this.logPublishProgress(s),await this.ipfsService.ipfs.files.write(`${n}/backup/animations.json`,(new TextEncoder).encode(JSON.stringify(t.animations)),{create:!0,parents:!0,flush:a}),s.backups.animations.saved=t.animationCount,this.logPublishProgress(s),await this.ipfsService.ipfs.files.write(`${n}/backup/themes.json`,(new TextEncoder).encode(JSON.stringify(t.themes)),{create:!0,parents:!0,flush:a}),s.backups.themes.saved=t.themeCount,this.logPublishProgress(s),await this.ipfsService.ipfs.files.write(`${n}/backup/static-pages.json`,(new TextEncoder).encode(JSON.stringify(t.staticPages)),{create:!0,parents:!0,flush:a}),s.backups.staticPages.saved=t.staticPageCount,this.logPublishProgress(s),this.logPublishProgress(s,"Flushing to IPFS..."),await this.ipfsService.ipfs.files.flush(`/export/${e.channel._id}/`);let l=await this.ipfsService.ipfs.files.stat(`/export/${e.channel._id}/`,{hash:!0});return this.logPublishProgress(s,`Published to local IPFS at ${l.cid.toString()}`),{cid:l.cid.toString()}}async exportToFS(e,t,i,a,n,s){await this._publishImagesFS(e,i.imageCids),await this._publishAnimationsFS(e,i.animationCids),await this._publishNFTMetadataFS(e,i.channel,i.items);let o=await this.channelService.exportContractMetadata(i.channel,n);await this._writeFSAction({file_path:`${e}/backup/export/contractMetadata.json`,content:us.from(JSON.stringify(o))}),t.contractAddress?(await this._writeFSAction({file_path:`${e}/backup/contract/contract.json`,content:us.from(JSON.stringify({contractAddress:t.contractAddress,ipfsCid:t.publishReaderIPFSStatus?.cid}))}),await this._writeFSAction({file_path:`${e}/backup/contract/contract-abi.json`,content:us.from(JSON.stringify(ps))})):(await this._writeFSAction({file_path:`${e}/backup/contract/contract.json`,content:us.from(JSON.stringify({}))}),await this._writeFSAction({file_path:`${e}/backup/contract/contract-abi.json`,content:us.from(JSON.stringify({}))}));let r=await(async e=>{let t,i=await this.settingsService.get();switch(t=e.gitProvider&&"default"!=e.gitProvider?e.gitProvider:i.defaultGitProvider?i.defaultGitProvider:"github",t){case"gitlab":if(!e.httpUrlToRepo)return;return{hostname:`https://${a=e.httpUrlToRepo,a.replace("https://gitlab.com/","").split("/")[0]}.gitlab.io`,baseURI:`/${e.title.replace(/[^a-z0-9]/gi,"-").toLowerCase()}/`};case"github":function n(e){return e.replace("https://github.com/","").split("/")[0]}if(!e.httpUrlToRepo)return;return{hostname:`https://${n(e.httpUrlToRepo)}.github.io`,baseURI:`/${e.title.replace(/[^a-z0-9]/gi,"-").toLowerCase()}/`}}var a})(t);await this._writeFSAction({file_path:`${e}/large-config.json`,content:us.from(JSON.stringify({showMintPage:t.showMintPage,showActivityPage:t.showActivityPage,hostname:t.productionHostname?t.productionHostname:r?.hostname,libraryURL:t.productionBaseLibraryURI,baseURL:t.productionBaseURI?t.productionBaseURI:r?.baseURI,externalLinks:t.externalLinks,marketplaces:t.marketplaces}))}),await this._writeFSAction({file_path:`${e}/backup/export/backup/channels.json`,content:us.from(JSON.stringify(a.channels))}),await this._writeFSAction({file_path:`${e}/backup/export/backup/authors.json`,content:us.from(JSON.stringify(a.authors))}),await this._writeFSAction({file_path:`${e}/backup/export/backup/items.json`,content:us.from(JSON.stringify(a.items))}),await this._writeFSAction({file_path:`${e}/backup/export/backup/originalMetadata.json`,content:us.from(JSON.stringify(a.originalMetadata))}),await this._writeFSAction({file_path:`${e}/backup/export/backup/images.json`,content:us.from(JSON.stringify(a.images))}),await this._writeFSAction({file_path:`${e}/backup/export/backup/animations.json`,content:us.from(JSON.stringify(a.animations))}),await this._writeFSAction({file_path:`${e}/backup/export/backup/themes.json`,content:us.from(JSON.stringify(a.themes))}),await this._writeFSAction({file_path:`${e}/backup/export/backup/static-pages.json`,content:us.from(JSON.stringify(a.staticPages))})}getIPFSDirectory(e){return`/export/${e._id}`}async getAnimationDirectoryCid(e){let t;try{t=(await this.ipfsService.ipfs.files.stat(`${e}/animations/`,{hash:!0})).cid.toString()}catch(e){}return t}async getImageDirectoryCid(e){let t;try{t=(await this.ipfsService.ipfs.files.stat(`${e}/images/`,{hash:!0})).cid.toString()}catch(e){}return t}async getFeeReceipient(e,t){let i;return"existing"==e.forkType?e.forkedFromFeeRecipient&&(i=e.forkedFromFeeRecipient):i=t,i}async _publishAnimationsIPFS(e,t,i,a){this.logPublishProgress(e,`Exporting ${i.length} animations`);for(let n of i){let i,s=await this.animationService.get(n),o=`${t}/animations/${s.cid}.html`,r={content:s.content};try{i=await this.ipfsService.ipfs.files.stat(o,{hash:!0})}catch(e){}if(i?.cid.toString())this.logPublishProgress(e,`${o} already exists. Skipping...`);else{const i=await this.ipfsService.ipfs.add(r);if(await this.ipfsService.ipfs.files.cp(`/ipfs/${i.cid.toString()}`,o,{parents:!0,flush:a}),i.cid.toString()!==s.cid.toString())throw new Error(`Incorrect cid when saving animation. Expected: ${s.cid}, Result: ${i.cid.toString()}`);this.logPublishProgress(e,`Saving animation #${e.animations.saved} to ${t}/animations/${s.cid}.html (${s.cid})`)}e.animations.saved++}}async _publishAnimationsFS(e,t){for(let i of t){let t=await this.animationService.get(i),a={content:t.content};await this._writeFSAction({file_path:`${e}/backup/export/animations/${t.cid}.html`,content:us.from(a.content)})}}async _publishImagesIPFS(e,t,i,a){for(let n of i){let i,s=await this.imageService.get(n),o=`${t}/images/${s.cid}.${s.buffer?"jpg":"svg"}`;try{i=await this.ipfsService.ipfs.files.stat(o,{hash:!0})}catch(e){}if(i?.cid.toString())this.logPublishProgress(e,`${o} already exists. Skipping...`);else{const t=await this.ipfsService.ipfs.add({content:await this.imageService.getImageContent(s)});if(t.cid.toString()!=s.cid)throw new Error(`Incorrect cid when saving image. Expected: ${s.cid}, Result: ${t.cid.toString()}`);await this.ipfsService.ipfs.files.cp(`/ipfs/${t.cid.toString()}`,o,{create:!0,parents:!0,flush:a}),this.logPublishProgress(e,`Saving image to ${o} (${s.cid})`)}e.images.saved++}}async _publishImagesFS(e,t){for(let i of t){let t=await this.imageService.get(i),a=await this.imageService.getImageContent(t);await this._writeFSAction({file_path:`${e}/backup/export/images/${t.cid}.${t.buffer?"jpg":"svg"}`,content:a})}}async _publishNFTMetadataIPFS(e,t,i,a,n){this.logPublishProgress(e,`Exporting ${a.length} metadata files`);let s={};for(let o of a){let a,r=this.exportService.prepareItem(o),c=`${t}/metadata/${r.tokenId}.json`,l=await this.imageService.get(r.coverImageId),f=await this.itemService.exportNFTMetadata(i,r,l),d=(new TextEncoder).encode(JSON.stringify(f)),p=await vt.of(d);s[p]=f;try{a=await this.ipfsService.ipfs.files.stat(c,{hash:!0})}catch(e){}if(a?.cid.toString()!=p){const e=await this.ipfsService.ipfs.add({content:d});await this.ipfsService.ipfs.files.cp(`/ipfs/${e.cid.toString()}`,c,{create:!0,parents:!0,flush:n})}else this.logPublishProgress(e,`${c} already exists. Skipping...`);e.nftMetadata.saved++,this.logPublishProgress(e,`Saving #${r.tokenId} to ${c}`)}return[]}async _publishNFTMetadataFS(e,t,i){for(let a of i){let i=this.exportService.prepareItem(a),n=await this.imageService.get(i.coverImageId),s=await this.itemService.exportNFTMetadata(t,i,n);await this._writeFSAction({file_path:`${e}/backup/export/metadata/${i.tokenId}.json`,content:us.from(JSON.stringify(s))})}}_writeFSAction(e){ls().existsSync(ds().dirname(e.file_path))||ls().mkdirSync(ds().dirname(e.file_path),{recursive:!0}),e.keepExisting&&ls().existsSync(e.file_path)||(console.log(`Writing file: ${e.file_path}`),ls().writeFileSync(e.file_path,e.content))}logPublishProgress(e,t){if(t&&console.log(t),"undefined"!=typeof window&&void 0!==window.document){const i=new CustomEvent("publish-progress",{detail:{publishStatus:e,message:t}});document.dispatchEvent(i)}}};function bs(e,{$:t,$h:i,$on:a,$f7:s,$update:o}){let r,c=n.getInstance(mi),l=n.getInstance(wi),f=(n.getInstance(Ze),n.getInstance(Xi),n.getInstance(_n)),d=(n.getInstance(vs),null!=l.ipfs),p=l.peerCount,u=e.channelViewModel,h=e.settings,g=!1,m="",v=u.channel.publishReaderRepoId>0&&"complete"==u.channel.publishReaderRepoStatus,b=null!=u.channel.localCid,y=u.itemCount>0,w=u?.gitProvider?.personalAccessToken?.length>0,S=h?.gitCorsProxy?.length>0,$=y&&w&&S,k=u.channel.httpUrlToRepo,I=[{text:"Home",path:"/"},{text:u.channel.title,path:`/admin/channel/show/${u.channel._id}`},{text:"Publish",path:`/admin/publish/${u.channel._id}`},{text:"Publish Collection To Reader"}];a("pageInit",(async()=>{await l.init(),d=null!=l.ipfs,r=await c.getGitProviderCredentials(u.channel,h),await o()}));const R=async e=>{e.preventDefault(),g=!0,await o();let t=document.getElementsByClassName("ipfs-label")[0];s.preloader.showIn(t);try{let e=`/export/${u.channel._id}`,t=await(0,Ba.Z)(l.ipfs.files.read(`${e}/contractMetadata.json`));await f.deployReaderGit(u.channel,t)}catch(e){console.log(e),s.dialog.alert(e,"There was an error")}s.preloader.hideIn(t),g=!1,await o()},x=async e=>{e.preventDefault();let t=document.getElementsByClassName("ipfs-label")[0];s.preloader.showIn(t);try{await f.clearGitRepos()}catch(e){s.dialog.alert(e,"There was an error")}s.preloader.hideIn(t),await o()};return t(document).on("publish-reader-progress",(async e=>{m=`<p>${e.detail.message}</p>`,o()})),t(document).on("update-peers",(async e=>{p=e.detail.count,o()})),function(e){e.$;var t=e.$h;e.$root,e.$f7,e.$f7route,e.$f7router,e.$theme,e.$update,e.$store;return t`
  ...
  `}}vs=hs([(0,s.b)(),ms(7,(0,o.f)(a.WalletService)),gs("design:paramtypes",[mi,fi,wi,Ct,_i,Oi,Ft,Object])],vs),bs.id="30c53cd39c",bs.style="\n\n    .publish-label, .ipfs-label, .forking-label {\n      margin-top: 10px;\n      margin-bottom: 10px;\n      font-weight: bold;\n      font-size: 18px;\n    }\n\n    .publish-output {\n      border: 1px solid #cccccc;\n      font-size: 13px;\n      width: 100%;\n      max-width: 100%;\n      padding: 5px;\n      height: 300px;\n      overflow-y : scroll;\n    }\n  ";const ys=bs;var ws=i(41972),Ss=function(e,t,i,a){var n,s=arguments.length,o=s<3?t:null===a?a=Object.getOwnPropertyDescriptor(t,i):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,i,a);else for(var r=e.length-1;r>=0;r--)(n=e[r])&&(o=(s<3?n(o):s>3?n(t,i,o):n(t,i))||o);return s>3&&o&&Object.defineProperty(t,i,o),o},$s=function(e,t){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(e,t)},ks=function(e,t){return function(i,a){t(i,a,e)}};let Is=class{channelService;walletService;contracts;constructor(e,t,i){this.channelService=e,this.walletService=t,this.contracts=i}async deployContract(e){if(!e.publishReaderIPFSStatus?.cid)throw new Error("Not published to IPFS");let t=await this.channelService.countItemsByChannel(e._id);if(t<=0)throw new Error("No NFTs");let i=ga.vz(e.mintPrice,"ether"),a=await this.deploy(e.title,e.symbol,e.publishReaderIPFSStatus?.cid,i.toString(),t);e.contractAddress=a.contractAddress,e.showActivityPage=!0,e.showMintPage=!0,await this.channelService.put(e)}async deploy(e,t,i,a,n){if(!(e&&t&&a&&n&&i))throw new Error("Missing inputs to deploy");let s=this.walletService.wallet;if(!s)throw new Error("No wallet!");const o=this.contracts.Channel,r=new ws.l(o.abi,o.bytecode,s);return(await r.deploy(e,t,i,BigInt(a.toString()),BigInt(n.toString()))).deploymentTransaction().wait()}};function Rs(e,{$:t,$h:i,$on:a,$f7:s,$update:o}){let r,c=n.getInstance(mi),l=(n.getInstance(wi),n.getInstance(Ze)),f=(n.getInstance(Xi),n.getInstance(Is)),d=e.channelViewModel,p=!1,u=null!=d.channel.publishReaderIPFSStatus?.cid||d.channel.contractAddress,h=[{text:"Home",path:"/"},{text:d.channel.title,path:`/admin/channel/show/${d.channel._id}`},{text:"Publish",path:`/admin/publish/${d.channel._id}`},{text:"Deploy Contract"}];a("pageInit",(async(e,t)=>{r=n.getWalletService(),await o()}));const g=async e=>{p=!0,await o();let t={title:`Deploying contract ${name}. Approve transaction and wait for it to be mined.`,promise:f.deployContract(d.channel)};await l.queuePromiseView(t),p=!1,await o()},m=async e=>{d.channel.contractAddress=void 0,await c.put(d.channel),d.channel=await c.get(d.channel._id),o()};return function(e){e.$;var t=e.$h;e.$root,e.$f7,e.$f7route,e.$f7router,e.$theme,e.$update,e.$store;return t`
                  ...
                  <div class="card-content card-content-padding">
                    ...
                    ${u?t`
                      ...
                      <div class="pin-status">
                        ...
                        <p><strong>Date Exported:</strong> ${ra()(d.channel.publishReaderIPFSStatus?.date).format("MMMM Do YYYY, h:mm:ss a")}</p>
                      </div>
  ...
  `}}Is=Ss([(0,s.b)(),ks(1,(0,o.f)(a.WalletService)),ks(2,(0,o.f)("contracts")),$s("design:paramtypes",[mi,Object,Object])],Is),Rs.id="1da465f1b6",Rs.style="\n\n  ";const xs=Rs;var _s=function(e,t,i,a){var n,s=arguments.length,o=s<3?t:null===a?a=Object.getOwnPropertyDescriptor(t,i):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,i,a);else for(var r=e.length-1;r>=0;r--)(n=e[r])&&(o=(s<3?n(o):s>3?n(t,i,o):n(t,i))||o);return s>3&&o&&Object.defineProperty(t,i,o),o},Ps=function(e,t){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(e,t)};let Cs=class{channelWebService;settingsService;schemaService;gitlabService;constructor(e,t,i,a){this.channelWebService=e,this.settingsService=t,this.schemaService=i,this.gitlabService=a}async publish(){return new na((async e=>(await this.schemaService.loadChannel(e.params.id),{channelViewModel:await this.channelWebService.get(e.params.id)})),as)}async export(){return new na((async e=>{await this.schemaService.loadChannel(e.params.id);let t,i=await this.channelWebService.get(e.params.id);try{t=await this.settingsService.get()}catch(e){}return{channelViewModel:i,settings:t}}),ss)}async forkReader(){return new na((async e=>{await this.schemaService.loadChannel(e.params.id);let t,i=await this.channelWebService.get(e.params.id);try{t=await this.settingsService.get()}catch(e){}return{channelViewModel:i,settings:t}}),rs)}async publishReader(){return new na((async e=>{await this.schemaService.loadChannel(e.params.id);let t,i=await this.channelWebService.get(e.params.id);try{t=await this.settingsService.get()}catch(e){}return{channelViewModel:i,settings:t}}),ys)}async contract(){return new na((async e=>(await this.schemaService.loadChannel(e.params.id),{channelViewModel:await this.channelWebService.get(e.params.id)})),xs)}};_s([sa("/admin/publish/:id"),Ps("design:type",Function),Ps("design:paramtypes",[]),Ps("design:returntype",Promise)],Cs.prototype,"publish",null),_s([sa("/admin/publish/export/:id"),Ps("design:type",Function),Ps("design:paramtypes",[]),Ps("design:returntype",Promise)],Cs.prototype,"export",null),_s([sa("/admin/publish/fork-reader/:id"),Ps("design:type",Function),Ps("design:paramtypes",[]),Ps("design:returntype",Promise)],Cs.prototype,"forkReader",null),_s([sa("/admin/publish/publish-reader/:id"),Ps("design:type",Function),Ps("design:paramtypes",[]),Ps("design:returntype",Promise)],Cs.prototype,"publishReader",null),_s([sa("/admin/publish/contract/:id"),Ps("design:type",Function),Ps("design:paramtypes",[]),Ps("design:returntype",Promise)],Cs.prototype,"contract",null),Cs=_s([(0,s.b)(),Ps("design:paramtypes",[zi,Ft,Ne,Xi])],Cs);var js=function(e,t,i,a){var n,s=arguments.length,o=s<3?t:null===a?a=Object.getOwnPropertyDescriptor(t,i):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,i,a);else for(var r=e.length-1;r>=0;r--)(n=e[r])&&(o=(s<3?n(o):s>3?n(t,i,o):n(t,i))||o);return s>3&&o&&Object.defineProperty(t,i,o),o},Ts=function(e,t){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(e,t)};let As=class{constructor(){}buildPagingViewModel(e,t,i,a){let n=new Os;return n.offset=e||0,n.limit=t,n.count=i,n.start=n.offset+1,n.end=Math.min(n.offset+t,i),n.previousOffset=Math.max(n.offset-t,0),n.offset+t<i&&(n.nextOffset=n.offset+t),n.page=n.offset/n.limit+1,n.page>n.endPage&&(n.page=n.endPage),n.endPage=Math.ceil(n.count/n.limit),n.lastOffset=n.endPage*n.limit-n.limit,n.showNext=n.endPage>n.page,n.showPrevious=0!=n.offset,n.showFirst=n.page>2,n.showLast=n.page<n.endPage-1,n}calculateEndIndex(e,t,i){let a=t+e-1;return Math.min(i-1,a)}calculateDescendingEndIndex(e,t){let i=t-(e-1);return Math.max(0,i)}calculateDescendingOffset(e,t){let i=t-1-e;return Math.max(0,i)}};As=js([(0,s.b)(),Ts("design:paramtypes",[])],As);class Os{page;pageNumbers;endPage;offset;limit;count;start;end;previousOffset;nextOffset;lastOffset;showPrevious;showNext;showFirst;showLast}var Fs=i(87470);function Es(e,{$:t,$on:i,$f7:a,$update:s}){n.getInstance(fi);let o=n.getInstance(mi),r=n.getWalletService(),c=e.channel_view_model;const l=async e=>{a.dialog.confirm("Are you sure you want to delete this collection? This will only remove your local copy of the files.",(async()=>{a.preloader.show(),await o.delete(c.channel),a.preloader.hide(),a.views.main.router.navigate("/");a.toast.show({text:"Collection deleted",closeTimeout:2e3,closeButton:!0,position:"bottom",horizontalPosition:"left"})}))};return function(e){e.$;var t,i=e.$h;e.$root,e.$f7,e.$f7route,e.$f7router,e.$theme,e.$update,e.$store;return i`
  ...
  <div class="card card-outline channel-card-show">
    ...
    <div class="card-header banner show-channel-banner-${c.channel._id}">
      ...
      ${c?.coverImage?i`
      <img src="${c.coverImage.url}" class="avatar" />
      `:i`
      <i class="material-icons avatar">image</i>
      `}
