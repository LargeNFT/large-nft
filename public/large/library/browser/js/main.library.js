...
`}}Q.id="86faf3e8a3";const K=Q,X=(e,{$h:t})=>{globalThis.container.get("WalletService");let a=globalThis.container.get("TransactionWebService");const n=e=>`${o+e}`;let i=e.transaction,r=e.event,o=e.base_uri,s=e.row_item_view_models,c=e.index;return()=>t`
