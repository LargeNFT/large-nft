  ...
  <div class="page" data-name="admin-show-collection">
    ...
    <div class="page-content infinite-scroll-content hide-toolbar-on-scroll" id="item-list-infinite-scroll">
      ...
      <div class="fixed-width-content center">
        ...
        <${ya} channel=${r.channel._id} token_id="1" />
...
`}}wa.id="8b37d844ff",wa.style="\n  \n\n";const Sa=wa;function $a(e,{$:t,$on:i,$f7:a,$update:n}){let s=e.theme,o=e.cover_image_css_editor_id,f=e.animation_css_editor_id;return function(e){e.$;var t=e.$h;e.$root,e.$f7,e.$f7route,e.$f7router,e.$theme,e.$update,e.$store;return t`
            ...
            <div class="page">
              ...
              <div class="page-content">
                <form id="add-theme-form" @submit="${v}">
                  <${ka} cover_image_css_editor_id="add-theme-cover-image-editor"
            ...
            <div class="page">
              ...
              <div class="page-content">
                <form id="edit-theme-form" @submit="${b}">
                  ...
                  <${ka} cover_image_css_editor_id="edit-theme-cover-image-editor"
            ...
            <div class="page">
              ...
              <div class="page-content">
                <form id="add-static-page-form" @submit="${b}">
                  <${_a} static_page_content_editor_id="add-static-page-content-editor"
            ...
            <div class="page">
              ...
              <div class="page-content">
                <form id="edit-static-page-form" @submit="${y}">
                  ...
                  <${_a} static_page_content_editor_id="edit-static-page-content-editor"
...
`}}ja.id="825d0e6d1c",ja.style="\n";const Ta=ja;function Aa(e,{$:t,$on:i,$f7:a,$update:s}){let o,f=[{text:"Home",path:"/"},{text:"Create & Import"}];return i("pageInit",(async()=>{o=n.getWalletService(),await s()})),function(e){e.$;var t=e.$h;e.$root,e.$f7,e.$f7route,e.$f7router,e.$theme,e.$update,e.$store;return t`
...
`}}fn.id="6ec32fb449",fn.style="\n\n";const rn=fn;var cn=function(e,t,i,a){var n,s=arguments.length,o=s<3?t:null===a?a=Object.getOwnPropertyDescriptor(t,i):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,i,a);else for(var f=e.length-1;f>=0;f--)(n=e[f])&&(o=(s<3?n(o):s>3?n(t,i,o):n(t,i))||o);return s>3&&o&&Object.defineProperty(t,i,o),o},ln=function(e,t){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(e,t)},dn=function(e,t){return function(i,a){t(i,a,e)}};let pn=class{channelWebService;itemWebService;schemaService;themeService;staticPageService;footerText;constructor(e,t,i,a,n,s){this.channelWebService=e,this.itemWebService=t,this.schemaService=i,this.themeService=a,this.staticPageService=n,this.footerText=s}async app(){return new aa((async e=>({footerText:this.footerText})),ra)}async create(){return new aa((async e=>{}),va)}async createMenu(){return new aa((async e=>{}),Fa)}async fork(){return new aa((async e=>({cid:e.query.cid})),tn)}async forkContract(){return new aa((async e=>({footerText:this.footerText,contractAddress:e.query.contractAddress})),nn)}async forkReader(){return new aa((async e=>({footerText:this.footerText})),on)}async show(){return new aa((async e=>{await this.schemaService.loadChannel(e.params.id);let t=await this.channelWebService.get(e.params.id);return{channelViewModel:t,firstPageItems:await this.itemWebService.listByChannel(t.channel._id,ee.CHUNK_SIZE,0)}}),Sa)}async themes(){return new aa((async e=>{await this.schemaService.loadChannel(e.params.id);let t=await this.channelWebService.get(e.params.id);return{channelViewModel:t,themes:await this.themeService.listByChannel(t.channel._id,1e3,0)}}),Ra)}async staticPages(){return new aa((async e=>{await this.schemaService.loadChannel(e.params.id);let t=await this.channelWebService.get(e.params.id);return{channelViewModel:t,staticPages:await this.staticPageService.listByChannel(t.channel._id,1e3,0)}}),Ca)}async edit(){return new aa((async e=>(await this.schemaService.loadChannel(e.params.id),{channelViewModel:await this.channelWebService.get(e.params.id)})),Ta)}async upgrade(){return new aa((async e=>(await this.schemaService.loadChannel(e.params.id),{channelViewModel:await this.channelWebService.get(e.params.id)})),rn)}};cn([na("/"),ln("design:type",Function),ln("design:paramtypes",[]),ln("design:returntype",Promise)],pn.prototype,"app",null),cn([na("/admin/channel/create"),ln("design:type",Function),ln("design:paramtypes",[]),ln("design:returntype",Promise)],pn.prototype,"create",null),cn([na("/admin/channel/create-menu"),ln("design:type",Function),ln("design:paramtypes",[]),ln("design:returntype",Promise)],pn.prototype,"createMenu",null),cn([na("/admin/channel/fork"),ln("design:type",Function),ln("design:paramtypes",[]),ln("design:returntype",Promise)],pn.prototype,"fork",null),cn([na("/admin/channel/fork-contract"),ln("design:type",Function),ln("design:paramtypes",[]),ln("design:returntype",Promise)],pn.prototype,"forkContract",null),cn([na("/admin/channel/fork-reader"),ln("design:type",Function),ln("design:paramtypes",[]),ln("design:returntype",Promise)],pn.prototype,"forkReader",null),cn([na("/admin/channel/show/:id"),ln("design:type",Function),ln("design:paramtypes",[]),ln("design:returntype",Promise)],pn.prototype,"show",null),cn([na("/admin/channel/themes/:id"),ln("design:type",Function),ln("design:paramtypes",[]),ln("design:returntype",Promise)],pn.prototype,"themes",null),cn([na("/admin/channel/static-pages/:id"),ln("design:type",Function),ln("design:paramtypes",[]),ln("design:returntype",Promise)],pn.prototype,"staticPages",null),cn([na("/admin/channel/edit/:id"),ln("design:type",Function),ln("design:paramtypes",[]),ln("design:returntype",Promise)],pn.prototype,"edit",null),cn([na("/admin/channel/upgrade/:id"),ln("design:type",Function),ln("design:paramtypes",[]),ln("design:returntype",Promise)],pn.prototype,"upgrade",null),pn=cn([(0,s.b)(),dn(5,(0,o.f)("footer-text")),ln("design:paramtypes",[Hi,Ni,Ne,Rt,Ti,String])],pn);var un,hn=i(6869),mn=i.n(hn),gn=i(48764).Buffer,vn=function(e,t,i,a){var n,s=arguments.length,o=s<3?t:null===a?a=Object.getOwnPropertyDescriptor(t,i):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,i,a);else for(var f=e.length-1;f>=0;f--)(n=e[f])&&(o=(s<3?n(o):s>3?n(t,i,o):n(t,i))||o);return s>3&&o&&Object.defineProperty(t,i,o),o},bn=function(e,t){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(e,t)};let yn=un=class{settingsService;static BASE_URL="https://api.github.com";static GRAPHQL_URL="https://api.github.com/graphql";static READER_REPO_OWNER="LargeNFT";static READER_REPO="large-reader";constructor(e){this.settingsService=e}async createFork(e){console.log("Creating reader fork...");let t=(await this.settingsService.get()).gitProviders.github;if(t.personalAccessToken.length<1)throw new Error("Gitlab personal access token not set");let i=await this.getExistingFork(e);if(i)return i;let a=`${un.BASE_URL}/repos/${un.READER_REPO_OWNER}/${un.READER_REPO}/generate`,n=(await Wi.Z.post(a,{owner:t.username,name:this.getBranchName(e),include_all_branches:!1,private:!0},{headers:{Authorization:`Bearer ${t.personalAccessToken}`}})).data;return{id:n.id,httpUrlToRepo:n.html_url,path:n.name,branch:"master"}}async createVariables(e){let t=await this.settingsService.get(),i=t.gitProviders.github;if(i.personalAccessToken.length<1)throw new Error("Gitlab personal access token not set");t.alchemyKey&&await this._createVariable(e,i,"ALCHEMY_API_KEY",t.alchemyKey)}async _createVariable(e,t,i,a){let n=`${un.BASE_URL}/repos/${t.username}/${this.getBranchName(e)}/actions/secrets/public-key`;const s=a;let o=(await Wi.Z.get(n,{headers:{Authorization:`Bearer ${t.personalAccessToken}`}})).data;await mn().ready;let f=mn().from_base64(o.key,mn().base64_variants.ORIGINAL),r=mn().from_string(s),c=mn().crypto_box_seal(r,f),l=mn().to_base64(c,mn().base64_variants.ORIGINAL),d=`${un.BASE_URL}/repos/${t.username}/${this.getBranchName(e)}/actions/secrets/${i}`;return Wi.Z.put(d,{key_id:o.key_id,encrypted_value:l},{headers:{Authorization:`Bearer ${t.personalAccessToken}`}})}async getExistingFork(e){let t=(await this.settingsService.get()).gitProviders.github;if(t.personalAccessToken.length<1)throw new Error("Gitlab personal access token not set");try{let i=`${un.BASE_URL}/repos/${t.username}/${this.getBranchName(e)}`,a=(await Wi.Z.get(i,{headers:{Authorization:`Bearer ${t.personalAccessToken}`}})).data;if(a.id)return{id:a.id,httpUrlToRepo:a.html_url,path:a.name,branch:"master"}}catch(e){}}async getForkRepoStatus(e){if((await this.settingsService.get()).gitProviders.github.personalAccessToken.length<1)throw new Error("Gitlab personal access token not set");return await this.getExistingFork(e)?"finished":"pending"}async commit(e,t,i){let a,n=0,s=this.chunkIt(t,100);for(const[o,f]of s.entries()){n+=f.length,this.logPublishProgress(`Commiting reader data for ${e.title} to GitHub: committing ${f.length} actions. ${n} / ${t.length}`);let r=await this.getMostRecentCommitOid(e,i);const c=f.map((e=>({path:e.file_path.slice(1),contents:gn.from(e.content).toString("base64")})));let l="";l=o===s.length-1?"Commiting reader data complete":`Commiting reader data for ${e.title}`;const d=`\n                mutation createCommit($additions: [FileAddition!]!, $oid: GitObjectID!) {\n                    createCommitOnBranch (input: {\n                        branch : {\n                            repositoryNameWithOwner: "${i.username}/${this.getBranchName(e)}"\n                            branchName: "master"\n                        }\n                        message: {\n                            headline: "${l}"\n                        }\n                        fileChanges: {\n                            additions: $additions\n                        }\n                        expectedHeadOid: $oid\n                        }) {\n                        commit {\n                            commitUrl\n                        }\n                    }\n                }\n            `,p={oid:r,additions:c};a=(await Wi.Z.post(un.GRAPHQL_URL,{query:d,variables:p},{headers:{"Content-Type":"application/json",Authorization:`Bearer ${i.personalAccessToken}`}})).data.data.createCommitOnBranch.commit.commitUrl.split("/").pop(),this.logPublishProgress(`Commit successful: ${a}`)}return a}async getIPFSActionStatus(e){let t=(await this.settingsService.get()).gitProviders.github;if(t.personalAccessToken.length<1)throw new Error("Gitlab personal access token not set");try{let i=await this.getMostRecentActionRun(e,t);if(("success"==i?.conclusion||"skipped"==i?.conclusion)&&(!e.publishReaderIPFSStatus?.date||$i()(i.created_at).isAfter($i()(e.publishReaderIPFSStatus?.date))))return"finished"}catch(e){console.log(e)}}async getIPFSActionResult(e){let t=(await this.settingsService.get()).gitProviders.github;if(t.personalAccessToken.length<1)throw new Error(`${t.name} personal access token not set`);try{const i=await Wi.Z.get(`${un.BASE_URL}/repos/${t.username}/${e.publishReaderRepoPath}/contents/ipfs/ipfs.json`,{headers:{Authorization:`Bearer ${t.personalAccessToken}`}});let a=JSON.parse(gn.from(i.data.content,"base64").toString());return a.archive=`${e.httpUrlToRepo}/blob/master/ipfs/${a.cid}.car`,a}catch(e){console.log(e)}}async getMostRecentActionRun(e,t){if(!e.publishReaderIPFSStatus?.headSha)return;const i=await Wi.Z.get(`${un.BASE_URL}/repos/${t.username}/${e.publishReaderRepoPath}/actions/workflows/main.yml/runs?per_page=1&page=1&head_sha=${e.publishReaderIPFSStatus.headSha}`,{headers:{Authorization:`Bearer ${t.personalAccessToken}`}});return i.data.workflow_runs?.length>0?i.data.workflow_runs[0]:void 0}async createCommit(e,t,i,a,n){const s=await Wi.Z.post(`${un.BASE_URL}/repos/${n.username}/${i.publishReaderRepoPath}/git/commits`,{message:a,parents:[e],tree:t},{headers:{Authorization:`Bearer ${n.personalAccessToken}`}});await Wi.Z.patch(`${un.BASE_URL}/repos/${n.username}/${i.publishReaderRepoPath}/git/refs/heads/master`,{sha:s.data.sha},{headers:{Authorization:`Bearer ${n.personalAccessToken}`}})}async createTree(e,t,i,a){let n={tree:t,base_tree:e};return(await Wi.Z.post(`${un.BASE_URL}/repos/${a.username}/${i.publishReaderRepoPath}/git/trees`,n,{headers:{Authorization:`Bearer ${a.personalAccessToken}`,Accept:"application/vnd.github+json"}})).data.sha}async deleteReaderBackup(e,t){if(t.personalAccessToken.length<1)throw new Error("Gitlab personal access token not set");this.logPublishProgress("Deleting existing files from repo..."),await this.deleteDirectory(e,t,".upload"),this.logPublishProgress("Successfully deleted existing backup...")}async deleteContractBackup(e,t){if(t.personalAccessToken.length<1)throw new Error("Gitlab personal access token not set");this.logPublishProgress("Deleting existing contract files from repo..."),await this.deleteDirectory(e,t,"backup/contract")}async getMostRecentCommit(e,t){return(await Wi.Z.get(`${un.BASE_URL}/repos/${t.username}/${e.publishReaderRepoPath}/commits/master`,{headers:{Authorization:`Bearer ${t.personalAccessToken}`}})).data}async getMostRecentCommitOid(e,t){const i=`\n            query GetBranch{\n                repository (name: "${this.getBranchName(e)}", owner: "${t.username}") {\n                    ref (qualifiedName: "master") {\n                        target {\n                            ... on Commit {\n                                history(first: 1) {\n                                    nodes {\n                                        oid\n                                    }\n                                }\n                            }\n                        }\n                    }\n                }\n            }\n        `;return(await Wi.Z.post(un.GRAPHQL_URL,JSON.stringify({query:i}),{headers:{"Content-Type":"application/json",Authorization:`Bearer ${t.personalAccessToken}`}})).data.data.repository.ref.target.history.nodes[0].oid}async deleteDirectory(e,t,i){const a=await this.getMostRecentCommit(e,t),n=a.commit.tree.sha;let s=(await Wi.Z.get(`${un.BASE_URL}/repos/${t.username}/${e.publishReaderRepoPath}/git/trees/${n}`,{headers:{Authorization:`Bearer ${t.personalAccessToken}`}})).data.tree,o=s.find((e=>e.path==i))?.sha;if(o){let s=(await Wi.Z.get(`${un.BASE_URL}/repos/${t.username}/${e.publishReaderRepoPath}/git/trees/${o}`,{headers:{Authorization:`Bearer ${t.personalAccessToken}`},params:{recursive:!0}})).data.tree.filter((({type:e})=>"blob"===e)).map((e=>({path:`${i}/${e.path}`,mode:e.mode,type:e.type,sha:null})));const f=await this.createTree(n,s,e,t);await this.createCommit(a.sha,f,e,`Deleting ${i}`,t)}}logPublishProgress(e){if(console.log(e),"undefined"!=typeof window&&void 0!==window.document){const t=new CustomEvent("publish-progress",{detail:{message:e}});document.dispatchEvent(t)}}chunkIt(e,t){let i=[];for(let a=0;a<e.length;a+=t){let n=e.slice(a,a+t);i.push(n)}return i}getBranchName(e){return e.title.replace(/[^a-z0-9]/gi,"-").toLowerCase()}};yn=un=vn([(0,s.b)(),bn("design:paramtypes",[Ft])],yn);var wn=i(48764).Buffer,Sn=function(e,t,i,a){var n,s=arguments.length,o=s<3?t:null===a?a=Object.getOwnPropertyDescriptor(t,i):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,i,a);else for(var f=e.length-1;f>=0;f--)(n=e[f])&&(o=(s<3?n(o):s>3?n(t,i,o):n(t,i))||o);return s>3&&o&&Object.defineProperty(t,i,o),o},$n=function(e,t){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(e,t)};let kn=class{settingsService;channelService;gitlabService;githubService;schemaService;fs;repoURI;defaultBranch;constructor(e,t,i,a,n){this.settingsService=e,this.channelService=t,this.gitlabService=i,this.githubService=a,this.schemaService=n}async deployReader(e){this.logPublishProgress("Deploying reader...");let t=await this.settingsService.get(),i=await this.channelService.getGitProviderCredentials(e,t);if(i.personalAccessToken.length<1)throw new Error(`${i.name} personal access token not set`);let a=[];this.logPublishProgress("Creating channel backup...");let n=await this.schemaService.backupChannel();a.push({action:"create",file_path:"/.upload/channel.json",content:wn.from(JSON.stringify(n.channel))}),a.push({action:"create",file_path:"/.upload/items.json",content:wn.from(JSON.stringify(n.items))}),a.push({action:"create",file_path:"/.upload/authors.json",content:wn.from(JSON.stringify(n.authors))}),a.push({action:"create",file_path:"/.upload/themes.json",content:wn.from(JSON.stringify(n.themes))}),a.push({action:"create",file_path:"/.upload/staticPages.json",content:wn.from(JSON.stringify(n.staticPages))}),a.push({action:"create",file_path:"/.upload/attributeCounts.json",content:wn.from(JSON.stringify(n.attributeCounts))}),this.logPublishProgress(`Packaging ${n.images?.length} images...`);let s=0;for(let e of n.images)e.buffer instanceof ArrayBuffer&&(e.buffer=new Uint8Array(e.buffer)),a.push({action:"create",file_path:`/.upload/images/${s}.json`,content:wn.from(JSON.stringify(e))}),s++;this.logPublishProgress(`Packaging ${n.animations?.length} animations...`),s=0;for(let e of n.animations)a.push({action:"create",file_path:`/.upload/animations/${s}.json`,content:wn.from(JSON.stringify(e))}),s++;switch(i.name){case"gitlab":return await this.gitlabService.createVariables(e),await this.gitlabService.deleteReaderBackup(e,i),this.gitlabService.commit(e,a,i);case"github":return await this.githubService.createVariables(e),await this.githubService.deleteReaderBackup(e,i),this.githubService.commit(e,a,i)}this.logPublishProgress("Export to git complete")}async deployReaderContract(e,t){let i=await this.settingsService.get(),a=await this.channelService.getGitProviderCredentials(e,i);if(a.personalAccessToken.length<1)throw new Error(`${a.name} personal access token not set`);switch(a.name){case"gitlab":return await this.gitlabService.deleteContractBackup(e,a),this.gitlabService.commit(e,t,a);case"github":return this.githubService.commit(e,t,a)}this.logPublishProgress("Export to git complete")}async getExistingFork(e){let t=await this.settingsService.get(),i=await this.channelService.getGitProviderCredentials(e,t);if(i.personalAccessToken.length<1)throw new Error(`${i.name} personal access token not set`);switch(i.name){case"gitlab":return this.gitlabService.getExistingFork(e);case"github":return this.githubService.getExistingFork(e)}}async createFork(e){let t=await this.settingsService.get(),i=await this.channelService.getGitProviderCredentials(e,t);if(i.personalAccessToken.length<1)throw new Error(`${i.name} personal access token not set`);switch(i.name){case"gitlab":return this.gitlabService.createFork(e);case"github":return this.githubService.createFork(e)}}async createVariables(e){let t=await this.settingsService.get(),i=await this.channelService.getGitProviderCredentials(e,t);if(i.personalAccessToken.length<1)throw new Error(`${i.name} personal access token not set`);switch(i.name){case"gitlab":return this.gitlabService.createVariables(e);case"github":return this.githubService.createVariables(e)}}async getForkRepoStatus(e){let t=await this.settingsService.get(),i=await this.channelService.getGitProviderCredentials(e,t);if(i.personalAccessToken.length<1)throw new Error(`${i.name} personal access token not set`);switch(i.name){case"gitlab":return this.gitlabService.getForkRepoStatus(e);case"github":return this.githubService.getForkRepoStatus(e)}}async getIPFSActionStatus(e){let t=await this.settingsService.get(),i=await this.channelService.getGitProviderCredentials(e,t);if(i.personalAccessToken.length<1)throw new Error(`${i.name} personal access token not set`);switch(i.name){case"gitlab":return this.gitlabService.getIPFSActionStatus(e);case"github":return this.githubService.getIPFSActionStatus(e)}}async getIPFSActionResult(e){let t=await this.settingsService.get(),i=await this.channelService.getGitProviderCredentials(e,t);if(i.personalAccessToken.length<1)throw new Error(`${i.name} personal access token not set`);switch(i.name){case"gitlab":return this.gitlabService.getIPFSActionResult(e);case"github":return this.githubService.getIPFSActionResult(e)}}logPublishProgress(e){if(console.log(e),"undefined"!=typeof window&&void 0!==window.document){const t=new CustomEvent("publish-progress",{detail:{message:e}});document.dispatchEvent(t)}}chunkArrayByBytes(e,t){let i=[],a={};e.forEach((e=>{if(a[e._id]=wn.byteLength(JSON.stringify(e),"utf8"),console.log(e),a[e._id]>t)throw new Error("Image larger than 15MB found. Upload can not proceed.")}));let n=[],s=0;for(let o of e)s+a[o._id]>=t&&(i.push(n),n=[],s=0),n.push(o),s+=a[o._id];return n.length>0&&i.push(n),i}};function In(e,{$:t,$on:i,$f7:a,$update:s}){let o=n.getInstance(Nt),f=(n.getInstance(at),n.getInstance(Ni)),r=n.getInstance(Pt),c=n.getInstance(l);const d=async()=>{$.images=await f.getImagesFromContent({title:$.item.title,content:{ops:o.activeEditor.getContents().ops},coverImageCSS:$.item.coverImageCSS,themes:$.item.themes}),1==$.images?.length&&($.coverImage=$.images[0]),o.activeEditor.update(),await s()},p=async e=>{let i=t(e.currentTarget).data("id"),a=$?.images.filter((e=>e.cid==i));a?.length>0&&($.coverImage=a[0]),await s()},u=async e=>{e.preventDefault(),$.coverImage=void 0,await s()},h=async e=>{let i=t(e.currentTarget).data("id");w.filter((e=>e.id==i))[0].value=t(e.currentTarget).val(),await s()},m=async e=>{let i=t(e.currentTarget).val();$.item.themes=i,await s(),await d()},g=e=>{let i=t(e.currentTarget).val();$.item.title=i,document.dispatchEvent(new CustomEvent("load-cover-images"))},v=e=>{j=t(e.currentTarget).prop("checked"),s()},b=async e=>{e.preventDefault();let t=a.form.convertToData("#generate-form");try{await o.generateAIImage(t.model,t.prompt,t.negativePrompt),a.popup.close(".ai-popup")}catch(e){c.hideSpinner(),a.dialog.alert(e.message,"There was an error")}};let y,w,S,$=e.item,k=e.editor,I=e.toolbar,R=e.themes,x=e.cancel_link,_=($.coverImage,e.cover_image_css_editor_id),P=e.animation_css_editor_id,C=e.show_hugging_face,j=!$.item.coverImageAsAnimation;return $&&(e=>{w=e;for(let e of w)!e.value&&e.values?.length>0&&(e.value=e.values[0])})($.attributeSelections),t(document).on("image-selected",(async e=>{$.coverImage=await r.get(e.detail._id),await d()})),t(document).on("update-cover-image-css",(async e=>{$.item.coverImageCSS=e?.detail?.coverImageCSS,await d()})),t(document).on("load-cover-images",(async e=>{await d()})),t(document).on("ipfs-ready",(async e=>{y=!0,await s()})),t(document).on("hugging-face-ready",(async e=>{C=!0,await s()})),t(document).on("set-ai-prompt",(async e=>{let t=o.activeEditor.getSelection();t&&(t.length>0?(S=o.activeEditor.getText(t.index,t.length),console.log("User has highlighted: ",S)):S=""),await s()})),function(e){e.$;var t=e.$h;e.$root,e.$f7,e.$f7route,e.$f7router,e.$theme,e.$update,e.$store;return t`
...
`}}xn.id="cfe40ade94",xn.style="\n  #create-item-editor {\n    min-height: 175px;\n    height: 100%;\n    /* added these styles */\n    flex: 1;\n    display: flex;\n    flex-direction: column;\n  }\n";const _n=xn;function Pn(e,{$:t,$on:i,$f7:a,$update:s}){n.getInstance(ci);let o=n.getInstance(l),f=n.getInstance(Ni),r=e.itemViewModel,c=(r.editable,[{text:"Home",path:"/"},{text:r.channel.title,path:`/admin/channel/show/${r.channel._id}`},{text:r.item.title?r.item.title:`#${r.item.tokenId}`}]);i("pageInit",(async(e,i)=>{t(`#item-content-${r.item._id} a`).addClass("external"),await s()}));const d=async e=>{try{a.dialog.confirm("Do you want to delete this item? Note: This only deletes from your device.",(async function(){await f.delete(r.item);a.toast.show({text:"Item deleted",closeTimeout:2e3,closeButton:!0,position:"bottom",horizontalPosition:"left"});a.views.main.router.navigate(`/admin/channel/show/${r.channel._id}`)}))}catch(e){o.showExceptionPopup(e)}},p=async e=>{let t=await f.clone(r.item);a.views.main.router.navigate(`/admin/channel/${r.channel._id}/item/edit/${t._id}`)};return function(e){e.$;var t=e.$h;e.$root,e.$f7,e.$f7route,e.$f7router,e.$theme,e.$update,e.$store;return t`
    ...
    <div class="page-content hide-toolbar-on-scroll">
      ...
      <div class="item-show">
        ...
        <div class="right">
          ...
          <${ya} channel=${r.channel._id} item=${r} />
...
`}}jn.id="128a6e1638",jn.style="\n  #edit-item-editor {\n    min-height: 175px;\n    height: 100%;\n    /* added these styles */\n    flex: 1;\n    display: flex;\n    flex-direction: column;\n  }\n";const Tn=jn;var An=function(e,t,i,a){var n,s=arguments.length,o=s<3?t:null===a?a=Object.getOwnPropertyDescriptor(t,i):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,i,a);else for(var f=e.length-1;f>=0;f--)(n=e[f])&&(o=(s<3?n(o):s>3?n(t,i,o):n(t,i))||o);return s>3&&o&&Object.defineProperty(t,i,o),o},Fn=function(e,t){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(e,t)};let On=class{itemWebService;themeService;schemaService;constructor(e,t,i){this.itemWebService=e,this.themeService=t,this.schemaService=i}async create(){return new aa((async e=>{await this.schemaService.loadChannel(e.params.channelId);let t=await this.itemWebService.getNewViewModel(e.params.channelId);return{itemViewModel:t,themes:await this.themeService.listByChannel(t.channel._id,1e3,0)}}),_n)}async show(){return new aa((async e=>(await this.schemaService.loadChannel(e.params.channelId),{itemViewModel:await this.itemWebService.getNavigation(e.params.channelId,parseInt(e.params.tokenId))})),Cn)}async edit(){return new aa((async e=>{await this.schemaService.loadChannel(e.params.channelId);let t=await this.itemWebService.get(e.params.id);return{itemViewModel:t,themes:await this.themeService.listByChannel(t.channel._id,1e3,0)}}),Tn)}};function En(e,{$:t,$on:i,$f7:a,$update:n}){let s=e.authorViewModel,o=[{text:"Home",path:"/"},{text:"Author Profile"}];return function(t){t.$;var i=t.$h;t.$root,t.$f7,t.$f7route,t.$f7router,t.$theme,t.$update,t.$store;return i`
    <div class="page" data-name="profile-show">

        <${oa} breadcrumbs=${o} active="profile" />
...
`}}An([na("/admin/item/create/:channelId"),Fn("design:type",Function),Fn("design:paramtypes",[]),Fn("design:returntype",Promise)],On.prototype,"create",null),An([na("/admin/channel/show/:channelId/:tokenId"),Fn("design:type",Function),Fn("design:paramtypes",[]),Fn("design:returntype",Promise)],On.prototype,"show",null),An([na("/admin/channel/:channelId/item/edit/:id"),Fn("design:type",Function),Fn("design:paramtypes",[]),Fn("design:returntype",Promise)],On.prototype,"edit",null),On=An([(0,s.b)(),Fn("design:paramtypes",[Ni,Rt,Ne])],On),En.id="83b7a0cce0",En.style="\n    \n  .profile-pic-edit, #profile-pic--edit-not-found {\n    max-width: 300px;\n    border-radius: 50%;\n    font-size: 100px;\n    float: left;\n  }\n  \n  \n  .profile-pic-main, #profile-pic-not-found {\n    max-width: 100%;\n    border-radius: 50%;\n    font-size: 100px;\n    float: left;\n  }\n  \n  .profile-name {\n    color: var(--f7-block-title-medium-text-color);\n    font-weight: bold;\n  }\n  \n  .profile-address {\n    color: var(--f7-list-item-text-text-color);\n    font-size: 13px;\n  }\n  \n  \n  .profile-pic-wrapper {\n    width: 115px;\n    float: left;\n    padding-right: 20px;\n  }\n\n";const Dn=En;function Bn(e,{$:t,$on:i,$f7:a,$update:s}){let o=n.getInstance(Gt),f=n.getInstance(Pt),r=n.getInstance(ei),c=n.getWalletService(),l=e.authorViewModel,d=[{text:"Home",path:"/"},{text:c.truncateEthAddress(l.author.walletAddress),path:`/admin/author/show/${l.author.walletAddress}`},{text:"Edit Profile"}];const p=async t=>{t.preventDefault();let i=Object.assign(new R,a.form.convertToData("#edit-author-form"));try{await r.put(i);a.toast.show({text:"Profile Saved",closeTimeout:2e3,closeButton:!0,position:"bottom",horizontalPosition:"left"});a.views.main.router.navigate(`/admin/${e.channelId}/author/show/${i._id}`)}catch(e){console.log(e),a.dialog.alert(e.errors,"There was an error")}},u=async e=>{t("#author-photo-browse").click()},h=async e=>{let t=await o.uploadFile(document.getElementById("author-photo-browse")),i=await f.newFromBuffer(t);try{await f.put(i)}catch(e){}l.authorPhoto={cid:i.cid,url:await f.getUrl(i)},s()};return function(e){e.$;var t=e.$h;e.$root,e.$f7,e.$f7route,e.$f7router,e.$theme,e.$update,e.$store;return t`
    <div class="page" data-name="profile-edit">

        <${oa} breadcrumbs=${d} active="profile" />
...
`}}qn([na("/admin/settings"),Gn("design:type",Function),Gn("design:paramtypes",[]),Gn("design:returntype",Promise)],Jn.prototype,"show",null),Jn=qn([(0,s.b)(),Gn("design:paramtypes",[Ft])],Jn),Wn.id="9efa81e6b9";const Zn=Wn;var Vn=function(e,t,i,a){var n,s=arguments.length,o=s<3?t:null===a?a=Object.getOwnPropertyDescriptor(t,i):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,i,a);else for(var f=e.length-1;f>=0;f--)(n=e[f])&&(o=(s<3?n(o):s>3?n(t,i,o):n(t,i))||o);return s>3&&o&&Object.defineProperty(t,i,o),o},Yn=function(e,t){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(e,t)};let Kn=class{ipfsService;constructor(e){this.ipfsService=e}async show(){return new aa((async e=>{if(!this.ipfsService.ipfs)return{};let t=await this.ipfsService.ipfs.swarm.peers(),i=await this.ipfsService.ipfs.id();return{peers:t.map((e=>e.addr.toString())),peerCount:t.length,addresses:i?.addresses?.map((e=>e.toString()))}}),Zn)}};function Qn(e,{$:t,$h:i,$on:a,$f7:s,$update:o}){let f,r=e.channelViewModel,c=[{text:"Home",path:"/"},{text:r.channel.title,path:`/admin/channel/show/${r.channel._id}`},{text:"Publish"}];return a("pageInit",(async(e,t)=>{f=n.getWalletService(),await o()})),function(e){e.$;var t=e.$h;e.$root,e.$f7,e.$f7route,e.$f7router,e.$theme,e.$update,e.$store;return t`
                                ...
                                ${l.channel.publishReaderIPFSStatus?.status?t`
                                    ...
                                    <div class="pin-status"> 
                                        ...
                                        ${"complete"==l.channel.publishReaderIPFSStatus?.status&&l.channel.publishReaderIPFSStatus?.cid?t`
                                            ...
                                            <strong>Date:</strong> ${$i()(l.channel.publishReaderIPFSStatus?.date).format("MMMM Do YYYY, h:mm:ss a")}
                                        `:t` `}
...
`}}ds=rs([(0,s.b)(),ls(7,(0,o.f)(a.WalletService)),cs("design:paramtypes",[mi,ci,yi,Pt,Pi,Oi,Ft,Object])],ds),ps.id="8b7737703d",ps.style="\n  .publish-label,\n  .ipfs-label,\n  .forking-label {\n    margin-top: 10px;\n    margin-bottom: 10px;\n    font-weight: bold;\n    font-size: 18px;\n  }\n\n  .publish-output {\n    border: 1px solid #cccccc;\n    font-size: 13px;\n    width: 100%;\n    max-width: 100%;\n    padding: 5px;\n    height: 300px;\n    overflow-y: scroll;\n  }\n\n  #fork-next-button {\n    width: 200px;\n  }\n";const us=ps;function hs(e,{$:t,$h:i,$on:a,$f7:s,$update:o}){let f,r=n.getInstance(mi),c=n.getInstance(yi),l=(n.getInstance(Ze),n.getInstance(Qi),n.getInstance(kn)),d=(n.getInstance(ds),null!=c.ipfs),p=c.peerCount,u=e.channelViewModel,h=e.settings,m=!1,g="",v=u.channel.publishReaderRepoId>0&&"complete"==u.channel.publishReaderRepoStatus,b=null!=u.channel.localCid,y=u.itemCount>0,w=u?.gitProvider?.personalAccessToken?.length>0,S=h?.gitCorsProxy?.length>0,$=y&&w&&S,k=u.channel.httpUrlToRepo,I=[{text:"Home",path:"/"},{text:u.channel.title,path:`/admin/channel/show/${u.channel._id}`},{text:"Publish",path:`/admin/publish/${u.channel._id}`},{text:"Publish Collection To Reader"}];a("pageInit",(async()=>{await c.init(),d=null!=c.ipfs,f=await r.getGitProviderCredentials(u.channel,h),await o()}));const R=async e=>{e.preventDefault(),m=!0,await o();let t=document.getElementsByClassName("ipfs-label")[0];s.preloader.showIn(t);try{let e=`/export/${u.channel._id}`,t=await(0,Oa.Z)(c.ipfs.files.read(`${e}/contractMetadata.json`));await l.deployReaderGit(u.channel,t)}catch(e){console.log(e),s.dialog.alert(e,"There was an error")}s.preloader.hideIn(t),m=!1,await o()},x=async e=>{e.preventDefault();let t=document.getElementsByClassName("ipfs-label")[0];s.preloader.showIn(t);try{await l.clearGitRepos()}catch(e){s.dialog.alert(e,"There was an error")}s.preloader.hideIn(t),await o()};return t(document).on("publish-reader-progress",(async e=>{g=`<p>${e.detail.message}</p>`,o()})),t(document).on("update-peers",(async e=>{p=e.detail.count,o()})),function(e){e.$;var t=e.$h;e.$root,e.$f7,e.$f7route,e.$f7router,e.$theme,e.$update,e.$store;return t`
  ...
  `}}hs.id="64e2fbd608",hs.style="\n\n    .publish-label, .ipfs-label, .forking-label {\n      margin-top: 10px;\n      margin-bottom: 10px;\n      font-weight: bold;\n      font-size: 18px;\n    }\n\n    .publish-output {\n      border: 1px solid #cccccc;\n      font-size: 13px;\n      width: 100%;\n      max-width: 100%;\n      padding: 5px;\n      height: 300px;\n      overflow-y : scroll;\n    }\n  ";const ms=hs;var gs=i(41972),vs=function(e,t,i,a){var n,s=arguments.length,o=s<3?t:null===a?a=Object.getOwnPropertyDescriptor(t,i):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,i,a);else for(var f=e.length-1;f>=0;f--)(n=e[f])&&(o=(s<3?n(o):s>3?n(t,i,o):n(t,i))||o);return s>3&&o&&Object.defineProperty(t,i,o),o},bs=function(e,t){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(e,t)},ys=function(e,t){return function(i,a){t(i,a,e)}};let ws=class{channelService;walletService;contracts;constructor(e,t,i){this.channelService=e,this.walletService=t,this.contracts=i}async deployContract(e){if(!e.publishReaderIPFSStatus?.cid)throw new Error("Not published to IPFS");let t=await this.channelService.countItemsByChannel(e._id);if(t<=0)throw new Error("No NFTs");let i=pa.vz(e.mintPrice,"ether"),a=await this.deploy(e.title,e.symbol,e.publishReaderIPFSStatus?.cid,i.toString(),t);e.contractAddress=a.contractAddress,e.showActivityPage=!0,e.showMintPage=!0,await this.channelService.put(e)}async deploy(e,t,i,a,n){if(!(e&&t&&a&&n&&i))throw new Error("Missing inputs to deploy");let s=this.walletService.wallet;if(!s)throw new Error("No wallet!");const o=this.contracts.Channel,f=new gs.l(o.abi,o.bytecode,s);return(await f.deploy(e,t,i,BigInt(a.toString()),BigInt(n.toString()))).deploymentTransaction().wait()}};function Ss(e,{$:t,$h:i,$on:a,$f7:s,$update:o}){let f,r=n.getInstance(mi),c=(n.getInstance(yi),n.getInstance(Ze)),l=(n.getInstance(Qi),n.getInstance(ws)),d=e.channelViewModel,p=!1,u=null!=d.channel.publishReaderIPFSStatus?.cid||d.channel.contractAddress,h=[{text:"Home",path:"/"},{text:d.channel.title,path:`/admin/channel/show/${d.channel._id}`},{text:"Publish",path:`/admin/publish/${d.channel._id}`},{text:"Deploy Contract"}];a("pageInit",(async(e,t)=>{f=n.getWalletService(),await o()}));const m=async e=>{p=!0,await o();let t={title:`Deploying contract ${name}. Approve transaction and wait for it to be mined.`,promise:l.deployContract(d.channel)};await c.queuePromiseView(t),p=!1,await o()},g=async e=>{d.channel.contractAddress=void 0,await r.put(d.channel),d.channel=await r.get(d.channel._id),o()};return function(e){e.$;var t=e.$h;e.$root,e.$f7,e.$f7route,e.$f7router,e.$theme,e.$update,e.$store;return t`
                  ...
                  <div class="card-content card-content-padding">
                    ...
                    ${u?t`
                      ...
                      <div class="pin-status">
                        ...
                        <p><strong>Date Exported:</strong> ${$i()(d.channel.publishReaderIPFSStatus?.date).format("MMMM Do YYYY, h:mm:ss a")}</p>
                      </div>
  ...
  `}}ws=vs([(0,s.b)(),ys(1,(0,o.f)(a.WalletService)),ys(2,(0,o.f)("contracts")),bs("design:paramtypes",[mi,Object,Object])],ws),Ss.id="b55e61e475",Ss.style="\n\n  ";const $s=Ss;var ks=function(e,t,i,a){var n,s=arguments.length,o=s<3?t:null===a?a=Object.getOwnPropertyDescriptor(t,i):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,i,a);else for(var f=e.length-1;f>=0;f--)(n=e[f])&&(o=(s<3?n(o):s>3?n(t,i,o):n(t,i))||o);return s>3&&o&&Object.defineProperty(t,i,o),o},Is=function(e,t){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(e,t)};let Rs=class{channelWebService;settingsService;schemaService;gitlabService;constructor(e,t,i,a){this.channelWebService=e,this.settingsService=t,this.schemaService=i,this.gitlabService=a}async publish(){return new aa((async e=>(await this.schemaService.loadChannel(e.params.id),{channelViewModel:await this.channelWebService.get(e.params.id)})),Xn)}async export(){return new aa((async e=>{await this.schemaService.loadChannel(e.params.id);let t,i=await this.channelWebService.get(e.params.id);try{t=await this.settingsService.get()}catch(e){}return{channelViewModel:i,settings:t}}),ts)}async forkReader(){return new aa((async e=>{await this.schemaService.loadChannel(e.params.id);let t,i=await this.channelWebService.get(e.params.id);try{t=await this.settingsService.get()}catch(e){}return{channelViewModel:i,settings:t}}),us)}async publishReader(){return new aa((async e=>{await this.schemaService.loadChannel(e.params.id);let t,i=await this.channelWebService.get(e.params.id);try{t=await this.settingsService.get()}catch(e){}return{channelViewModel:i,settings:t}}),ms)}async contract(){return new aa((async e=>(await this.schemaService.loadChannel(e.params.id),{channelViewModel:await this.channelWebService.get(e.params.id)})),$s)}};ks([na("/admin/publish/:id"),Is("design:type",Function),Is("design:paramtypes",[]),Is("design:returntype",Promise)],Rs.prototype,"publish",null),ks([na("/admin/publish/export/:id"),Is("design:type",Function),Is("design:paramtypes",[]),Is("design:returntype",Promise)],Rs.prototype,"export",null),ks([na("/admin/publish/fork-reader/:id"),Is("design:type",Function),Is("design:paramtypes",[]),Is("design:returntype",Promise)],Rs.prototype,"forkReader",null),ks([na("/admin/publish/publish-reader/:id"),Is("design:type",Function),Is("design:paramtypes",[]),Is("design:returntype",Promise)],Rs.prototype,"publishReader",null),ks([na("/admin/publish/contract/:id"),Is("design:type",Function),Is("design:paramtypes",[]),Is("design:returntype",Promise)],Rs.prototype,"contract",null),Rs=ks([(0,s.b)(),Is("design:paramtypes",[Hi,Ft,Ne,Qi])],Rs);var xs=function(e,t,i,a){var n,s=arguments.length,o=s<3?t:null===a?a=Object.getOwnPropertyDescriptor(t,i):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,i,a);else for(var f=e.length-1;f>=0;f--)(n=e[f])&&(o=(s<3?n(o):s>3?n(t,i,o):n(t,i))||o);return s>3&&o&&Object.defineProperty(t,i,o),o},_s=function(e,t){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(e,t)};let Ps=class{constructor(){}buildPagingViewModel(e,t,i,a){let n=new Cs;return n.offset=e||0,n.limit=t,n.count=i,n.start=n.offset+1,n.end=Math.min(n.offset+t,i),n.previousOffset=Math.max(n.offset-t,0),n.offset+t<i&&(n.nextOffset=n.offset+t),n.page=n.offset/n.limit+1,n.page>n.endPage&&(n.page=n.endPage),n.endPage=Math.ceil(n.count/n.limit),n.lastOffset=n.endPage*n.limit-n.limit,n.showNext=n.endPage>n.page,n.showPrevious=0!=n.offset,n.showFirst=n.page>2,n.showLast=n.page<n.endPage-1,n}calculateEndIndex(e,t,i){let a=t+e-1;return Math.min(i-1,a)}calculateDescendingEndIndex(e,t){let i=t-(e-1);return Math.max(0,i)}calculateDescendingOffset(e,t){let i=t-1-e;return Math.max(0,i)}};Ps=xs([(0,s.b)(),_s("design:paramtypes",[])],Ps);class Cs{page;pageNumbers;endPage;offset;limit;count;start;end;previousOffset;nextOffset;lastOffset;showPrevious;showNext;showFirst;showLast}var js=i(4079);function Ts(e,{$:t,$on:i,$f7:a,$update:s}){n.getInstance(ci);let o=n.getInstance(mi),f=n.getWalletService(),r=e.channel_view_model;const c=async e=>{a.dialog.confirm("Are you sure you want to delete this collection? This will only remove your local copy of the files.",(async()=>{a.preloader.show(),await o.delete(r.channel),a.preloader.hide(),a.views.main.router.navigate("/");a.toast.show({text:"Collection deleted",closeTimeout:2e3,closeButton:!0,position:"bottom",horizontalPosition:"left"})}))};return function(e){e.$;var t,i=e.$h;e.$root,e.$f7,e.$f7route,e.$f7router,e.$theme,e.$update,e.$store;return i`
