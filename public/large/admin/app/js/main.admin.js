...
`}}Ii.id="894f2ba313",Ii.style="\n\n\n";const Ri=Ii;function xi(e,{$on:t,$f7:a,$update:i}){let s=n.getWalletService(),o=s.address,r=null!=s.provider,c=e.active,l=e.reader_config,f=e.breadcrumbs;const d=/^(0x[a-zA-Z0-9]{4})[a-zA-Z0-9]+([a-zA-Z0-9]{4})$/,p=e=>{const t=e.match(d);return t?`${t[1]}…${t[2]}`:e},u=async e=>{document.dispatchEvent(new CustomEvent("connect-wallet"))};return function(e){e.$;var t=e.$h;e.$root,e.$f7,e.$f7route,e.$f7router,e.$theme,e.$update,e.$store;return t`
                ...
                <div class="page">
                    ...
                    <div class="page-content">
                        ...
                        <div class="block">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <a class="link" href="#" data-id="${e.id}" @click="${w}">Edit</a> | <a
                                            class="link" href="#" data-id="${e.id}" @click="${$}">Delete</a>
                                        `:t` `}
                            ...
                            ${F.editable?t`
                                <a class="button button-outline add-category-button" @click="${S}" tabindex="10">Add Attribute Type</a>
                            `:t` `}
                                                ...
                                                ${H?.length>0?t`
                                                    ...
                                                    <ul style="padding-left: 0px;">
                                                        ...
                                                        <li>
                                                            ...
                                                            <a class="link" href="#" data-id="${e.id}" @click="${C}">Edit</a> | 
                                                            <a class="link" href="#" data-id="${e.id}" @click="${P}">Delete</a>
                                                        </li>
                                                        `))}
  ...
  <div class="page" data-name="admin-show-collection">
    ...
    <div class="page-content infinite-scroll-content hide-toolbar-on-scroll" id="item-list-infinite-scroll">
      ...
      <div class="fixed-width-content center">
        ...
        <${Mi} channel=${c.channel._id} token_id="1" />
...
`}}Li.id="667e7323a7",Li.style="\n  \n\n";const Ni=Li;function Ui(e,{$:t,$on:a,$f7:i,$update:n}){let s=e.theme,o=e.cover_image_css_editor_id,r=e.animation_css_editor_id;return function(e){e.$;var t=e.$h;e.$root,e.$f7,e.$f7route,e.$f7router,e.$theme,e.$update,e.$store;return t`
            ...
            <div class="page">
              ...
              <div class="page-content">
                <form id="add-theme-form" @submit="${v}">
                  <${Hi} cover_image_css_editor_id="add-theme-cover-image-editor"
            ...
            <div class="page">
              ...
              <div class="page-content">
                <form id="edit-theme-form" @submit="${b}">
                  ...
                  <${Hi} cover_image_css_editor_id="edit-theme-cover-image-editor"
            ...
            <div class="page">
              ...
              <div class="page-content">
                <form id="add-static-page-form" @submit="${b}">
                  <${Wi} static_page_content_editor_id="add-static-page-content-editor"
            ...
            <div class="page">
              ...
              <div class="page-content">
                <form id="edit-static-page-form" @submit="${y}">
                  ...
                  <${Wi} static_page_content_editor_id="edit-static-page-content-editor"
...
`}}Ji.id="5ae7c7c55b",Ji.style="\n";const Ki=Ji;function Yi(e,{$:t,$on:a,$f7:i,$update:s}){let o,r=[{text:"Home",path:"/"},{text:"Create & Import"}];return a("pageInit",(async()=>{o=n.getWalletService(),await s()})),function(e){e.$;var t=e.$h;e.$root,e.$f7,e.$f7route,e.$f7router,e.$theme,e.$update,e.$store;return t`
...
`}}xn.id="493008459a",xn.style="\n\n";const _n=xn;var Cn=function(e,t,a,i){var n,s=arguments.length,o=s<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,a):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,a,i);else for(var r=e.length-1;r>=0;r--)(n=e[r])&&(o=(s<3?n(o):s>3?n(t,a,o):n(t,a))||o);return s>3&&o&&Object.defineProperty(t,a,o),o},Pn=function(e,t){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(e,t)},Tn=function(e,t){return function(a,i){t(a,i,e)}};let An=class{channelWebService;itemWebService;schemaService;themeService;staticPageService;footerText;constructor(e,t,a,i,n,s){this.channelWebService=e,this.itemWebService=t,this.schemaService=a,this.themeService=i,this.staticPageService=n,this.footerText=s}async app(){return new wi((async e=>({footerText:this.footerText})),Ri)}async create(){return new wi((async e=>{}),Di)}async createMenu(){return new wi((async e=>{}),Qi)}async fork(){return new wi((async e=>({cid:e.query.cid})),$n)}async forkContract(){return new wi((async e=>({footerText:this.footerText,contractAddress:e.query.contractAddress})),kn)}async forkReader(){return new wi((async e=>({footerText:this.footerText})),Rn)}async show(){return new wi((async e=>{await this.schemaService.loadChannel(e.params.id);let t=await this.channelWebService.get(e.params.id);return{channelViewModel:t,firstPageItems:await this.itemWebService.listByChannel(t.channel._id,te.CHUNK_SIZE,0)}}),Ni)}async themes(){return new wi((async e=>{await this.schemaService.loadChannel(e.params.id);let t=await this.channelWebService.get(e.params.id);return{channelViewModel:t,themes:await this.themeService.listByChannel(t.channel._id,1e3,0)}}),Gi)}async staticPages(){return new wi((async e=>{await this.schemaService.loadChannel(e.params.id);let t=await this.channelWebService.get(e.params.id);return{channelViewModel:t,staticPages:await this.staticPageService.listByChannel(t.channel._id,1e3,0)}}),Zi)}async edit(){return new wi((async e=>(await this.schemaService.loadChannel(e.params.id),{channelViewModel:await this.channelWebService.get(e.params.id)})),Ki)}async upgrade(){return new wi((async e=>(await this.schemaService.loadChannel(e.params.id),{channelViewModel:await this.channelWebService.get(e.params.id)})),_n)}};Cn([$i("/"),Pn("design:type",Function),Pn("design:paramtypes",[]),Pn("design:returntype",Promise)],An.prototype,"app",null),Cn([$i("/admin/channel/create"),Pn("design:type",Function),Pn("design:paramtypes",[]),Pn("design:returntype",Promise)],An.prototype,"create",null),Cn([$i("/admin/channel/create-menu"),Pn("design:type",Function),Pn("design:paramtypes",[]),Pn("design:returntype",Promise)],An.prototype,"createMenu",null),Cn([$i("/admin/channel/fork"),Pn("design:type",Function),Pn("design:paramtypes",[]),Pn("design:returntype",Promise)],An.prototype,"fork",null),Cn([$i("/admin/channel/fork-contract"),Pn("design:type",Function),Pn("design:paramtypes",[]),Pn("design:returntype",Promise)],An.prototype,"forkContract",null),Cn([$i("/admin/channel/fork-reader"),Pn("design:type",Function),Pn("design:paramtypes",[]),Pn("design:returntype",Promise)],An.prototype,"forkReader",null),Cn([$i("/admin/channel/show/:id"),Pn("design:type",Function),Pn("design:paramtypes",[]),Pn("design:returntype",Promise)],An.prototype,"show",null),Cn([$i("/admin/channel/themes/:id"),Pn("design:type",Function),Pn("design:paramtypes",[]),Pn("design:returntype",Promise)],An.prototype,"themes",null),Cn([$i("/admin/channel/static-pages/:id"),Pn("design:type",Function),Pn("design:paramtypes",[]),Pn("design:returntype",Promise)],An.prototype,"staticPages",null),Cn([$i("/admin/channel/edit/:id"),Pn("design:type",Function),Pn("design:paramtypes",[]),Pn("design:returntype",Promise)],An.prototype,"edit",null),Cn([$i("/admin/channel/upgrade/:id"),Pn("design:type",Function),Pn("design:paramtypes",[]),Pn("design:returntype",Promise)],An.prototype,"upgrade",null),An=Cn([(0,s.b)(),Tn(5,(0,o.f)("footer-text")),Pn("design:paramtypes",[si,ti,We,Et,Wa,String])],An);var On,jn=a(6869),Fn=a.n(jn),En=a(48764).Buffer,Dn=function(e,t,a,i){var n,s=arguments.length,o=s<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,a):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,a,i);else for(var r=e.length-1;r>=0;r--)(n=e[r])&&(o=(s<3?n(o):s>3?n(t,a,o):n(t,a))||o);return s>3&&o&&Object.defineProperty(t,a,o),o},Bn=function(e,t){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(e,t)},Mn=function(e,t){return function(a,i){t(a,i,e)}};let Ln=class{static{On=this}settingsService;dayjs;static BASE_URL="https://api.github.com";static GRAPHQL_URL="https://api.github.com/graphql";static READER_REPO_OWNER="LargeNFT";static READER_REPO="large-reader";constructor(e,t){this.settingsService=e,this.dayjs=t}async createFork(e){console.log("Creating reader fork...");let t=(await this.settingsService.get()).gitProviders.github;if(t.personalAccessToken.length<1)throw new Error("Gitlab personal access token not set");let a=await this.getExistingFork(e);if(a)return a;let i=`${On.BASE_URL}/repos/${On.READER_REPO_OWNER}/${On.READER_REPO}/generate`,n=(await fi.Z.post(i,{owner:t.username,name:this.getBranchName(e),include_all_branches:!1,private:!0},{headers:{Authorization:`Bearer ${t.personalAccessToken}`}})).data;return{id:n.id,httpUrlToRepo:n.html_url,path:n.name,branch:"master"}}async createVariables(e){let t=await this.settingsService.get(),a=t.gitProviders.github;if(a.personalAccessToken.length<1)throw new Error("Gitlab personal access token not set");t.alchemyKey&&await this._createVariable(e,a,"ALCHEMY_API_KEY",t.alchemyKey)}async _createVariable(e,t,a,i){let n=`${On.BASE_URL}/repos/${t.username}/${this.getBranchName(e)}/actions/secrets/public-key`;const s=i;let o=(await fi.Z.get(n,{headers:{Authorization:`Bearer ${t.personalAccessToken}`}})).data;await Fn().ready;let r=Fn().from_base64(o.key,Fn().base64_variants.ORIGINAL),c=Fn().from_string(s),l=Fn().crypto_box_seal(c,r),f=Fn().to_base64(l,Fn().base64_variants.ORIGINAL),d=`${On.BASE_URL}/repos/${t.username}/${this.getBranchName(e)}/actions/secrets/${a}`;return fi.Z.put(d,{key_id:o.key_id,encrypted_value:f},{headers:{Authorization:`Bearer ${t.personalAccessToken}`}})}async getExistingFork(e){let t=(await this.settingsService.get()).gitProviders.github;if(t.personalAccessToken.length<1)throw new Error("Gitlab personal access token not set");try{let a=`${On.BASE_URL}/repos/${t.username}/${this.getBranchName(e)}`,i=(await fi.Z.get(a,{headers:{Authorization:`Bearer ${t.personalAccessToken}`}})).data;if(i.id)return{id:i.id,httpUrlToRepo:i.html_url,path:i.name,branch:"master"}}catch(e){}}async getForkRepoStatus(e){if((await this.settingsService.get()).gitProviders.github.personalAccessToken.length<1)throw new Error("Gitlab personal access token not set");return await this.getExistingFork(e)?"finished":"pending"}async commit(e,t,a){let i,n=0,s=this.chunkIt(t,100);for(const[o,r]of s.entries()){n+=r.length,this.logPublishProgress(`Commiting reader data for ${e.title} to GitHub: committing ${r.length} actions. ${n} / ${t.length}`);let c=await this.getMostRecentCommitOid(e,a);const l=r.map((e=>({path:e.file_path.slice(1),contents:En.from(e.content).toString("base64")})));let f="";f=o===s.length-1?"Commiting reader data complete":`Commiting reader data for ${e.title}`;const d=`\n                mutation createCommit($additions: [FileAddition!]!, $oid: GitObjectID!) {\n                    createCommitOnBranch (input: {\n                        branch : {\n                            repositoryNameWithOwner: "${a.username}/${this.getBranchName(e)}"\n                            branchName: "master"\n                        }\n                        message: {\n                            headline: "${f}"\n                        }\n                        fileChanges: {\n                            additions: $additions\n                        }\n                        expectedHeadOid: $oid\n                        }) {\n                        commit {\n                            commitUrl\n                        }\n                    }\n                }\n            `,p={oid:c,additions:l};i=(await fi.Z.post(On.GRAPHQL_URL,{query:d,variables:p},{headers:{"Content-Type":"application/json",Authorization:`Bearer ${a.personalAccessToken}`}})).data.data.createCommitOnBranch.commit.commitUrl.split("/").pop(),this.logPublishProgress(`Commit successful: ${i}`)}return i}async getMostRecentActionRun(e,t){if(!e.publishReaderIPFSStatus?.headSha)return;const a=await fi.Z.get(`${On.BASE_URL}/repos/${t.username}/${e.publishReaderRepoPath}/actions/workflows/main.yml/runs?per_page=1&page=1&head_sha=${e.publishReaderIPFSStatus.headSha}`,{headers:{Authorization:`Bearer ${t.personalAccessToken}`}});return a.data.workflow_runs?.length>0?a.data.workflow_runs[0]:void 0}async createCommit(e,t,a,i,n){const s=await fi.Z.post(`${On.BASE_URL}/repos/${n.username}/${a.publishReaderRepoPath}/git/commits`,{message:i,parents:[e],tree:t},{headers:{Authorization:`Bearer ${n.personalAccessToken}`}});await fi.Z.patch(`${On.BASE_URL}/repos/${n.username}/${a.publishReaderRepoPath}/git/refs/heads/master`,{sha:s.data.sha},{headers:{Authorization:`Bearer ${n.personalAccessToken}`}})}async createTree(e,t,a,i){let n={tree:t,base_tree:e};return(await fi.Z.post(`${On.BASE_URL}/repos/${i.username}/${a.publishReaderRepoPath}/git/trees`,n,{headers:{Authorization:`Bearer ${i.personalAccessToken}`,Accept:"application/vnd.github+json"}})).data.sha}async deleteReaderBackup(e,t){if(t.personalAccessToken.length<1)throw new Error("Gitlab personal access token not set");this.logPublishProgress("Deleting existing files from repo..."),await this.deleteDirectory(e,t,".upload"),this.logPublishProgress("Successfully deleted existing backup...")}async deleteContractBackup(e,t){if(t.personalAccessToken.length<1)throw new Error("Gitlab personal access token not set");this.logPublishProgress("Deleting existing contract files from repo..."),await this.deleteDirectory(e,t,"backup/contract")}async getMostRecentCommit(e,t){return(await fi.Z.get(`${On.BASE_URL}/repos/${t.username}/${e.publishReaderRepoPath}/commits/master`,{headers:{Authorization:`Bearer ${t.personalAccessToken}`}})).data}async getMostRecentCommitOid(e,t){const a=`\n            query GetBranch{\n                repository (name: "${this.getBranchName(e)}", owner: "${t.username}") {\n                    ref (qualifiedName: "master") {\n                        target {\n                            ... on Commit {\n                                history(first: 1) {\n                                    nodes {\n                                        oid\n                                    }\n                                }\n                            }\n                        }\n                    }\n                }\n            }\n        `;return(await fi.Z.post(On.GRAPHQL_URL,JSON.stringify({query:a}),{headers:{"Content-Type":"application/json",Authorization:`Bearer ${t.personalAccessToken}`}})).data.data.repository.ref.target.history.nodes[0].oid}async deleteDirectory(e,t,a){const i=await this.getMostRecentCommit(e,t),n=i.commit.tree.sha;let s=(await fi.Z.get(`${On.BASE_URL}/repos/${t.username}/${e.publishReaderRepoPath}/git/trees/${n}`,{headers:{Authorization:`Bearer ${t.personalAccessToken}`}})).data.tree,o=s.find((e=>e.path==a))?.sha;if(o){let s=(await fi.Z.get(`${On.BASE_URL}/repos/${t.username}/${e.publishReaderRepoPath}/git/trees/${o}`,{headers:{Authorization:`Bearer ${t.personalAccessToken}`},params:{recursive:!0}})).data.tree.filter((({type:e})=>"blob"===e)).map((e=>({path:`${a}/${e.path}`,mode:e.mode,type:e.type,sha:null})));const r=await this.createTree(n,s,e,t);await this.createCommit(i.sha,r,e,`Deleting ${a}`,t)}}logPublishProgress(e){if(console.log(e),"undefined"!=typeof window&&void 0!==window.document){const t=new CustomEvent("publish-progress",{detail:{message:e}});document.dispatchEvent(t)}}chunkIt(e,t){let a=[];for(let i=0;i<e.length;i+=t){let n=e.slice(i,i+t);a.push(n)}return a}getBranchName(e){return e.title.replace(/[^a-z0-9]/gi,"-").toLowerCase()}};Ln=On=Dn([(0,s.b)(),Mn(1,(0,o.f)("dayjs")),Bn("design:paramtypes",[Gt,Object])],Ln);var Nn=function(e,t,a,i){var n,s=arguments.length,o=s<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,a):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,a,i);else for(var r=e.length-1;r>=0;r--)(n=e[r])&&(o=(s<3?n(o):s>3?n(t,a,o):n(t,a))||o);return s>3&&o&&Object.defineProperty(t,a,o),o},Un=function(e,t){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(e,t)};let Hn=class{carRepository;db;constructor(e){this.carRepository=e}async get(e){return this.carRepository.get(e)}async put(e){e.dateCreated||(e.dateCreated=(new Date).toJSON());let t=await(0,_t.GuS)(e,{forbidUnknownValues:!0,whitelist:!0});if(t.length>0)throw new xt(t);await this.carRepository.put(e)}async delete(e){await this.carRepository.delete(e)}async getByIds(e){return this.carRepository.getByIds(e)}};Hn=Nn([(0,s.b)(),Un("design:paramtypes",[qe])],Hn);var qn=a(48764).Buffer,Gn=function(e,t,a,i){var n,s=arguments.length,o=s<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,a):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,a,i);else for(var r=e.length-1;r>=0;r--)(n=e[r])&&(o=(s<3?n(o):s>3?n(t,a,o):n(t,a))||o);return s>3&&o&&Object.defineProperty(t,a,o),o},zn=function(e,t){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(e,t)};let Wn=class{settingsService;channelService;gitlabService;githubService;carService;fs;repoURI;defaultBranch;constructor(e,t,a,i,n){this.settingsService=e,this.channelService=t,this.gitlabService=a,this.githubService=i,this.carService=n}async deployReader(e){this.logPublishProgress("Deploying reader...");let t=await this.settingsService.get(),a=await this.channelService.getGitProviderCredentials(e,t);if(a.personalAccessToken.length<1)throw new Error(`${a.name} personal access token not set`);let i=[],n=await this.carService.get("export"),s=await this.carService.get("contract");if(!n)throw new Error("Generate an IPFS .car bundle before deploying to git provider.");switch(i.push({action:"create",file_path:"/backup/export.car",content:n.content}),s&&e.contractAddress&&i.push({action:"create",file_path:"/backup/contract.car",content:s.content}),a.name){case"gitlab":return await this.gitlabService.createVariables(e),await this.gitlabService.deleteReaderBackup(e,a),this.gitlabService.commit(e,i,a);case"github":return await this.githubService.createVariables(e),await this.githubService.deleteReaderBackup(e,a),this.githubService.commit(e,i,a)}this.logPublishProgress("Export to git complete")}async deployReaderContract(e,t){let a=await this.settingsService.get(),i=await this.channelService.getGitProviderCredentials(e,a);if(i.personalAccessToken.length<1)throw new Error(`${i.name} personal access token not set`);switch(i.name){case"gitlab":return await this.gitlabService.deleteContractBackup(e,i),this.gitlabService.commit(e,t,i);case"github":return this.githubService.commit(e,t,i)}this.logPublishProgress("Export to git complete")}async getExistingFork(e){let t=await this.settingsService.get(),a=await this.channelService.getGitProviderCredentials(e,t);if(a.personalAccessToken.length<1)throw new Error(`${a.name} personal access token not set`);switch(a.name){case"gitlab":return this.gitlabService.getExistingFork(e);case"github":return this.githubService.getExistingFork(e)}}async createFork(e){let t=await this.settingsService.get(),a=await this.channelService.getGitProviderCredentials(e,t);if(a.personalAccessToken.length<1)throw new Error(`${a.name} personal access token not set`);switch(a.name){case"gitlab":return this.gitlabService.createFork(e);case"github":return this.githubService.createFork(e)}}async createVariables(e){let t=await this.settingsService.get(),a=await this.channelService.getGitProviderCredentials(e,t);if(a.personalAccessToken.length<1)throw new Error(`${a.name} personal access token not set`);switch(a.name){case"gitlab":return this.gitlabService.createVariables(e);case"github":return this.githubService.createVariables(e)}}async getForkRepoStatus(e){let t=await this.settingsService.get(),a=await this.channelService.getGitProviderCredentials(e,t);if(a.personalAccessToken.length<1)throw new Error(`${a.name} personal access token not set`);switch(a.name){case"gitlab":return this.gitlabService.getForkRepoStatus(e);case"github":return this.githubService.getForkRepoStatus(e)}}logPublishProgress(e){if(console.log(e),"undefined"!=typeof window&&void 0!==window.document){const t=new CustomEvent("publish-progress",{detail:{message:e}});document.dispatchEvent(t)}}chunkArrayByBytes(e,t){let a=[],i={};e.forEach((e=>{if(i[e._id]=qn.byteLength(JSON.stringify(e),"utf8"),console.log(e),i[e._id]>t)throw new Error("Image larger than 15MB found. Upload can not proceed.")}));let n=[],s=0;for(let o of e)s+i[o._id]>=t&&(a.push(n),n=[],s=0),n.push(o),s+=i[o._id];return n.length>0&&a.push(n),a}};function Vn(e,{$:t,$on:a,$f7:i,$update:s}){let o=n.getInstance(Kt),r=(n.getInstance(ut),n.getInstance(ti)),c=n.getInstance(Lt),l=n.getInstance(f);const d=async()=>{S.images=await r.getImagesFromContent({title:S.item.title,content:{ops:o.activeEditor.getContents().ops},coverImageCSS:S.item.coverImageCSS,themes:S.item.themes}),1==S.images?.length&&(S.coverImage=S.images[0]),o.activeEditor.update(),await s()},p=async e=>{let a=t(e.currentTarget).data("id"),i=S?.images.filter((e=>e.cid==a));i?.length>0&&(S.coverImage=i[0]),await s()},u=async e=>{e.preventDefault(),S.coverImage=void 0,await s()},h=async e=>{let a=t(e.currentTarget).data("id");w.filter((e=>e.id==a))[0].value=t(e.currentTarget).val(),await s()},m=async e=>{let a=t(e.currentTarget).val();S.item.themes=a,await s(),await d()},g=e=>{let a=t(e.currentTarget).val();S.item.title=a,document.dispatchEvent(new CustomEvent("load-cover-images"))},v=e=>{T=t(e.currentTarget).prop("checked"),s()},b=async e=>{e.preventDefault();let t=i.form.convertToData("#generate-form");try{await o.generateAIImage(t.model,t.prompt,t.negativePrompt),i.popup.close(".ai-popup")}catch(e){l.hideSpinner(),i.dialog.alert(e.message,"There was an error")}};let y,w,$,S=e.item,k=e.editor,I=e.toolbar,R=e.themes,x=e.cancel_link,_=(S.coverImage,e.cover_image_css_editor_id),C=e.animation_css_editor_id,P=e.show_hugging_face,T=!S.item.coverImageAsAnimation;return S&&(e=>{w=e;for(let e of w)!e.value&&e.values?.length>0&&(e.value=e.values[0])})(S.attributeSelections),t(document).on("image-selected",(async e=>{S.coverImage=await c.get(e.detail._id),await d()})),t(document).on("update-cover-image-css",(async e=>{S.item.coverImageCSS=e?.detail?.coverImageCSS,await d()})),t(document).on("load-cover-images",(async e=>{await d()})),t(document).on("ipfs-ready",(async e=>{y=!0,await s()})),t(document).on("hugging-face-ready",(async e=>{P=!0,await s()})),t(document).on("set-ai-prompt",(async e=>{let t=o.activeEditor.getSelection();t&&(t.length>0?($=o.activeEditor.getText(t.index,t.length),console.log("User has highlighted: ",$)):$=""),await s()})),function(e){e.$;var t=e.$h;e.$root,e.$f7,e.$f7route,e.$f7router,e.$theme,e.$update,e.$store;return t`
                                ...
                                <div class="item-content item-input">
                                    <div class="item-inner post-area">
                                        ...
                                        <div id="${I}">
                                            ...
                                            <button class="text-editor-button ai-button" ${P?t`style='display: visible;'`:t``}>AI</button>                                                
                        ...
                        <ul>
                            ...
                            ${T?t`
                                <li class="accordion-item">
                                    ...
                                    <div class="accordion-item-content">
                                        <div class="editor bg-color-white text-color-black css-editor" id="${C}" tabindex="4"></div>
                                    </div>
                                </li>
                            `:t`
    ...
    <div class="page-content hide-toolbar-on-scroll">
      ...
      <div class="item-show">
        ...
        <div class="right">
          ...
          <${Mi} channel=${c.channel._id} item=${c} />
...
`}}Xn.id="d760e6d709",Xn.style="\n  #edit-item-editor {\n    min-height: 175px;\n    height: 100%;\n    /* added these styles */\n    flex: 1;\n    display: flex;\n    flex-direction: column;\n  }\n";const es=Xn;var ts=function(e,t,a,i){var n,s=arguments.length,o=s<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,a):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,a,i);else for(var r=e.length-1;r>=0;r--)(n=e[r])&&(o=(s<3?n(o):s>3?n(t,a,o):n(t,a))||o);return s>3&&o&&Object.defineProperty(t,a,o),o},as=function(e,t){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(e,t)};let is=class{itemWebService;themeService;schemaService;constructor(e,t,a){this.itemWebService=e,this.themeService=t,this.schemaService=a}async create(){return new wi((async e=>{await this.schemaService.loadChannel(e.params.channelId);let t=await this.itemWebService.getNewViewModel(e.params.channelId);return{itemViewModel:t,themes:await this.themeService.listByChannel(t.channel._id,1e3,0)}}),Kn)}async show(){return new wi((async e=>(await this.schemaService.loadChannel(e.params.channelId),{itemViewModel:await this.itemWebService.getNavigation(e.params.channelId,parseInt(e.params.tokenId))})),Qn)}async edit(){return new wi((async e=>{await this.schemaService.loadChannel(e.params.channelId);let t=await this.itemWebService.get(e.params.id);return{itemViewModel:t,themes:await this.themeService.listByChannel(t.channel._id,1e3,0)}}),es)}};function ns(e,{$:t,$on:a,$f7:i,$update:n}){let s=e.authorViewModel,o=[{text:"Home",path:"/"},{text:"Author Profile"}];return function(t){t.$;var a=t.$h;t.$root,t.$f7,t.$f7route,t.$f7router,t.$theme,t.$update,t.$store;return a`
    <div class="page" data-name="profile-show">

        <${_i} breadcrumbs=${o} active="profile" />
...
`}}ts([$i("/admin/item/create/:channelId"),as("design:type",Function),as("design:paramtypes",[]),as("design:returntype",Promise)],is.prototype,"create",null),ts([$i("/admin/channel/show/:channelId/:tokenId"),as("design:type",Function),as("design:paramtypes",[]),as("design:returntype",Promise)],is.prototype,"show",null),ts([$i("/admin/channel/:channelId/item/edit/:id"),as("design:type",Function),as("design:paramtypes",[]),as("design:returntype",Promise)],is.prototype,"edit",null),is=ts([(0,s.b)(),as("design:paramtypes",[ti,Et,We])],is),ns.id="4217338998",ns.style="\n    \n  .profile-pic-edit, #profile-pic--edit-not-found {\n    max-width: 300px;\n    border-radius: 50%;\n    font-size: 100px;\n    float: left;\n  }\n  \n  \n  .profile-pic-main, #profile-pic-not-found {\n    max-width: 100%;\n    border-radius: 50%;\n    font-size: 100px;\n    float: left;\n  }\n  \n  .profile-name {\n    color: var(--f7-block-title-medium-text-color);\n    font-weight: bold;\n  }\n  \n  .profile-address {\n    color: var(--f7-list-item-text-text-color);\n    font-size: 13px;\n  }\n  \n  \n  .profile-pic-wrapper {\n    width: 115px;\n    float: left;\n    padding-right: 20px;\n  }\n\n";const ss=ns;function os(e,{$:t,$on:a,$f7:i,$update:s}){let o=n.getInstance(aa),r=n.getInstance(Lt),c=n.getInstance(da),l=n.getWalletService(),f=e.authorViewModel,d=[{text:"Home",path:"/"},{text:l.truncateEthAddress(f.author.walletAddress),path:`/admin/author/show/${f.author.walletAddress}`},{text:"Edit Profile"}];const p=async t=>{t.preventDefault();let a=Object.assign(new R,i.form.convertToData("#edit-author-form"));try{await c.put(a);i.toast.show({text:"Profile Saved",closeTimeout:2e3,closeButton:!0,position:"bottom",horizontalPosition:"left"});i.views.main.router.navigate(`/admin/${e.channelId}/author/show/${a._id}`)}catch(e){console.log(e),i.dialog.alert(e.errors,"There was an error")}},u=async e=>{t("#author-photo-browse").click()},h=async e=>{let t=await o.uploadFile(document.getElementById("author-photo-browse")),a=await r.newFromBuffer(t);try{await r.put(a)}catch(e){}f.authorPhoto={cid:a.cid,url:await r.getUrl(a)},s()};return function(e){e.$;var t=e.$h;e.$root,e.$f7,e.$f7route,e.$f7router,e.$theme,e.$update,e.$store;return t`
    <div class="page" data-name="profile-edit">

        <${_i} breadcrumbs=${d} active="profile" />
...
`}}os.id="fb7518c212",os.style="\n    .author-photo-preview {\n        max-width: 100%;\n        max-height: 200px;\n        border: 1px solid #cccccc;\n        padding: 5px;\n        margin-bottom: 10px;\n    }\n";const rs=os;var cs=function(e,t,a,i){var n,s=arguments.length,o=s<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,a):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,a,i);else for(var r=e.length-1;r>=0;r--)(n=e[r])&&(o=(s<3?n(o):s>3?n(t,a,o):n(t,a))||o);return s>3&&o&&Object.defineProperty(t,a,o),o},ls=function(e,t){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(e,t)};let fs=class{authorWebService;schemaService;constructor(e,t){this.authorWebService=e,this.schemaService=t}async show(){return new wi((async e=>{let t;await this.schemaService.loadChannel(e.params.channelId);try{t=await this.authorWebService.get(e.params.id)}catch(e){console.log(e)}return t||(t=Object.assign(new R,{author:{walletAddress:e.params.id}})),{authorViewModel:t}}),ss)}async edit(){return new wi((async e=>{let t;await this.schemaService.loadChannel(e.params.channelId);try{t=await this.authorWebService.get(e.params.id)}catch(e){}return t||(t=Object.assign(new R,{author:{walletAddress:e.params.id}})),{authorViewModel:t}}),rs)}};function ds(e,{$:t,$on:a,$f7:i,$update:s}){let o,r=n.getInstance(Gt),c=n.getInstance(Da),l=[{text:"Home",path:"/"},{text:"Settings"}];const f=async e=>{e.preventDefault();let t=i.form.convertToData("#edit-settings-form"),a={_id:t._id,_rev:t._rev,ipfsHost:t.ipfsHost,defaultGitProvider:t.gitProvider,gitCorsProxy:t.gitCorsProxy,gitProviders:{gitlab:{name:"gitlab",username:t.gitLabUsername,personalAccessToken:t.gitLabPersonalAccessToken},github:{name:"github",username:t.gitHubUsername,personalAccessToken:t.gitHubPersonalAccessToken}},alchemyKey:t.alchemyKey,huggingFace:t.huggingFace,welcomeHide:"true"==t.welcomeHide};try{let e=Object.assign(new L,a);await r.put(e),o?.ipfsHost!=e?.ipfsHost&&await c.clearInit();i.toast.show({text:"Settings Saved",closeTimeout:2e3,closeButton:!0,position:"bottom",horizontalPosition:"left"});i.views.main.router.navigate("/")}catch(e){console.log(e.errors),i.dialog.alert(e,"Saving settings failed")}},d=async e=>{o.gitProvider=t(e.currentTarget).val(),await s()};return a("pageInit",(async e=>{o=await r.get(),s()})),function(e){e.$;var t=e.$h;e.$root,e.$f7,e.$f7route,e.$f7router,e.$theme,e.$update,e.$store;return t`
...
`}}us([$i("/admin/settings"),hs("design:type",Function),hs("design:paramtypes",[]),hs("design:returntype",Promise)],ms.prototype,"show",null),ms=us([(0,s.b)(),hs("design:paramtypes",[Gt])],ms),gs.id="791de2c102";const vs=gs;var bs=function(e,t,a,i){var n,s=arguments.length,o=s<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,a):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,a,i);else for(var r=e.length-1;r>=0;r--)(n=e[r])&&(o=(s<3?n(o):s>3?n(t,a,o):n(t,a))||o);return s>3&&o&&Object.defineProperty(t,a,o),o},ys=function(e,t){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(e,t)};let ws=class{ipfsService;constructor(e){this.ipfsService=e}async show(){return new wi((async e=>{if(!this.ipfsService.ipfs)return{};let t=await this.ipfsService.ipfs.swarm.peers(),a=await this.ipfsService.ipfs.id();return{peers:t.map((e=>e.addr.toString())),peerCount:t.length,addresses:a?.addresses?.map((e=>e.toString()))}}),vs)}};function $s(e,{$:t,$h:a,$on:i,$f7:s,$update:o}){let r,c=e.channelViewModel,l=[{text:"Home",path:"/"},{text:c.channel.title,path:`/admin/channel/show/${c.channel._id}`},{text:"Publish"}];return i("pageInit",(async(e,t)=>{r=n.getWalletService(),await o()})),function(e){e.$;var t=e.$h;e.$root,e.$f7,e.$f7route,e.$f7router,e.$theme,e.$update,e.$store;return t`
  ...
  `}}bs([$i("/admin/connect"),ys("design:type",Function),ys("design:paramtypes",[]),ys("design:returntype",Promise)],ws.prototype,"show",null),ws=bs([(0,s.b)(),ys("design:paramtypes",[Da])],ws),$s.id="6332c71d3c";const Ss=$s;var ks=a(27484),Is=a.n(ks);function Rs(e,{$:t,$h:a,$on:i,$f7:s,$update:o}){n.getInstance(_a),n.getInstance(Da),n.getInstance(nt),n.getInstance(mi);let r,c=n.getInstance(Wn),l=e.channelViewModel,f=(e.settings,!1),d="",p=!1,u="pending"==l?.channel.publishReaderIPFSStatus?.status,h=l.itemCount>0,m=l?.gitProvider?.personalAccessToken?.length>0,g=l?.channel?.httpUrlToRepo?.length>0,v=h&&m&&g,b=[{text:"Home",path:"/"},{text:l.channel.title,path:`/admin/channel/show/${l.channel._id}`},{text:"Publish",path:`/admin/publish/${l.channel._id}`},{text:"Push to Git Repo"}];i("pageInit",(async()=>{p=!1,await o()})),i("pageAfterOut",((e,t)=>{console.log("Unloading page"),p=!0}));const y=async e=>{e.preventDefault();s.form.convertToData("#export-form");f=!0,await o();let t=document.getElementsByClassName("publish-label")[0];s.preloader.showIn(t);try{await c.deployReader(l.channel);s.dialog.alert("Files exported to git provider.","Success")}catch(e){console.log(e),s.dialog.alert(e.message,"There was an error")}s.preloader.hideIn(t),f=!1,u=!0,await o()};return t(document).on("publish-progress",(async e=>{e.detail.message&&(d=`<p>${e.detail.message}</p>`),r=e.detail.publishStatus,o();let a=document.getElementById("ipfs-publish-process");a&&t(a).scrollTop(a.scrollHeight)})),function(e){e.$;var t=e.$h;e.$root,e.$f7,e.$f7route,e.$f7router,e.$theme,e.$update,e.$store;return t`
                    ...
                    <form @submit="${S}" id="create-car-form">
                        ...
                        <div class="card card-header-divider">
                            ...
                            <div class="card-content card-content-padding">      
                                ...
                                ${g?t`
                                    <div class="publish-output" innerHTML="${g}" id="ipfs-publish-process" ></div>
                                `:t`
                                ...
                                ${u.channel.publishReaderIPFSStatus?.cid?t`
                                    ...
                                    <div class="pin-status"> 
                                            ...
                                            <strong>Download Archive:</strong> <a href="#" @click="${k}" class="link">export.car</a><br />
                                            <strong>Date:</strong> ${Is()(u.channel.publishReaderIPFSStatus?.date).format("MMMM DD YYYY, h:mm:ss a")}
...
`}}Ms.id="c7c36f8ecf",Ms.style="\n  .publish-label,\n  .ipfs-label,\n  .forking-label {\n    margin-top: 10px;\n    margin-bottom: 10px;\n    font-weight: bold;\n    font-size: 18px;\n  }\n\n  .publish-output {\n    border: 1px solid #cccccc;\n    font-size: 13px;\n    width: 100%;\n    max-width: 100%;\n    padding: 5px;\n    height: 300px;\n    overflow-y: scroll;\n  }\n\n  #fork-next-button {\n    width: 200px;\n  }\n";const Ls=Ms;function Ns(e,{$:t,$h:a,$on:i,$f7:s,$update:o}){let r,c=n.getInstance(_a),l=n.getInstance(Da),f=(n.getInstance(nt),n.getInstance(mi),n.getInstance(Wn)),d=(n.getInstance(Es),null!=l.ipfs),p=l.peerCount,u=e.channelViewModel,h=e.settings,m=!1,g="",v=u.channel.publishReaderRepoId>0&&"complete"==u.channel.publishReaderRepoStatus,b=null!=u.channel.localCid,y=u.itemCount>0,w=u?.gitProvider?.personalAccessToken?.length>0,$=h?.gitCorsProxy?.length>0,S=y&&w&&$,k=u.channel.httpUrlToRepo,I=[{text:"Home",path:"/"},{text:u.channel.title,path:`/admin/channel/show/${u.channel._id}`},{text:"Publish",path:`/admin/publish/${u.channel._id}`},{text:"Publish Collection To Reader"}];i("pageInit",(async()=>{await l.init(),d=null!=l.ipfs,r=await c.getGitProviderCredentials(u.channel,h),await o()}));const R=async e=>{e.preventDefault(),m=!0,await o();let t=document.getElementsByClassName("ipfs-label")[0];s.preloader.showIn(t);try{let e=`/export/${u.channel._id}`,t=await(0,Xi.Z)(l.ipfs.files.read(`${e}/contractMetadata.json`));await f.deployReaderGit(u.channel,t)}catch(e){console.log(e),s.dialog.alert(e,"There was an error")}s.preloader.hideIn(t),m=!1,await o()},x=async e=>{e.preventDefault();let t=document.getElementsByClassName("ipfs-label")[0];s.preloader.showIn(t);try{await f.clearGitRepos()}catch(e){s.dialog.alert(e,"There was an error")}s.preloader.hideIn(t),await o()};return t(document).on("publish-reader-progress",(async e=>{g=`<p>${e.detail.message}</p>`,o()})),t(document).on("update-peers",(async e=>{p=e.detail.count,o()})),function(e){e.$;var t=e.$h;e.$root,e.$f7,e.$f7route,e.$f7router,e.$theme,e.$update,e.$store;return t`
  ...
  `}}Ns.id="80ec35b0cf",Ns.style="\n\n    .publish-label, .ipfs-label, .forking-label {\n      margin-top: 10px;\n      margin-bottom: 10px;\n      font-weight: bold;\n      font-size: 18px;\n    }\n\n    .publish-output {\n      border: 1px solid #cccccc;\n      font-size: 13px;\n      width: 100%;\n      max-width: 100%;\n      padding: 5px;\n      height: 300px;\n      overflow-y : scroll;\n    }\n  ";const Us=Ns;var Hs=a(41972),qs=function(e,t,a,i){var n,s=arguments.length,o=s<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,a):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,a,i);else for(var r=e.length-1;r>=0;r--)(n=e[r])&&(o=(s<3?n(o):s>3?n(t,a,o):n(t,a))||o);return s>3&&o&&Object.defineProperty(t,a,o),o},Gs=function(e,t){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(e,t)},zs=function(e,t){return function(a,i){t(a,i,e)}};let Ws=class{channelService;walletService;contracts;constructor(e,t,a){this.channelService=e,this.walletService=t,this.contracts=a}async deployContract(e){if(!e.publishReaderIPFSStatus?.cid)throw new Error("Not published to IPFS");let t=await this.channelService.countItemsByChannel(e._id);if(t<=0)throw new Error("No NFTs");let a=Ai.vz(e.mintPrice,"ether"),i=await this.deploy(e.title,e.symbol,e.publishReaderIPFSStatus?.cid,a.toString(),t);e.contractAddress=i.contractAddress,e.showActivityPage=!0,e.showMintPage=!0,await this.channelService.put(e)}async updateContract(e){if(!e.publishReaderIPFSStatus?.cid)throw new Error("Not published to IPFS");let t=await this.channelService.countItemsByChannel(e._id);if(t<=0)throw new Error("No NFTs");let a=Ai.vz(e.mintPrice,"ether");await this.update(e,e.publishReaderIPFSStatus?.cid,a.toString(),t);e.showActivityPage=!0,e.showMintPage=!0,await this.channelService.put(e)}async deploy(e,t,a,i,n){if(!(e&&t&&i&&n&&a))throw new Error("Missing inputs to deploy");let s=this.walletService.wallet;if(!s)throw new Error("No wallet!");const o=this.contracts.Channel,r=new Hs.l(o.abi,o.bytecode,s);return(await r.deploy(e,t,a,BigInt(i.toString()),BigInt(n.toString()))).deploymentTransaction().wait()}async update(e,t,a,i){if(!a||!i||!t)throw new Error("Missing inputs to deploy");if(!this.walletService.wallet)throw new Error("No wallet!");let n=await this.channelService.getChannelContract(e),s=await n.update(t,BigInt(a.toString()),BigInt(i.toString()));console.log(s)}};function Vs(e,{$:t,$h:a,$on:i,$f7:s,$update:o}){let r,c=n.getInstance(_a),l=n.getInstance(Da),f=n.getInstance(nt),d=(n.getInstance(mi),n.getInstance(Ws)),p=(n.getInstance(Hn),n.getInstance(Es)),u=e.channelViewModel,h=(e.channelContract,!1),m=null!=u.channel.publishReaderIPFSStatus?.cid||u.channel.contractAddress,g=[{text:"Home",path:"/"},{text:u.channel.title,path:`/admin/channel/show/${u.channel._id}`},{text:"Publish",path:`/admin/publish/${u.channel._id}`},{text:"Deploy Contract"}];i("pageInit",(async(e,t)=>{r=n.getWalletService(),await l.initLocal(),await o()}));const v=async e=>{h=!0,await o();let t={title:`Deploying contract ${name}. Approve transaction and wait for it to be mined.`,promise:d.deployContract(u.channel)};await f.queuePromiseView(t),h=!1,await o()},b=async e=>{h=!0,await o();let t={title:`Updating contract ${name}. Approve transaction and wait for it to be mined.`,promise:d.updateContract(u.channel)};await f.queuePromiseView(t),h=!1,await o()},y=async e=>{s.dialog.confirm("Are you sure you want to clear the contract address? This will not remove the actual contract from the network it will just allow you to redploy a new copy.","Reset Contract",(async()=>{u.channel.contractAddress=void 0,await c.put(u.channel),u.channel=await c.get(u.channel._id);s.toast.show({text:"Contract address cleared.",closeTimeout:2e3,closeButton:!0,position:"bottom",horizontalPosition:"left"});await o()}))},w=async e=>{e.preventDefault();let a=await p.publishContract(u.channel);t("#hidden-download").attr("href",URL.createObjectURL(new Blob([a.content],{type:"application/car"}))),t("#hidden-download").click()};return function(e){e.$;var t=e.$h;e.$root,e.$f7,e.$f7route,e.$f7router,e.$theme,e.$update,e.$store;return t`
                ...
                <div class="card-content card-content-padding">
                  ...
                  ${m?t`
                    ...
                    <div class="pin-status">
                      ...
                      <p><strong>Date Exported:</strong> ${Is()(u.channel.publishReaderIPFSStatus?.date).format("MMMM DD YYYY, h:mm:ss a")}</p>
                    </div>
  ...
  `}}Ws=qs([(0,s.b)(),zs(1,(0,o.f)(i.WalletService)),zs(2,(0,o.f)("contracts")),Gs("design:paramtypes",[_a,Object,Object])],Ws),Vs.id="1ebbf8ae0d",Vs.style="\n\n  ";const Zs=Vs;var Js=function(e,t,a,i){var n,s=arguments.length,o=s<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,a):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,a,i);else for(var r=e.length-1;r>=0;r--)(n=e[r])&&(o=(s<3?n(o):s>3?n(t,a,o):n(t,a))||o);return s>3&&o&&Object.defineProperty(t,a,o),o},Ks=function(e,t){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(e,t)};let Ys=class{channelWebService;settingsService;schemaService;gitlabService;constructor(e,t,a,i){this.channelWebService=e,this.settingsService=t,this.schemaService=a,this.gitlabService=i}async publish(){return new wi((async e=>(await this.schemaService.loadChannel(e.params.id),{channelViewModel:await this.channelWebService.get(e.params.id)})),Ss)}async export(){return new wi((async e=>{await this.schemaService.loadChannel(e.params.id);let t,a=await this.channelWebService.get(e.params.id);try{t=await this.settingsService.get()}catch(e){}return{channelViewModel:a,settings:t}}),xs)}async ipfs(){return new wi((async e=>{await this.schemaService.loadChannel(e.params.id);let t,a=await this.channelWebService.get(e.params.id);try{t=await this.settingsService.get()}catch(e){}return{channelViewModel:a,settings:t}}),Bs)}async forkReader(){return new wi((async e=>{await this.schemaService.loadChannel(e.params.id);let t,a=await this.channelWebService.get(e.params.id);try{t=await this.settingsService.get()}catch(e){}return{channelViewModel:a,settings:t}}),Ls)}async publishReader(){return new wi((async e=>{await this.schemaService.loadChannel(e.params.id);let t,a=await this.channelWebService.get(e.params.id);try{t=await this.settingsService.get()}catch(e){}return{channelViewModel:a,settings:t}}),Us)}async contract(){return new wi((async e=>{await this.schemaService.loadChannel(e.params.id);let t=await this.channelWebService.get(e.params.id);return{channelViewModel:t,channelContract:await this.channelWebService.getChannelContract(t.channel)}}),Zs)}};Js([$i("/admin/publish/:id"),Ks("design:type",Function),Ks("design:paramtypes",[]),Ks("design:returntype",Promise)],Ys.prototype,"publish",null),Js([$i("/admin/publish/export/:id"),Ks("design:type",Function),Ks("design:paramtypes",[]),Ks("design:returntype",Promise)],Ys.prototype,"export",null),Js([$i("/admin/publish/ipfs/:id"),Ks("design:type",Function),Ks("design:paramtypes",[]),Ks("design:returntype",Promise)],Ys.prototype,"ipfs",null),Js([$i("/admin/publish/fork-reader/:id"),Ks("design:type",Function),Ks("design:paramtypes",[]),Ks("design:returntype",Promise)],Ys.prototype,"forkReader",null),Js([$i("/admin/publish/publish-reader/:id"),Ks("design:type",Function),Ks("design:paramtypes",[]),Ks("design:returntype",Promise)],Ys.prototype,"publishReader",null),Js([$i("/admin/publish/contract/:id"),Ks("design:type",Function),Ks("design:paramtypes",[]),Ks("design:returntype",Promise)],Ys.prototype,"contract",null),Ys=Js([(0,s.b)(),Ks("design:paramtypes",[si,Gt,We,mi])],Ys);var Qs=function(e,t,a,i){var n,s=arguments.length,o=s<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,a):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,a,i);else for(var r=e.length-1;r>=0;r--)(n=e[r])&&(o=(s<3?n(o):s>3?n(t,a,o):n(t,a))||o);return s>3&&o&&Object.defineProperty(t,a,o),o},Xs=function(e,t){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(e,t)};let eo=class{constructor(){}buildPagingViewModel(e,t,a,i){let n=new to;return n.offset=e||0,n.limit=t,n.count=a,n.start=n.offset+1,n.end=Math.min(n.offset+t,a),n.previousOffset=Math.max(n.offset-t,0),n.offset+t<a&&(n.nextOffset=n.offset+t),n.page=n.offset/n.limit+1,n.page>n.endPage&&(n.page=n.endPage),n.endPage=Math.ceil(n.count/n.limit),n.lastOffset=n.endPage*n.limit-n.limit,n.showNext=n.endPage>n.page,n.showPrevious=0!=n.offset,n.showFirst=n.page>2,n.showLast=n.page<n.endPage-1,n}calculateEndIndex(e,t,a){let i=t+e-1;return Math.min(a-1,i)}calculateDescendingEndIndex(e,t){let a=t-(e-1);return Math.max(0,a)}calculateDescendingOffset(e,t){let a=t-1-e;return Math.max(0,a)}};eo=Qs([(0,s.b)(),Xs("design:paramtypes",[])],eo);class to{page;pageNumbers;endPage;offset;limit;count;start;end;previousOffset;nextOffset;lastOffset;showPrevious;showNext;showFirst;showLast}var ao=a(56354);function io(e,{$:t,$on:a,$f7:i,$update:s}){n.getInstance(wa);let o=n.getInstance(_a),r=n.getWalletService(),c=e.channel_view_model;const l=async e=>{i.dialog.confirm("Are you sure you want to delete this collection? This will only remove your local copy of the files.",(async()=>{i.preloader.show(),await o.delete(c.channel),i.preloader.hide(),i.views.main.router.navigate("/");i.toast.show({text:"Collection deleted",closeTimeout:2e3,closeButton:!0,position:"bottom",horizontalPosition:"left"})}))};return function(e){e.$;var t,a=e.$h;e.$root,e.$f7,e.$f7route,e.$f7router,e.$theme,e.$update,e.$store;return a`
