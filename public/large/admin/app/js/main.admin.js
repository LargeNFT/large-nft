...
`}}ma.id="58bfa7b03a",ma.style="\n\n\n\n\n\n";const va=ma;var ba=i(20637);function ya(e,{$:t,$on:i,$f7:a,$update:s}){n.getInstance(mi);let o,r=n.getInstance(zi),c=n.getInstance(ti),l=n.getInstance(Lt),d=(n.getInstance(f),n.getWalletService()),p=[{text:"Home",path:"/"},{text:"Create & Import",path:"/admin/channel/create-menu"},{text:"Create Collection"}];ba.Z.configure({languages:["css"]});let u,h,g={channel:{mintPrice:"0.00",authorId:d.address},themes:[],staticPages:[],editable:!0,disableForks:!1};const m=async e=>{if(e.preventDefault(),!document.getElementById("create-channel-form").reportValidity())return void document.getElementById("collection-title").scrollIntoView();let t=Object.assign(new A,a.form.convertToData("#create-channel-form"));t.description=l.activeEditor.getContents(),t.license=o.getContents(),t.sellerFeeBasisPoints=parseInt(t.sellerFeeBasisPoints),t.attributeOptions?t.attributeOptions=JSON.parse(t.attributeOptions):t.attributeOptions=[],t.externalLinks?t.externalLinks=JSON.parse(t.externalLinks):t.externalLinks=[],t.marketplaces?t.marketplaces=JSON.parse(t.marketplaces):t.marketplaces=[],t.disableForks="true"==t.disableForks,t.showMintPage="true"==t.showMintPage,t.showActivityPage="true"==t.showActivityPage;try{await r.put(t,u,h),t.authorId&&await c.insertIfNew(t.authorId);a.toast.show({text:"Collection saved",closeTimeout:2e3,closeButton:!0,position:"bottom",horizontalPosition:"left"});a.views.main.router.navigate(`/admin/channel/show/${t._id}`)}catch(e){console.log(e),a.dialog.alert(e.errors,"There was an error")}};i("pageInit",(async(e,i)=>{t("#create-channel-form").attr("novalidate","novalidate"),await l.init(),l.buildQuillPostEditor("#create-channel-description-editor","#create-channel-description-toolbar"),o=new(ot())("#create-channel-license-editor",{bounds:".page-content",modules:{toolbar:"#create-channel-license-toolbar"},theme:"snow"})}));return t(document).on("cover-image-updated",(async e=>{u=e.detail.coverImage})),t(document).on("cover-banner-updated",(async e=>{h=e.detail.coverBanner})),function(e){e.$;var t=e.$h;e.$root,e.$f7,e.$f7route,e.$f7router,e.$theme,e.$update,e.$store;return t`
            ...
            <div class="page">
              ...
              <div class="page-content">
                <form id="add-theme-form" @submit="${v}">
                  <${_a} cover_image_css_editor_id="add-theme-cover-image-editor"
            ...
            <div class="page">
              ...
              <div class="page-content">
                <form id="edit-theme-form" @submit="${b}">
                  ...
                  <${_a} cover_image_css_editor_id="edit-theme-cover-image-editor"
