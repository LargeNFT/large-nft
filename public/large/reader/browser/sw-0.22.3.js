...
(0,workbox_routing__WEBPACK_IMPORTED_MODULE_0__.registerRoute)(({ url }) => url.pathname.startsWith(`${baseURI}sync`), new workbox_strategies__WEBPACK_IMPORTED_MODULE_1__.NetworkFirst());
...
(0,workbox_routing__WEBPACK_IMPORTED_MODULE_0__.registerRoute)(({ url }) => url.pathname.startsWith(`${baseURI}backup`), new workbox_strategies__WEBPACK_IMPORTED_MODULE_1__.CacheFirst());
...
(0,workbox_routing__WEBPACK_IMPORTED_MODULE_0__.registerRoute)(({ url }) => url.pathname.startsWith(`${baseURI}t`), new workbox_strategies__WEBPACK_IMPORTED_MODULE_1__.StaleWhileRevalidate());
(0,workbox_routing__WEBPACK_IMPORTED_MODULE_0__.registerRoute)(({ url }) => url.pathname.startsWith(`${baseURI}s`), new workbox_strategies__WEBPACK_IMPORTED_MODULE_1__.StaleWhileRevalidate());

})();

/******/ })()
;
//# sourceMappingURL=sw-0.22.3.js.map