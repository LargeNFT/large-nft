...
function framework7Component(props, {
  ...
  const updateTotal = async () => {
    total = globalThis.ethers.formatUnits(mintPriceWei * quantity);
    await $update();
  };
  ...
  const populate = async () => {
    ...
    try {
      ...
      mintPriceWei = globalThis.ethers.parseUnits(mintingViewModel.mintPrice, 'ether');
      await updateTotal();
...
/***/ "./src/reader/html/css/framework7-bundle.css":
/*!***************************************************!*\
  !*** ./src/reader/html/css/framework7-bundle.css ***!
  \***************************************************/
/***/ (() => {
...
/***/ "./src/reader/html/css/framework7-icons.css":
/*!**************************************************!*\
  !*** ./src/reader/html/css/framework7-icons.css ***!
  \**************************************************/
/***/ (() => {
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initLibrary: () => (/* binding */ initLibrary)
/* harmony export */ });
...
/* harmony import */ var _reader_inversify_config_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../reader/inversify.config.js */ "./src/reader/inversify.config.ts");
...
/* harmony import */ var _reader_html_css_app_css__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../reader/html/css/app.css */ "./src/reader/html/css/app.css");
/* harmony import */ var _html_css_app_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./html/css/app.css */ "./src/library/html/css/app.css");
/* harmony import */ var _service_web_home_web_service_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./service/web/home-web-service.js */ "./src/library/service/web/home-web-service.ts");
/* harmony import */ var _repository_web_home_repository_impl_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./repository/web/home-repository-impl.js */ "./src/library/repository/web/home-repository-impl.ts");
/* harmony import */ var _reader_service_core_routing_service_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../reader/service/core/routing-service.js */ "./src/reader/service/core/routing-service.ts");
...
let initLibrary = async (libraryURL, baseURI, hostname, version, channelId) => {
    console.log("Initializing Library");
    if ('serviceWorker' in navigator) {
        const wb = new workbox_window__WEBPACK_IMPORTED_MODULE_2__.Workbox(`${hostname}/sw-library-${version}.js`, {
            scope: `/`
        });
        let container = new inversify__WEBPACK_IMPORTED_MODULE_7__.Container();
        container.bind("libraryURL").toConstantValue(libraryURL);
        container.bind("HomeWebService").to(_service_web_home_web_service_js__WEBPACK_IMPORTED_MODULE_8__.HomeWebService).inSingletonScope();
        container.bind("HomeRepository").to(_repository_web_home_repository_impl_js__WEBPACK_IMPORTED_MODULE_9__.HomeRepositoryBrowserImpl).inSingletonScope();
        let routes = _reader_service_core_routing_service_js__WEBPACK_IMPORTED_MODULE_10__.RoutingService.getLibraryRoutes(libraryURL);
        container = await (0,_reader_inversify_config_js__WEBPACK_IMPORTED_MODULE_11__.getMainContainer)(container, baseURI, hostname, version, routes, channelId);
...
/***/ "./src/library/repository/web/home-repository-impl.ts":
/*!************************************************************!*\
  !*** ./src/library/repository/web/home-repository-impl.ts ***!
  \************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   HomeRepositoryBrowserImpl: () => (/* binding */ HomeRepositoryBrowserImpl)
/* harmony export */ });
...
let HomeRepositoryBrowserImpl = class HomeRepositoryBrowserImpl {
    libraryURL;
    constructor(libraryURL) {
        this.libraryURL = libraryURL;
    }
    async get(pageNumber) {
        const response = await axios__WEBPACK_IMPORTED_MODULE_0__["default"].get(`${this.libraryURL}/home.json`);
        return response.data;
    }
};
HomeRepositoryBrowserImpl = __decorate([
    (0,inversify__WEBPACK_IMPORTED_MODULE_1__.injectable)(),
    __param(0, (0,inversify__WEBPACK_IMPORTED_MODULE_2__.inject)('libraryURL')),
    __metadata("design:paramtypes", [Object])
], HomeRepositoryBrowserImpl);



/***/ }),

/***/ "./src/library/service/web/home-web-service.ts":
/*!*****************************************************!*\
  !*** ./src/library/service/web/home-web-service.ts ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   HomeWebService: () => (/* binding */ HomeWebService)
/* harmony export */ });
...
let HomeWebService = class HomeWebService {
    constructor() { }
    homeRepository;
    async get() {
...
__decorate([
    (0,inversify__WEBPACK_IMPORTED_MODULE_0__.inject)("HomeRepository"),
    __metadata("design:type", Object)
], HomeWebService.prototype, "homeRepository", void 0);
HomeWebService = __decorate([
    (0,inversify__WEBPACK_IMPORTED_MODULE_1__.injectable)(),
...
/* harmony import */ var ethers__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! ethers */ "./node_modules/ethers/lib.esm/providers/provider-browser.js");
/* harmony import */ var ethers__WEBPACK_IMPORTED_MODULE_82__ = __webpack_require__(/*! ethers */ "./node_modules/ethers/lib.esm/ethers.js");
/* harmony import */ var framework7__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! framework7 */ "./node_modules/framework7/framework7.esm.js");
...
/* harmony import */ var dayjs_plugin_relativeTime_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! dayjs/plugin/relativeTime.js */ "./node_modules/dayjs/plugin/relativeTime.js");
/* harmony import */ var dayjs_plugin_relativeTime_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(dayjs_plugin_relativeTime_js__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var pouchdb_quick_search__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! pouchdb-quick-search */ "./node_modules/pouchdb-quick-search/lib/index.js");
/* harmony import */ var pouchdb_quick_search__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(pouchdb_quick_search__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var framework7_components_dialog__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! framework7/components/dialog */ "./node_modules/framework7/components/dialog/dialog.js");
/* harmony import */ var framework7_components_toast__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! framework7/components/toast */ "./node_modules/framework7/components/toast/toast.js");
/* harmony import */ var framework7_components_preloader__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! framework7/components/preloader */ "./node_modules/framework7/components/preloader/preloader.js");
/* harmony import */ var framework7_components_virtual_list__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! framework7/components/virtual-list */ "./node_modules/framework7/components/virtual-list/virtual-list.js");
/* harmony import */ var framework7_components_list_index__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! framework7/components/list-index */ "./node_modules/framework7/components/list-index/list-index.js");
...
/* harmony import */ var framework7_components_accordion__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! framework7/components/accordion */ "./node_modules/framework7/components/accordion/accordion.js");
...
/* harmony import */ var framework7_components_card__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! framework7/components/card */ "./node_modules/framework7/components/card/card.js");
/* harmony import */ var framework7_components_chip__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! framework7/components/chip */ "./node_modules/framework7/components/chip/chip.js");
/* harmony import */ var framework7_components_form__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! framework7/components/form */ "./node_modules/framework7/components/form/form.js");
/* harmony import */ var framework7_components_grid__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! framework7/components/grid */ "./node_modules/framework7/components/grid/grid.js");
...
/* harmony import */ var _components_reader_transaction_f7_html__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ./components/reader/transaction.f7.html */ "./src/reader/components/reader/transaction.f7.html");
/* harmony import */ var _components_reader_item_mint_list_f7_html__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./components/reader/item/mint-list.f7.html */ "./src/reader/components/reader/item/mint-list.f7.html");
/* harmony import */ var _components_reader_channel_attribute_filter_f7_html__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./components/reader/channel/attribute-filter.f7.html */ "./src/reader/components/reader/channel/attribute-filter.f7.html");
/* harmony import */ var _components_reader_channel_explore_total_info_f7_html__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./components/reader/channel/explore-total-info.f7.html */ "./src/reader/components/reader/channel/explore-total-info.f7.html");
/* harmony import */ var _components_reader_channel_mint_info_f7_html__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./components/reader/channel/mint-info.f7.html */ "./src/reader/components/reader/channel/mint-info.f7.html");
/* harmony import */ var _components_reader_channel_largest_sales_f7_html__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./components/reader/channel/largest-sales.f7.html */ "./src/reader/components/reader/channel/largest-sales.f7.html");
/* harmony import */ var _components_reader_channel_transaction_row_f7_html__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ./components/reader/channel/transaction-row.f7.html */ "./src/reader/components/reader/channel/transaction-row.f7.html");
/* harmony import */ var _components_reader_channel_leaderboard_rows_f7_html__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ./components/reader/channel/leaderboard-rows.f7.html */ "./src/reader/components/reader/channel/leaderboard-rows.f7.html");
...
/* harmony import */ var _service_core_wallet_service_impl_js__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(/*! ./service/core/wallet-service-impl.js */ "./src/reader/service/core/wallet-service-impl.ts");
/* harmony import */ var _repository_browser_channel_repository_impl_js__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(/*! ./repository/browser/channel-repository-impl.js */ "./src/reader/repository/browser/channel-repository-impl.ts");
/* harmony import */ var _repository_browser_item_repository_impl_js__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(/*! ./repository/browser/item-repository-impl.js */ "./src/reader/repository/browser/item-repository-impl.ts");
/* harmony import */ var _repository_browser_author_repository_impl_js__WEBPACK_IMPORTED_MODULE_40__ = __webpack_require__(/*! ./repository/browser/author-repository-impl.js */ "./src/reader/repository/browser/author-repository-impl.ts");
/* harmony import */ var _repository_browser_metadata_repository_impl_js__WEBPACK_IMPORTED_MODULE_41__ = __webpack_require__(/*! ./repository/browser/metadata-repository-impl.js */ "./src/reader/repository/browser/metadata-repository-impl.ts");
/* harmony import */ var _repository_browser_image_repository_impl_js__WEBPACK_IMPORTED_MODULE_42__ = __webpack_require__(/*! ./repository/browser/image-repository-impl.js */ "./src/reader/repository/browser/image-repository-impl.ts");
/* harmony import */ var _repository_browser_animation_repository_impl_js__WEBPACK_IMPORTED_MODULE_43__ = __webpack_require__(/*! ./repository/browser/animation-repository-impl.js */ "./src/reader/repository/browser/animation-repository-impl.ts");
/* harmony import */ var _repository_browser_static_page_repository_impl_js__WEBPACK_IMPORTED_MODULE_44__ = __webpack_require__(/*! ./repository/browser/static-page-repository-impl.js */ "./src/reader/repository/browser/static-page-repository-impl.ts");
/* harmony import */ var _repository_browser_item_page_repository_impl_js__WEBPACK_IMPORTED_MODULE_45__ = __webpack_require__(/*! ./repository/browser/item-page-repository-impl.js */ "./src/reader/repository/browser/item-page-repository-impl.ts");
/* harmony import */ var _repository_browser_attribute_total_repository_impl_js__WEBPACK_IMPORTED_MODULE_47__ = __webpack_require__(/*! ./repository/browser/attribute-total-repository-impl.js */ "./src/reader/repository/browser/attribute-total-repository-impl.ts");
/* harmony import */ var _repository_browser_reader_settings_repository_impl_js__WEBPACK_IMPORTED_MODULE_48__ = __webpack_require__(/*! ./repository/browser/reader-settings-repository-impl.js */ "./src/reader/repository/browser/reader-settings-repository-impl.ts");
/* harmony import */ var _repository_browser_token_repository_impl_js__WEBPACK_IMPORTED_MODULE_51__ = __webpack_require__(/*! ./repository/browser/token-repository-impl.js */ "./src/reader/repository/browser/token-repository-impl.ts");
/* harmony import */ var _service_web_channel_web_service_js__WEBPACK_IMPORTED_MODULE_54__ = __webpack_require__(/*! ./service/web/channel-web-service.js */ "./src/reader/service/web/channel-web-service.ts");
/* harmony import */ var _service_web_item_web_service_js__WEBPACK_IMPORTED_MODULE_55__ = __webpack_require__(/*! ./service/web/item-web-service.js */ "./src/reader/service/web/item-web-service.ts");
/* harmony import */ var _service_web_author_web_service_js__WEBPACK_IMPORTED_MODULE_56__ = __webpack_require__(/*! ./service/web/author-web-service.js */ "./src/reader/service/web/author-web-service.ts");
/* harmony import */ var _service_web_mint_web_service_js__WEBPACK_IMPORTED_MODULE_57__ = __webpack_require__(/*! ./service/web/mint-web-service.js */ "./src/reader/service/web/mint-web-service.ts");
/* harmony import */ var _service_web_searchbar_service_js__WEBPACK_IMPORTED_MODULE_58__ = __webpack_require__(/*! ./service/web/searchbar-service.js */ "./src/reader/service/web/searchbar-service.ts");
...
/* harmony import */ var _repository_browser_token_owner_page_repository_impl_js__WEBPACK_IMPORTED_MODULE_46__ = __webpack_require__(/*! ./repository/browser/token-owner-page-repository-impl.js */ "./src/reader/repository/browser/token-owner-page-repository-impl.ts");
...
/* harmony import */ var _repository_browser_row_item_view_model_repository_impl_js__WEBPACK_IMPORTED_MODULE_53__ = __webpack_require__(/*! ./repository/browser/row-item-view-model-repository-impl.js */ "./src/reader/repository/browser/row-item-view-model-repository-impl.ts");





dayjs__WEBPACK_IMPORTED_MODULE_0___default().extend((dayjs_plugin_relativeTime_js__WEBPACK_IMPORTED_MODULE_1___default()));



//Enable find plugin
pouchdb_browser__WEBPACK_IMPORTED_MODULE_2__["default"].plugin(pouchdb_find__WEBPACK_IMPORTED_MODULE_3__["default"]);
//Enable quicksearch
pouchdb_browser__WEBPACK_IMPORTED_MODULE_2__["default"].plugin((pouchdb_quick_search__WEBPACK_IMPORTED_MODULE_4___default()));
...
framework7__WEBPACK_IMPORTED_MODULE_5__["default"].use([framework7_components_dialog__WEBPACK_IMPORTED_MODULE_6__["default"], framework7_components_toast__WEBPACK_IMPORTED_MODULE_7__["default"], framework7_components_preloader__WEBPACK_IMPORTED_MODULE_8__["default"], framework7_components_virtual_list__WEBPACK_IMPORTED_MODULE_9__["default"], framework7_components_list_index__WEBPACK_IMPORTED_MODULE_10__["default"], framework7_components_card__WEBPACK_IMPORTED_MODULE_11__["default"], framework7_components_chip__WEBPACK_IMPORTED_MODULE_12__["default"], framework7_components_form__WEBPACK_IMPORTED_MODULE_13__["default"], framework7_components_grid__WEBPACK_IMPORTED_MODULE_14__["default"],
    framework7_components_range__WEBPACK_IMPORTED_MODULE_15__["default"], framework7_components_accordion__WEBPACK_IMPORTED_MODULE_16__["default"], framework7_components_popup__WEBPACK_IMPORTED_MODULE_17__["default"], framework7_components_infinite_scroll__WEBPACK_IMPORTED_MODULE_18__["default"], framework7_components_panel__WEBPACK_IMPORTED_MODULE_19__["default"], framework7_components_popover__WEBPACK_IMPORTED_MODULE_20__["default"], framework7_components_stepper__WEBPACK_IMPORTED_MODULE_21__["default"]]);
...
async function getMainContainer(customContainer, theBaseURI, theHostname, version, routes, channelId) {
    ...
    function framework7() {
        framework7__WEBPACK_IMPORTED_MODULE_5__["default"].registerComponent("nav-bar", _components_reader_navbar_f7_html__WEBPACK_IMPORTED_MODULE_23__["default"]);
        framework7__WEBPACK_IMPORTED_MODULE_5__["default"].registerComponent("token-toolbar", _components_reader_token_toolbar_f7_html__WEBPACK_IMPORTED_MODULE_24__["default"]);
        // Framework7.registerComponent("nft-info", NftInfo)
        framework7__WEBPACK_IMPORTED_MODULE_5__["default"].registerComponent("mint-list", _components_reader_item_mint_list_f7_html__WEBPACK_IMPORTED_MODULE_25__["default"]);
        framework7__WEBPACK_IMPORTED_MODULE_5__["default"].registerComponent("attribute-filter", _components_reader_channel_attribute_filter_f7_html__WEBPACK_IMPORTED_MODULE_26__["default"]);
        framework7__WEBPACK_IMPORTED_MODULE_5__["default"].registerComponent("explore-total-info", _components_reader_channel_explore_total_info_f7_html__WEBPACK_IMPORTED_MODULE_27__["default"]);
        framework7__WEBPACK_IMPORTED_MODULE_5__["default"].registerComponent("mint-info", _components_reader_channel_mint_info_f7_html__WEBPACK_IMPORTED_MODULE_28__["default"]);
        framework7__WEBPACK_IMPORTED_MODULE_5__["default"].registerComponent("largest-sales", _components_reader_channel_largest_sales_f7_html__WEBPACK_IMPORTED_MODULE_29__["default"]);
        framework7__WEBPACK_IMPORTED_MODULE_5__["default"].registerComponent("transaction-viewer", _components_reader_transaction_f7_html__WEBPACK_IMPORTED_MODULE_30__["default"]);
        framework7__WEBPACK_IMPORTED_MODULE_5__["default"].registerComponent("transaction-row", _components_reader_channel_transaction_row_f7_html__WEBPACK_IMPORTED_MODULE_31__["default"]);
        framework7__WEBPACK_IMPORTED_MODULE_5__["default"].registerComponent("leaderboard-rows", _components_reader_channel_leaderboard_rows_f7_html__WEBPACK_IMPORTED_MODULE_32__["default"]);
        framework7__WEBPACK_IMPORTED_MODULE_5__["default"].registerComponent("search-list", _components_reader_item_search_list_f7_html__WEBPACK_IMPORTED_MODULE_33__["default"]);
        framework7__WEBPACK_IMPORTED_MODULE_5__["default"].registerComponent("infinite-scroll-content", _components_reader_item_infinite_scroll_content_f7_html__WEBPACK_IMPORTED_MODULE_34__["default"]);
        globalThis.app = new framework7__WEBPACK_IMPORTED_MODULE_5__["default"]({
            el: '#app',
            id: 'large-reader',
            name: 'Large Reader',
            theme: 'auto',
    ...
    container.bind("PouchDB").toConstantValue(() => {
        return pouchdb_browser__WEBPACK_IMPORTED_MODULE_2__["default"];
    });
    container.bind("PouchFind").toConstantValue(pouchdb_find__WEBPACK_IMPORTED_MODULE_3__["default"]);
    container.bind("PouchQuickSearch").toConstantValue((pouchdb_quick_search__WEBPACK_IMPORTED_MODULE_4___default()));
    container.bind("provider").toConstantValue(() => {
        if (typeof window !== "undefined" && window['ethereum']) {
            //@ts-ignore
            window.web3Provider = window.ethereum;
            //@ts-ignore
            return new ethers__WEBPACK_IMPORTED_MODULE_35__.BrowserProvider(window.ethereum);
        }
    });
    container.bind("contracts").toConstantValue(async () => {
        let contract;
        let contractABI;
        let contractResponse = await axios__WEBPACK_IMPORTED_MODULE_36__["default"].get(`${globalThis.hostname}${globalThis.baseURI}backup/contract/contract.json`, { responseType: 'json' });
        let contractABIResponse = await axios__WEBPACK_IMPORTED_MODULE_36__["default"].get(`${globalThis.hostname}${globalThis.baseURI}backup/contract/contract-abi.json`, { responseType: 'json' });
    ...
    container.bind("WalletService").to(_service_core_wallet_service_impl_js__WEBPACK_IMPORTED_MODULE_37__.WalletServiceImpl).inSingletonScope();
    container.bind("ChannelRepository").to(_repository_browser_channel_repository_impl_js__WEBPACK_IMPORTED_MODULE_38__.ChannelRepositoryBrowserImpl).inSingletonScope();
    container.bind("ItemRepository").to(_repository_browser_item_repository_impl_js__WEBPACK_IMPORTED_MODULE_39__.ItemRepositoryBrowserImpl).inSingletonScope();
    container.bind("AuthorRepository").to(_repository_browser_author_repository_impl_js__WEBPACK_IMPORTED_MODULE_40__.AuthorRepositoryBrowserImpl).inSingletonScope();
    container.bind("MetadataRepository").to(_repository_browser_metadata_repository_impl_js__WEBPACK_IMPORTED_MODULE_41__.MetadataRepositoryBrowserImpl).inSingletonScope();
    container.bind("ImageRepository").to(_repository_browser_image_repository_impl_js__WEBPACK_IMPORTED_MODULE_42__.ImageRepositoryBrowserImpl).inSingletonScope();
    container.bind("AnimationRepository").to(_repository_browser_animation_repository_impl_js__WEBPACK_IMPORTED_MODULE_43__.AnimationRepositoryBrowserImpl).inSingletonScope();
    container.bind("StaticPageRepository").to(_repository_browser_static_page_repository_impl_js__WEBPACK_IMPORTED_MODULE_44__.StaticPageRepositoryBrowserImpl).inSingletonScope();
    container.bind("ItemPageRepository").to(_repository_browser_item_page_repository_impl_js__WEBPACK_IMPORTED_MODULE_45__.ItemPageRepositoryBrowserImpl).inSingletonScope();
    container.bind("TokenOwnerPageRepository").to(_repository_browser_token_owner_page_repository_impl_js__WEBPACK_IMPORTED_MODULE_46__.TokenOwnerPageRepositoryBrowserImpl).inSingletonScope();
    container.bind("AttributeTotalRepository").to(_repository_browser_attribute_total_repository_impl_js__WEBPACK_IMPORTED_MODULE_47__.AttributeTotalRepositoryBrowserImpl).inSingletonScope();
    container.bind("ReaderSettingsRepository").to(_repository_browser_reader_settings_repository_impl_js__WEBPACK_IMPORTED_MODULE_48__.ReaderSettingsRepositoryBrowserImpl).inSingletonScope();
    //@ts-ignore
    ...
    container.bind("TokenRepository").to(_repository_browser_token_repository_impl_js__WEBPACK_IMPORTED_MODULE_51__.TokenRepositoryBrowserImpl).inSingletonScope();
    ...
    container.bind("RowItemViewModelRepository").to(_repository_browser_row_item_view_model_repository_impl_js__WEBPACK_IMPORTED_MODULE_53__.RowItemViewModelRepositoryBrowserImpl).inSingletonScope();
    container.bind("ChannelWebService").to(_service_web_channel_web_service_js__WEBPACK_IMPORTED_MODULE_54__.ChannelWebService).inSingletonScope();
    container.bind("ItemWebService").to(_service_web_item_web_service_js__WEBPACK_IMPORTED_MODULE_55__.ItemWebService).inSingletonScope();
    container.bind("AuthorWebService").to(_service_web_author_web_service_js__WEBPACK_IMPORTED_MODULE_56__.AuthorWebService).inSingletonScope();
    container.bind("MintWebService").to(_service_web_mint_web_service_js__WEBPACK_IMPORTED_MODULE_57__.MintWebService).inSingletonScope();
    container.bind("SearchbarService").to(_service_web_searchbar_service_js__WEBPACK_IMPORTED_MODULE_58__.SearchbarService).inSingletonScope();
    ...
    globalThis.ethers = ethers__WEBPACK_IMPORTED_MODULE_82__;
    globalThis.he = (he__WEBPACK_IMPORTED_MODULE_22___default());
    globalThis.dayjs = (dayjs__WEBPACK_IMPORTED_MODULE_0___default());
        ...
        if (this.walletService.provider && this.walletService.provider.listeners()?.length == 0) {
            let filter = {
                ...
                topics: [
                    ...
                    ethers__WEBPACK_IMPORTED_MODULE_0__.id("MintEvent(uint256)")
                ]
            };
...
/* harmony import */ var inversify__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! inversify */ "./node_modules/inversify/es/annotation/injectable.js");
/* harmony import */ var _channel_service_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../channel-service.js */ "./src/reader/service/channel-service.ts");
/* harmony import */ var _core_schema_service_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../core/schema-service.js */ "./src/reader/service/core/schema-service.ts");
/* harmony import */ var _item_service_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../item-service.js */ "./src/reader/service/item-service.ts");
/* harmony import */ var _token_contract_service_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../token-contract-service.js */ "./src/reader/service/token-contract-service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
__decorate([
    (0,inversify__WEBPACK_IMPORTED_MODULE_0__.inject)("TokenContractService"),
    __metadata("design:type", _token_contract_service_js__WEBPACK_IMPORTED_MODULE_1__.TokenContractService)
], MintWebService.prototype, "tokenContractService", void 0);
__decorate([
    (0,inversify__WEBPACK_IMPORTED_MODULE_0__.inject)("ChannelService"),
    __metadata("design:type", _channel_service_js__WEBPACK_IMPORTED_MODULE_2__.ChannelService)
...
__decorate([
    ...
    __metadata("design:type", _core_schema_service_js__WEBPACK_IMPORTED_MODULE_4__.SchemaService)
...
/***/ "./src/reader/service/web/searchbar-service.ts":
/*!*****************************************************!*\
  !*** ./src/reader/service/web/searchbar-service.ts ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var inversify__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! inversify */ "./node_modules/inversify/es/annotation/inject.js");
/* harmony import */ var inversify__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! inversify */ "./node_modules/inversify/es/annotation/injectable.js");
/* harmony import */ var _item_web_service_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./item-web-service.js */ "./src/reader/service/web/item-web-service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
__decorate([
    (0,inversify__WEBPACK_IMPORTED_MODULE_0__.inject)("ItemWebService"),
    __metadata("design:type", _item_web_service_js__WEBPACK_IMPORTED_MODULE_1__.ItemWebService)
], SearchbarService.prototype, "itemWebService", void 0);
...
/******/ __webpack_require__.O(0, ["vendors"], () => (__webpack_exec__("./src/library/index.ts")));
