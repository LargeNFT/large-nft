...
(0,workbox_routing__WEBPACK_IMPORTED_MODULE_0__.registerRoute)(({ url }) => new RegExp(`/r/.*/sync.*`).test(url.pathname), new workbox_strategies__WEBPACK_IMPORTED_MODULE_1__.NetworkFirst());
(0,workbox_routing__WEBPACK_IMPORTED_MODULE_0__.registerRoute)(/\.(?:js.*|css.*|webmanifest|eot|ttf|woff|woff2)$/, new workbox_strategies__WEBPACK_IMPORTED_MODULE_1__.CacheFirst({ cacheName: 'static-resources' }));
//Backup doesn't change
(0,workbox_routing__WEBPACK_IMPORTED_MODULE_0__.registerRoute)(({ url }) => new RegExp(`/r/.*/backup.*`).test(url.pathname), new workbox_strategies__WEBPACK_IMPORTED_MODULE_1__.CacheFirst());
//HTML and Large should serve stale but revalidate for next request
(0,workbox_routing__WEBPACK_IMPORTED_MODULE_0__.registerRoute)(({ event }) => event.request.destination === 'image', new workbox_strategies__WEBPACK_IMPORTED_MODULE_1__.StaleWhileRevalidate());
(0,workbox_routing__WEBPACK_IMPORTED_MODULE_0__.registerRoute)(({ event }) => event.request.destination === 'document', new workbox_strategies__WEBPACK_IMPORTED_MODULE_1__.StaleWhileRevalidate());
(0,workbox_routing__WEBPACK_IMPORTED_MODULE_0__.registerRoute)(({ url }) => url.pathname.endsWith(`.html`), new workbox_strategies__WEBPACK_IMPORTED_MODULE_1__.StaleWhileRevalidate());
(0,workbox_routing__WEBPACK_IMPORTED_MODULE_0__.registerRoute)(({ url }) => new RegExp(`/r/.*/t/.*`).test(url.pathname), new workbox_strategies__WEBPACK_IMPORTED_MODULE_1__.StaleWhileRevalidate());
(0,workbox_routing__WEBPACK_IMPORTED_MODULE_0__.registerRoute)(({ url }) => new RegExp(`/r/.*/s/.*`).test(url.pathname), new workbox_strategies__WEBPACK_IMPORTED_MODULE_1__.StaleWhileRevalidate());

})();

/******/ })()
;
//# sourceMappingURL=sw-library-0.18.6.js.map