  ...
  <div class="page" data-name="admin-show-collection">
    ...
    <div class="page-content infinite-scroll-content hide-toolbar-on-scroll" id="item-list-infinite-scroll">
      ...
      <div class="fixed-width-content center">
        ...
        <${Sa} channel=${r.channel._id} token_id="1" />
...
`}}$a.id="c1c41fa611",$a.style="\n  \n\n";const ka=$a;function Ia(e,{$:t,$on:i,$f7:a,$update:n}){let s=e.theme,o=e.cover_image_css_editor_id,f=e.animation_css_editor_id;return function(e){e.$;var t=e.$h;e.$root,e.$f7,e.$f7route,e.$f7router,e.$theme,e.$update,e.$store;return t`
...
`}}Aa.id="491a3b92c8",Aa.style="\n";const Fa=Aa;function Oa(e,{$:t,$on:i,$f7:a,$update:s}){let o,f=[{text:"Home",path:"/"},{text:"Create & Import"}];return i("pageInit",(async()=>{o=n.getWalletService(),await s()})),function(e){e.$;var t=e.$h;e.$root,e.$f7,e.$f7route,e.$f7router,e.$theme,e.$update,e.$store;return t`
...
`}}Cn.id="ce41305b4c",Cn.style="\n  #create-item-editor {\n    min-height: 175px;\n    height: 100%;\n    /* added these styles */\n    flex: 1;\n    display: flex;\n    flex-direction: column;\n  }\n";const jn=Cn;function Tn(e,{$:t,$on:i,$f7:a,$update:s}){n.getInstance(ci);let o=n.getInstance(l),f=n.getInstance(Mi),r=e.itemViewModel,c=(r.editable,[{text:"Home",path:"/"},{text:r.channel.title,path:`/admin/channel/show/${r.channel._id}`},{text:r.item.title?r.item.title:`#${r.item.tokenId}`}]);i("pageInit",(async(e,i)=>{t(`#item-content-${r.item._id} a`).addClass("external"),await s()}));const d=async e=>{try{a.dialog.confirm("Do you want to delete this item? Note: This only deletes from your device.",(async function(){await f.delete(r.item);a.toast.show({text:"Item deleted",closeTimeout:2e3,closeButton:!0,position:"bottom",horizontalPosition:"left"});a.views.main.router.navigate(`/admin/channel/show/${r.channel._id}`)}))}catch(e){o.showExceptionPopup(e)}},p=async e=>{let t=await f.clone(r.item);a.views.main.router.navigate(`/admin/channel/${r.channel._id}/item/edit/${t._id}`)};return function(e){e.$;var t=e.$h;e.$root,e.$f7,e.$f7route,e.$f7router,e.$theme,e.$update,e.$store;return t`
    ...
    <div class="page-content hide-toolbar-on-scroll">
      ...
      <div class="item-show">
        ...
        <div class="right">
          ...
          <${Sa} channel=${r.channel._id} item=${r} />
...
`}}Wn([na("/admin/settings"),Zn("design:type",Function),Zn("design:paramtypes",[]),Zn("design:returntype",Promise)],Vn.prototype,"show",null),Vn=Wn([(0,s.b)(),Zn("design:paramtypes",[Ft])],Vn),Yn.id="78130233e3";const Kn=Yn;var Qn=function(e,t,i,a){var n,s=arguments.length,o=s<3?t:null===a?a=Object.getOwnPropertyDescriptor(t,i):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,i,a);else for(var f=e.length-1;f>=0;f--)(n=e[f])&&(o=(s<3?n(o):s>3?n(t,i,o):n(t,i))||o);return s>3&&o&&Object.defineProperty(t,i,o),o},Xn=function(e,t){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(e,t)};let es=class{ipfsService;constructor(e){this.ipfsService=e}async show(){return new aa((async e=>{if(!this.ipfsService.ipfs)return{};let t=await this.ipfsService.ipfs.swarm.peers(),i=await this.ipfsService.ipfs.id();return{peers:t.map((e=>e.addr.toString())),peerCount:t.length,addresses:i?.addresses?.map((e=>e.toString()))}}),Kn)}};function ts(e,{$:t,$h:i,$on:a,$f7:s,$update:o}){let f,r=e.channelViewModel,c=[{text:"Home",path:"/"},{text:r.channel.title,path:`/admin/channel/show/${r.channel._id}`},{text:"Publish"}];return a("pageInit",(async(e,t)=>{f=n.getWalletService(),await o()})),function(e){e.$;var t=e.$h;e.$root,e.$f7,e.$f7route,e.$f7router,e.$theme,e.$update,e.$store;return t`
                                ...
                                ${l.channel.publishReaderIPFSStatus?.status?t`
                                    ...
                                    <div class="pin-status"> 
                                        ...
                                        ${"complete"==l.channel.publishReaderIPFSStatus?.status&&l.channel.publishReaderIPFSStatus?.cid?t`
                                            ...
                                            <strong>Date:</strong> ${oa()(l.channel.publishReaderIPFSStatus?.date).format("MMMM Do YYYY, h:mm:ss a")}
                                        `:t` `}
