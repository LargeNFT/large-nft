...
`}}Y.id="1e8ee7e455";const ee=Y,te=(e,{$h:t})=>{globalThis.container.get("WalletService");let a=globalThis.container.get("TransactionWebService");const n=e=>`${o+e}`;let i=e.transaction,r=e.event,o=e.base_uri,s=e.row_item_view_models,c=e.index;return()=>t`
...
`}}de.id="fa198e7325";const pe=de;function ue(e,{$:t,$on:a,$f7:n,$update:i}){let r=globalThis.container.get("ItemWebService"),o=globalThis.container.get("baseURI")();const s=e=>o+e;let c,l=!1;const d=async e=>{e.preventDefault(),t(".searchbar input").blur(),n.preloader.showIn(".cards-list"),l=!0,i(),c=await r.query(t(".searchbar input").val()),l=!1,i(),n.preloader.hideIn(".cards-list")};return function(e){e.$;var t=e.$h;e.$root,e.$f7,e.$f7route,e.$f7router,e.$theme,e.$update,e.$store;return t`
