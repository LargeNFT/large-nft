...
`}}Aa.id="e60df30425",Aa.style="\n";const Oa=Aa;function Fa(e,{$:t,$on:i,$f7:a,$update:s}){let o,r=[{text:"Home",path:"/"},{text:"Create & Import"}];return i("pageInit",(async()=>{o=n.getWalletService(),await s()})),function(e){e.$;var t=e.$h;e.$root,e.$f7,e.$f7route,e.$f7router,e.$theme,e.$update,e.$store;return t`
...
`}}On.id="65d04ec7b7",On.style="\n  #edit-item-editor {\n    min-height: 175px;\n    height: 100%;\n    /* added these styles */\n    flex: 1;\n    display: flex;\n    flex-direction: column;\n  }\n";const Fn=On;var En=function(e,t,i,a){var n,s=arguments.length,o=s<3?t:null===a?a=Object.getOwnPropertyDescriptor(t,i):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,i,a);else for(var r=e.length-1;r>=0;r--)(n=e[r])&&(o=(s<3?n(o):s>3?n(t,i,o):n(t,i))||o);return s>3&&o&&Object.defineProperty(t,i,o),o},Dn=function(e,t){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(e,t)};let Bn=class{itemWebService;themeService;schemaService;constructor(e,t,i){this.itemWebService=e,this.themeService=t,this.schemaService=i}async create(){return new aa((async e=>{await this.schemaService.loadChannel(e.params.channelId);let t=await this.itemWebService.getNewViewModel(e.params.channelId);return{itemViewModel:t,themes:await this.themeService.listByChannel(t.channel._id,1e3,0)}}),jn)}async show(){return new aa((async e=>(await this.schemaService.loadChannel(e.params.channelId),{itemViewModel:await this.itemWebService.getNavigation(e.params.channelId,parseInt(e.params.tokenId))})),An)}async edit(){return new aa((async e=>{await this.schemaService.loadChannel(e.params.channelId);let t=await this.itemWebService.get(e.params.id);return{itemViewModel:t,themes:await this.themeService.listByChannel(t.channel._id,1e3,0)}}),Fn)}};function Mn(e,{$:t,$on:i,$f7:a,$update:n}){let s=e.authorViewModel,o=[{text:"Home",path:"/"},{text:"Author Profile"}];return function(t){t.$;var i=t.$h;t.$root,t.$f7,t.$f7route,t.$f7router,t.$theme,t.$update,t.$store;return i`
                                ...
                                ${f.channel.publishReaderIPFSStatus?.status?t`
                                    ...
                                    <div class="pin-status"> 
                                        ...
                                        ${"complete"==f.channel.publishReaderIPFSStatus?.status&&f.channel.publishReaderIPFSStatus?.cid?t`
                                            ...
                                            <strong>Date:</strong> ${oa()(f.channel.publishReaderIPFSStatus?.date).format("MMMM Do YYYY, h:mm:ss a")}
                                        `:t` `}
...
`}}ss.id="6b340918a1",ss.style="\n  .publish-label,\n  .ipfs-label,\n  .forking-label {\n    margin-top: 10px;\n    margin-bottom: 10px;\n    font-weight: bold;\n    font-size: 18px;\n  }\n\n  .publish-output {\n    border: 1px solid #cccccc;\n    font-size: 13px;\n    width: 100%;\n    max-width: 100%;\n    padding: 5px;\n    height: 300px;\n    overflow-y: scroll;\n  }\n\n  #fork-next-button {\n    width: 200px;\n  }\n";const os=ss;var rs=i(76551),cs=i.n(rs),ls=i(26470),fs=i.n(ls),ds=i(26015),ps=i(48764).Buffer,us=function(e,t,i,a){var n,s=arguments.length,o=s<3?t:null===a?a=Object.getOwnPropertyDescriptor(t,i):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,i,a);else for(var r=e.length-1;r>=0;r--)(n=e[r])&&(o=(s<3?n(o):s>3?n(t,i,o):n(t,i))||o);return s>3&&o&&Object.defineProperty(t,i,o),o},hs=function(e,t){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(e,t)},gs=function(e,t){return function(i,a){t(i,a,e)}};let ms=class{channelService;itemService;ipfsService;imageService;animationService;exportService;settingsService;walletService;constructor(e,t,i,a,n,s,o,r){this.channelService=e,this.itemService=t,this.ipfsService=i,this.imageService=a,this.animationService=n,this.exportService=s,this.settingsService=o,this.walletService=r}async publish(e,t){this.logPublishProgress(void 0,"Preparing export...");let i=await this.exportService.prepareExport(e,this.walletService.address),a=await this.getFeeReceipient(i.channel,i.ownerAddress);a&&this.logPublishProgress(void 0,`Fee Recipient: ${a}`),this.logPublishProgress(void 0,"Preparing backup...");let n,s=await this.exportService.createBackup(i);return e.contractAddress?e.publishReaderIPFSStatus?.cid&&(n={cid:e.publishReaderIPFSStatus.cid,imageDirectoryCid:e.publishReaderIPFSStatus.imageDirectoryCid,animationDirectoryCid:e.publishReaderIPFSStatus.animationDirectoryCid}):(this.logPublishProgress(void 0,"Exporting to IPFS..."),n=await this.exportToIPFS(i,s,a)),this.logPublishProgress(void 0,"Exporting to file system..."),await this.exportToFS(t,e,i,s,a,n),{cids:n}}async exportToIPFS(e,t,i){let a=!0,n=this.getIPFSDirectory(e.channel);try{await this.ipfsService.ipfs.files.read(n),await this.ipfsService.ipfs.files.rm(n,{recursive:!0,flush:!0})}catch(e){}let s={contractMetadata:{saved:0,total:1},nftMetadata:{saved:0,total:e.items.length},images:{saved:0,total:e.imageCids.length},animations:{saved:0,total:e.animationCids.length},backups:{channels:{saved:0,total:1},authors:{saved:0,total:1},items:{saved:0,total:t.itemCount},images:{saved:0,total:e.imageCids.length},animations:{saved:0,total:e.animationCids.length},themes:{saved:0,total:t.themeCount},staticPages:{saved:0,total:t.staticPageCount}}};this.logPublishProgress(s),await this._publishImagesIPFS(s,n,e.imageCids,!0),await this._publishAnimationsIPFS(s,n,e.animationCids,!0);let o=await this.getImageDirectoryCid(n),r=await this.getAnimationDirectoryCid(n);await this._publishNFTMetadataIPFS(s,n,e.channel,e.items,r,o,!0);let c=`${n}/contractMetadata.json`,l=await this.channelService.exportContractMetadata(e.channel,i,o);await this.ipfsService.ipfs.files.write(c,(new TextEncoder).encode(JSON.stringify(l)),{create:!0,parents:!0,flush:a});let f=await this.ipfsService.ipfs.files.stat(c);s.contractMetadata.saved=1,this.logPublishProgress(s,`Saving contract metadata to ${c} (${f.cid})`),await this.ipfsService.ipfs.files.write(`${n}/backup/channels.json`,(new TextEncoder).encode(JSON.stringify(t.channels)),{create:!0,parents:!0,flush:a}),s.backups.channels.saved=1,this.logPublishProgress(s),await this.ipfsService.ipfs.files.write(`${n}/backup/authors.json`,(new TextEncoder).encode(JSON.stringify(t.authors)),{create:!0,parents:!0,flush:a}),s.backups.authors.saved=1,this.logPublishProgress(s),await this.ipfsService.ipfs.files.write(`${n}/backup/items.json`,(new TextEncoder).encode(JSON.stringify(t.items)),{create:!0,parents:!0,flush:a}),s.backups.items.saved=t.itemCount,this.logPublishProgress(s),await this.ipfsService.ipfs.files.write(`${n}/backup/originalMetadata.json`,(new TextEncoder).encode(JSON.stringify(t.originalMetadata)),{create:!0,parents:!0,flush:a}),await this.ipfsService.ipfs.files.write(`${n}/backup/images.json`,(new TextEncoder).encode(JSON.stringify(t.images)),{create:!0,parents:!0,flush:a}),s.backups.images.saved=t.imageCount,this.logPublishProgress(s),await this.ipfsService.ipfs.files.write(`${n}/backup/animations.json`,(new TextEncoder).encode(JSON.stringify(t.animations)),{create:!0,parents:!0,flush:a}),s.backups.animations.saved=t.animationCount,this.logPublishProgress(s),await this.ipfsService.ipfs.files.write(`${n}/backup/themes.json`,(new TextEncoder).encode(JSON.stringify(t.themes)),{create:!0,parents:!0,flush:a}),s.backups.themes.saved=t.themeCount,this.logPublishProgress(s),await this.ipfsService.ipfs.files.write(`${n}/backup/static-pages.json`,(new TextEncoder).encode(JSON.stringify(t.staticPages)),{create:!0,parents:!0,flush:a}),s.backups.staticPages.saved=t.staticPageCount,this.logPublishProgress(s),this.logPublishProgress(s,"Flushing to IPFS..."),await this.ipfsService.ipfs.files.flush(`/export/${e.channel._id}/`);let d=await this.ipfsService.ipfs.files.stat(`/export/${e.channel._id}/`,{hash:!0});return this.logPublishProgress(s,`Published to local IPFS at ${d.cid.toString()}`),{cid:d.cid.toString(),imageDirectoryCid:o.toString(),animationDirectoryCid:r.toString()}}async exportToFS(e,t,i,a,n,s){await this._publishImagesFS(e,i.imageCids),await this._publishAnimationsFS(e,i.animationCids),await this._publishNFTMetadataFS(e,i.channel,i.items,s?.animationDirectoryCid,s?.imageDirectoryCid);let o=await this.channelService.exportContractMetadata(i.channel,n,s?.imageDirectoryCid);await this._writeFSAction({file_path:`${e}/backup/export/contractMetadata.json`,content:ps.from(JSON.stringify(o))}),t.contractAddress?(await this._writeFSAction({file_path:`${e}/backup/contract/contract.json`,content:ps.from(JSON.stringify({contractAddress:t.contractAddress,ipfsCid:t.publishReaderIPFSStatus?.cid}))}),await this._writeFSAction({file_path:`${e}/backup/contract/contract-abi.json`,content:ps.from(JSON.stringify(ds))})):(await this._writeFSAction({file_path:`${e}/backup/contract/contract.json`,content:ps.from(JSON.stringify({}))}),await this._writeFSAction({file_path:`${e}/backup/contract/contract-abi.json`,content:ps.from(JSON.stringify({}))}));let r=await(async e=>{let t,i=await this.settingsService.get();switch(t=e.gitProvider&&"default"!=e.gitProvider?e.gitProvider:i.defaultGitProvider?i.defaultGitProvider:"github",t){case"gitlab":if(!e.httpUrlToRepo)return;return{hostname:`https://${a=e.httpUrlToRepo,a.replace("https://gitlab.com/","").split("/")[0]}.gitlab.io`,baseURI:`/${e.title.replace(/[^a-z0-9]/gi,"-").toLowerCase()}/`};case"github":function n(e){return e.replace("https://github.com/","").split("/")[0]}if(!e.httpUrlToRepo)return;return{hostname:`https://${n(e.httpUrlToRepo)}.github.io`,baseURI:`/${e.title.replace(/[^a-z0-9]/gi,"-").toLowerCase()}/`}}var a})(t);await this._writeFSAction({file_path:`${e}/large-config.json`,content:ps.from(JSON.stringify({showMintPage:t.showMintPage,showActivityPage:t.showActivityPage,hostname:t.productionHostname?t.productionHostname:r?.hostname,libraryURL:t.productionBaseLibraryURI,baseURL:t.productionBaseURI?t.productionBaseURI:r?.baseURI,externalLinks:t.externalLinks,marketplaces:t.marketplaces}))}),await this._writeFSAction({file_path:`${e}/backup/export/backup/channels.json`,content:ps.from(JSON.stringify(a.channels))}),await this._writeFSAction({file_path:`${e}/backup/export/backup/authors.json`,content:ps.from(JSON.stringify(a.authors))}),await this._writeFSAction({file_path:`${e}/backup/export/backup/items.json`,content:ps.from(JSON.stringify(a.items))}),await this._writeFSAction({file_path:`${e}/backup/export/backup/originalMetadata.json`,content:ps.from(JSON.stringify(a.originalMetadata))}),await this._writeFSAction({file_path:`${e}/backup/export/backup/images.json`,content:ps.from(JSON.stringify(a.images))}),await this._writeFSAction({file_path:`${e}/backup/export/backup/animations.json`,content:ps.from(JSON.stringify(a.animations))}),await this._writeFSAction({file_path:`${e}/backup/export/backup/themes.json`,content:ps.from(JSON.stringify(a.themes))}),await this._writeFSAction({file_path:`${e}/backup/export/backup/static-pages.json`,content:ps.from(JSON.stringify(a.staticPages))})}getIPFSDirectory(e){return`/export/${e._id}`}async getAnimationDirectoryCid(e){let t;try{t=(await this.ipfsService.ipfs.files.stat(`${e}/animations/`,{hash:!0})).cid.toString()}catch(e){}return t}async getImageDirectoryCid(e){let t;try{t=(await this.ipfsService.ipfs.files.stat(`${e}/images/`,{hash:!0})).cid.toString()}catch(e){}return t}async getFeeReceipient(e,t){let i;return"existing"==e.forkType?e.forkedFromFeeRecipient&&(i=e.forkedFromFeeRecipient):i=t,i}async _publishAnimationsIPFS(e,t,i,a){this.logPublishProgress(e,`Exporting ${i.length} animations`);for(let n of i){let i,s=await this.animationService.get(n),o=`${t}/animations/${s.cid}.html`,r={content:s.content};try{i=await this.ipfsService.ipfs.files.stat(o,{hash:!0})}catch(e){}if(i?.cid.toString())this.logPublishProgress(e,`${o} already exists. Skipping...`);else{const i=await this.ipfsService.ipfs.add(r);if(await this.ipfsService.ipfs.files.cp(`/ipfs/${i.cid.toString()}`,o,{parents:!0,flush:a}),i.cid.toString()!==s.cid.toString())throw new Error(`Incorrect cid when saving animation. Expected: ${s.cid}, Result: ${i.cid.toString()}`);this.logPublishProgress(e,`Saving animation #${e.animations.saved} to ${t}/animations/${s.cid}.html (${s.cid})`)}e.animations.saved++}}async _publishAnimationsFS(e,t){for(let i of t){let t=await this.animationService.get(i),a={content:t.content};await this._writeFSAction({file_path:`${e}/backup/export/animations/${t.cid}.html`,content:ps.from(a.content)})}}async _publishImagesIPFS(e,t,i,a){for(let n of i){let i,s=await this.imageService.get(n),o=`${t}/images/${s.cid}.${s.buffer?"jpg":"svg"}`;try{i=await this.ipfsService.ipfs.files.stat(o,{hash:!0})}catch(e){}if(i?.cid.toString())this.logPublishProgress(e,`${o} already exists. Skipping...`);else{const t=await this.ipfsService.ipfs.add({content:await this.imageService.getImageContent(s)});if(await this.ipfsService.ipfs.files.cp(`/ipfs/${t.cid.toString()}`,o,{create:!0,parents:!0,flush:a}),t.cid.toString()!=s.cid)throw new Error(`Incorrect cid when saving image. Expected: ${s.cid}, Result: ${t.cid.toString()}`);this.logPublishProgress(e,`Saving image to ${o} (${s.cid})`)}e.images.saved++}}async _publishImagesFS(e,t){for(let i of t){let t=await this.imageService.get(i),a=await this.imageService.getImageContent(t);await this._writeFSAction({file_path:`${e}/backup/export/images/${t.cid}.${t.buffer?"jpg":"svg"}`,content:a})}}async _publishNFTMetadataIPFS(e,t,i,a,n,s,o){this.logPublishProgress(e,`Exporting ${a.length} metadata files`);let r={};for(let c of a){let a,l=this.exportService.prepareItem(c),f=`${t}/metadata/${l.tokenId}.json`,d=await this.imageService.get(l.coverImageId),p=await this.itemService.exportNFTMetadata(i,l,d,n,s),u=(new TextEncoder).encode(JSON.stringify(p)),h=await vt.of(u);r[h]=p;try{a=await this.ipfsService.ipfs.files.stat(f,{hash:!0})}catch(e){}if(a?.cid.toString()!=h){const e=await this.ipfsService.ipfs.add({content:u});await this.ipfsService.ipfs.files.cp(`/ipfs/${e.cid.toString()}`,f,{create:!0,parents:!0,flush:o})}else this.logPublishProgress(e,`${f} already exists. Skipping...`);e.nftMetadata.saved++,this.logPublishProgress(e,`Saving #${l.tokenId} to ${f}`)}return[]}async _publishNFTMetadataFS(e,t,i,a,n){for(let s of i){let i=this.exportService.prepareItem(s),o=await this.imageService.get(i.coverImageId),r=await this.itemService.exportNFTMetadata(t,i,o,a,n);await this._writeFSAction({file_path:`${e}/backup/export/metadata/${i.tokenId}.json`,content:ps.from(JSON.stringify(r))})}}_writeFSAction(e){cs().existsSync(fs().dirname(e.file_path))||cs().mkdirSync(fs().dirname(e.file_path),{recursive:!0}),e.keepExisting&&cs().existsSync(e.file_path)||(console.log(`Writing file: ${e.file_path}`),cs().writeFileSync(e.file_path,e.content))}logPublishProgress(e,t){if(t&&console.log(t),"undefined"!=typeof window&&void 0!==window.document){const i=new CustomEvent("publish-progress",{detail:{publishStatus:e,message:t}});document.dispatchEvent(i)}}};function vs(e,{$:t,$h:i,$on:a,$f7:s,$update:o}){let r,c=n.getInstance(gi),l=n.getInstance(yi),f=(n.getInstance(Ze),n.getInstance(Qi),n.getInstance(xn)),d=(n.getInstance(ms),null!=l.ipfs),p=l.peerCount,u=e.channelViewModel,h=e.settings,g=!1,m="",v=u.channel.publishReaderRepoId>0&&"complete"==u.channel.publishReaderRepoStatus,b=null!=u.channel.localCid,y=u.itemCount>0,w=u?.gitProvider?.personalAccessToken?.length>0,S=h?.gitCorsProxy?.length>0,$=y&&w&&S,k=u.channel.httpUrlToRepo,I=[{text:"Home",path:"/"},{text:u.channel.title,path:`/admin/channel/show/${u.channel._id}`},{text:"Publish",path:`/admin/publish/${u.channel._id}`},{text:"Publish Collection To Reader"}];a("pageInit",(async()=>{await l.init(),d=null!=l.ipfs,r=await c.getGitProviderCredentials(u.channel,h),await o()}));const R=async e=>{e.preventDefault(),g=!0,await o();let t=document.getElementsByClassName("ipfs-label")[0];s.preloader.showIn(t);try{let e=`/export/${u.channel._id}`,t=await(0,Da.Z)(l.ipfs.files.read(`${e}/contractMetadata.json`));await f.deployReaderGit(u.channel,t)}catch(e){console.log(e),s.dialog.alert(e,"There was an error")}s.preloader.hideIn(t),g=!1,await o()},x=async e=>{e.preventDefault();let t=document.getElementsByClassName("ipfs-label")[0];s.preloader.showIn(t);try{await f.clearGitRepos()}catch(e){s.dialog.alert(e,"There was an error")}s.preloader.hideIn(t),await o()};return t(document).on("publish-reader-progress",(async e=>{m=`<p>${e.detail.message}</p>`,o()})),t(document).on("update-peers",(async e=>{p=e.detail.count,o()})),function(e){e.$;var t=e.$h;e.$root,e.$f7,e.$f7route,e.$f7router,e.$theme,e.$update,e.$store;return t`
  ...
  `}}ms=us([(0,s.b)(),gs(7,(0,o.f)(a.WalletService)),hs("design:paramtypes",[gi,li,yi,Pt,xi,Ai,Ot,Object])],ms),vs.id="d43c8385e5",vs.style="\n\n    .publish-label, .ipfs-label, .forking-label {\n      margin-top: 10px;\n      margin-bottom: 10px;\n      font-weight: bold;\n      font-size: 18px;\n    }\n\n    .publish-output {\n      border: 1px solid #cccccc;\n      font-size: 13px;\n      width: 100%;\n      max-width: 100%;\n      padding: 5px;\n      height: 300px;\n      overflow-y : scroll;\n    }\n  ";const bs=vs;var ys=i(41972),ws=function(e,t,i,a){var n,s=arguments.length,o=s<3?t:null===a?a=Object.getOwnPropertyDescriptor(t,i):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,i,a);else for(var r=e.length-1;r>=0;r--)(n=e[r])&&(o=(s<3?n(o):s>3?n(t,i,o):n(t,i))||o);return s>3&&o&&Object.defineProperty(t,i,o),o},Ss=function(e,t){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(e,t)},$s=function(e,t){return function(i,a){t(i,a,e)}};let ks=class{channelService;walletService;contracts;constructor(e,t,i){this.channelService=e,this.walletService=t,this.contracts=i}async deployContract(e){if(!e.publishReaderIPFSStatus?.cid)throw new Error("Not published to IPFS");let t=await this.channelService.countItemsByChannel(e._id);if(t<=0)throw new Error("No NFTs");let i=ha.vz(e.mintPrice,"ether"),a=await this.deploy(e.title,e.symbol,e.publishReaderIPFSStatus?.cid,i.toString(),t);e.contractAddress=a.contractAddress,e.showActivityPage=!0,e.showMintPage=!0,await this.channelService.put(e)}async deploy(e,t,i,a,n){if(!(e&&t&&a&&n&&i))throw new Error("Missing inputs to deploy");let s=this.walletService.wallet;if(!s)throw new Error("No wallet!");const o=this.contracts.Channel,r=new ys.l(o.abi,o.bytecode,s);return(await r.deploy(e,t,i,BigInt(a.toString()),BigInt(n.toString()))).deploymentTransaction().wait()}};function Is(e,{$:t,$h:i,$on:a,$f7:s,$update:o}){let r,c=n.getInstance(gi),l=(n.getInstance(yi),n.getInstance(Ze)),f=(n.getInstance(Qi),n.getInstance(ks)),d=e.channelViewModel,p=!1,u=null!=d.channel.publishReaderIPFSStatus?.cid||d.channel.contractAddress,h=[{text:"Home",path:"/"},{text:d.channel.title,path:`/admin/channel/show/${d.channel._id}`},{text:"Publish",path:`/admin/publish/${d.channel._id}`},{text:"Deploy Contract"}];a("pageInit",(async(e,t)=>{r=n.getWalletService(),await o()}));const g=async e=>{p=!0,await o();let t={title:`Deploying contract ${name}. Approve transaction and wait for it to be mined.`,promise:f.deployContract(d.channel)};await l.queuePromiseView(t),p=!1,await o()},m=async e=>{d.channel.contractAddress=void 0,await c.put(d.channel),d.channel=await c.get(d.channel._id),o()};return function(e){e.$;var t=e.$h;e.$root,e.$f7,e.$f7route,e.$f7router,e.$theme,e.$update,e.$store;return t`
                  ...
                  <div class="card-content card-content-padding">
                    ...
                    ${u?t`
                      ...
                      <div class="pin-status">
                        ...
                        <p><strong>Date Exported:</strong> ${oa()(d.channel.publishReaderIPFSStatus?.date).format("MMMM Do YYYY, h:mm:ss a")}</p>
                      </div>
  ...
  `}}ks=ws([(0,s.b)(),$s(1,(0,o.f)(a.WalletService)),$s(2,(0,o.f)("contracts")),Ss("design:paramtypes",[gi,Object,Object])],ks),Is.id="c678f67e0f",Is.style="\n\n  ";const Rs=Is;var xs=function(e,t,i,a){var n,s=arguments.length,o=s<3?t:null===a?a=Object.getOwnPropertyDescriptor(t,i):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,i,a);else for(var r=e.length-1;r>=0;r--)(n=e[r])&&(o=(s<3?n(o):s>3?n(t,i,o):n(t,i))||o);return s>3&&o&&Object.defineProperty(t,i,o),o},_s=function(e,t){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(e,t)};let Ps=class{channelWebService;settingsService;schemaService;gitlabService;constructor(e,t,i,a){this.channelWebService=e,this.settingsService=t,this.schemaService=i,this.gitlabService=a}async publish(){return new aa((async e=>(await this.schemaService.loadChannel(e.params.id),{channelViewModel:await this.channelWebService.get(e.params.id)})),is)}async export(){return new aa((async e=>{await this.schemaService.loadChannel(e.params.id);let t,i=await this.channelWebService.get(e.params.id);try{t=await this.settingsService.get()}catch(e){}return{channelViewModel:i,settings:t}}),ns)}async forkReader(){return new aa((async e=>{await this.schemaService.loadChannel(e.params.id);let t,i=await this.channelWebService.get(e.params.id);try{t=await this.settingsService.get()}catch(e){}return{channelViewModel:i,settings:t}}),os)}async publishReader(){return new aa((async e=>{await this.schemaService.loadChannel(e.params.id);let t,i=await this.channelWebService.get(e.params.id);try{t=await this.settingsService.get()}catch(e){}return{channelViewModel:i,settings:t}}),bs)}async contract(){return new aa((async e=>(await this.schemaService.loadChannel(e.params.id),{channelViewModel:await this.channelWebService.get(e.params.id)})),Rs)}};xs([na("/admin/publish/:id"),_s("design:type",Function),_s("design:paramtypes",[]),_s("design:returntype",Promise)],Ps.prototype,"publish",null),xs([na("/admin/publish/export/:id"),_s("design:type",Function),_s("design:paramtypes",[]),_s("design:returntype",Promise)],Ps.prototype,"export",null),xs([na("/admin/publish/fork-reader/:id"),_s("design:type",Function),_s("design:paramtypes",[]),_s("design:returntype",Promise)],Ps.prototype,"forkReader",null),xs([na("/admin/publish/publish-reader/:id"),_s("design:type",Function),_s("design:paramtypes",[]),_s("design:returntype",Promise)],Ps.prototype,"publishReader",null),xs([na("/admin/publish/contract/:id"),_s("design:type",Function),_s("design:paramtypes",[]),_s("design:returntype",Promise)],Ps.prototype,"contract",null),Ps=xs([(0,s.b)(),_s("design:paramtypes",[Hi,Ot,Ne,Qi])],Ps);var Cs=function(e,t,i,a){var n,s=arguments.length,o=s<3?t:null===a?a=Object.getOwnPropertyDescriptor(t,i):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,i,a);else for(var r=e.length-1;r>=0;r--)(n=e[r])&&(o=(s<3?n(o):s>3?n(t,i,o):n(t,i))||o);return s>3&&o&&Object.defineProperty(t,i,o),o},js=function(e,t){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(e,t)};let Ts=class{constructor(){}buildPagingViewModel(e,t,i,a){let n=new As;return n.offset=e||0,n.limit=t,n.count=i,n.start=n.offset+1,n.end=Math.min(n.offset+t,i),n.previousOffset=Math.max(n.offset-t,0),n.offset+t<i&&(n.nextOffset=n.offset+t),n.page=n.offset/n.limit+1,n.page>n.endPage&&(n.page=n.endPage),n.endPage=Math.ceil(n.count/n.limit),n.lastOffset=n.endPage*n.limit-n.limit,n.showNext=n.endPage>n.page,n.showPrevious=0!=n.offset,n.showFirst=n.page>2,n.showLast=n.page<n.endPage-1,n}calculateEndIndex(e,t,i){let a=t+e-1;return Math.min(i-1,a)}calculateDescendingEndIndex(e,t){let i=t-(e-1);return Math.max(0,i)}calculateDescendingOffset(e,t){let i=t-1-e;return Math.max(0,i)}};Ts=Cs([(0,s.b)(),js("design:paramtypes",[])],Ts);class As{page;pageNumbers;endPage;offset;limit;count;start;end;previousOffset;nextOffset;lastOffset;showPrevious;showNext;showFirst;showLast}var Os=i(87470);function Fs(e,{$:t,$on:i,$f7:a,$update:s}){n.getInstance(li);let o=n.getInstance(gi),r=n.getWalletService(),c=e.channel_view_model;const l=async e=>{a.dialog.confirm("Are you sure you want to delete this collection? This will only remove your local copy of the files.",(async()=>{a.preloader.show(),await o.delete(c.channel),a.preloader.hide(),a.views.main.router.navigate("/");a.toast.show({text:"Collection deleted",closeTimeout:2e3,closeButton:!0,position:"bottom",horizontalPosition:"left"})}))};return function(e){e.$;var t,i=e.$h;e.$root,e.$f7,e.$f7route,e.$f7router,e.$theme,e.$update,e.$store;return i`
