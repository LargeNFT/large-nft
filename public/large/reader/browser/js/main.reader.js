...
`}}X.id="a42dce9ffb";const Y=X,ee=(e,{$h:t})=>{globalThis.container.get("WalletService");let a=globalThis.container.get("TransactionWebService");const n=e=>`${o+e}`;let i=e.transaction,r=e.event,o=e.base_uri,s=e.row_item_view_models,c=e.index;return()=>t`
    ...
    `},ne=e=>{let t=globalThis.container.get("WalletService");return ie?.ens&&ie.ens[e]?ie.ens[e]:t.truncateEthAddress(e)};let ie,re,oe=async e=>re(e);function se(e,{$:t,$on:a,$f7:n,$update:i}){globalThis.container.get("WalletService");let r=globalThis.container.get("baseURI")();globalThis.moment;ie=e.transactions;let o=e.items,s=e.token;return re=async e=>{ie=e.transactionsViewModel,await i()},document.removeEventListener("transactions-updated",oe),document.addEventListener("transactions-updated",oe),function(e){e.$;var t=e.$h;e.$root,e.$f7,e.$f7route,e.$f7router,e.$theme,e.$update,e.$store;return t`
